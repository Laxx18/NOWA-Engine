...
/// @ingroup detour
class __declspec( dllexport ) dtQueryFilter
{
...
/// @ingroup detour
struct __declspec( dllexport ) dtRaycastHit
{
...
/// a navigation mesh.
/// @ingroup detour
class __declspec( dllexport ) dtNavMeshQuery
{
public:
	dtNavMeshQuery();
	~dtNavMeshQuery();
...
private:
	...
	struct __declspec( dllexport ) dtQueryData
	{
		dtStatus status;
	...
	class __declspec( dllexport ) dtNodePool* m_tinyNodePool;	///< Pointer to small node pool.
	class __declspec( dllexport ) dtNodePool* m_nodePool;		///< Pointer to node pool.
	class __declspec( dllexport ) dtNodeQueue* m_openList;		///< Pointer to open list queue.
};
