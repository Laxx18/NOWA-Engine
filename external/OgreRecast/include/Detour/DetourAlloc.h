...
__declspec( dllexport ) void dtAllocSetCustom(dtAllocFunc *allocFunc, dtFreeFunc *freeFunc);
...
///  @return A pointer to the beginning of the allocated memory block, or null if the allocation failed.
/// @see dtFree
__declspec( dllexport ) void* dtAlloc(size_t size, dtAllocHint hint);

/// Deallocates a memory block.
///  @param[in]		ptr		A pointer to a memory block previously allocated using #dtAlloc.
/// @see dtAlloc
__declspec( dllexport ) void dtFree(void* ptr);
