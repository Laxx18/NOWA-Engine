...
struct __declspec( dllexport ) dtObstacleCircle
{
...
struct __declspec( dllexport ) dtObstacleSegment
{
...
class __declspec( dllexport ) dtObstacleAvoidanceDebugData
{
public:
...
struct __declspec( dllexport ) dtObstacleAvoidanceParams
{
	float velBias;
	float weightDesVel;
	float weightCurVel;
...
class __declspec( dllexport ) dtObstacleAvoidanceQuery
{
public:
