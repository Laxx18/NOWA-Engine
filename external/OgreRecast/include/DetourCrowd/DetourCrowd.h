...
struct __declspec( dllexport ) dtCrowdNeighbour
{
...
/// @ingroup crowd
struct __declspec( dllexport ) dtCrowdAgentParams
{
...
/// @ingroup crowd
struct __declspec( dllexport ) dtCrowdAgent
{
...
struct __declspec( dllexport ) dtCrowdAgentAnimation
{
	bool active;
...
struct __declspec( dllexport ) dtCrowdAgentDebugInfo
{
	int idx;
...
/// @ingroup crowd
class __declspec( dllexport ) dtCrowd
{
	int m_maxAgents;
