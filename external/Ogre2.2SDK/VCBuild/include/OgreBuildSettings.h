...
#define OGRE_BUILD_PLUGIN_PFX2
#define OGRE_BUILD_COMPONENT_ATMOSPHERE
#define OGRE_BUILD_COMPONENT_HLMS_PBS
#define OGRE_BUILD_COMPONENT_HLMS_UNLIT
/* #undef OGRE_BUILD_COMPONENT_PAGING */
#define OGRE_BUILD_COMPONENT_PLANAR_REFLECTIONS
#define OGRE_BUILD_COMPONENT_SCENE_FORMAT
...
#define OGRE_NO_FINE_LIGHT_MASK_GRANULARITY 0

#define OGRE_ENABLE_LIGHT_OBB_RESTRAINT 1
...
/* #undef OGRE_SHADER_THREADING_USE_TLS */
#define OGRE_SHADER_THREADING_BACKWARDS_COMPATIBLE_API
