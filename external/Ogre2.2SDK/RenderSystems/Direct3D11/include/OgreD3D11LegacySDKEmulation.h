...
DEFINE_GUID( IID_ID3D11Device1, 0xa04bfb29, 0x08ef, 0x43d6, 0xa4, 0x9c, 0xa9, 0xbd, 0xbd, 0xcb, 0xe6,
             0x86 );
#if defined( __cplusplus ) && !defined( CINTERFACE )
MIDL_INTERFACE( "a04bfb29-08ef-43d6-a49c-a9bdbdcbe686" )
ID3D11Device1 : public ID3D11Device
{
    virtual void STDMETHODCALLTYPE GetImmediateContext1( ID3D11DeviceContext1 *
    ...
    virtual HRESULT STDMETHODCALLTYPE CreateDeviceContextState(
        ...
        REFIID EmulatedInterface, D3D_FEATURE_LEVEL *pChosenFeatureLevel,
        ID3DDeviceContextState **ppContextState ) = 0;

    virtual HRESULT STDMETHODCALLTYPE OpenSharedResource1( HANDLE hResource, REFIID returnedInterface,
                                                           void **ppResource ) = 0;

    virtual HRESULT STDMETHODCALLTYPE OpenSharedResourceByName(
        LPCWSTR lpName, DWORD dwDesiredAccess, REFIID returnedInterface, void **ppResource ) = 0;
};
#endif

DEFINE_GUID( IID_ID3D11DeviceContext1, 0xbb2c6faa, 0xb5fb, 0x4082, 0x8e, 0x6b, 0x38, 0x8b, 0x8c, 0xfa,
             0x90, 0xe1 );
#if defined( __cplusplus ) && !defined( CINTERFACE )
...
ID3D11DeviceContext1 : public ID3D11DeviceContext
{
    ...
    virtual void STDMETHODCALLTYPE UpdateSubresource1(
        ...
        const void *pSrcData, UINT SrcRowPitch, UINT SrcDepthPitch, UINT CopyFlags ) = 0;

    virtual void STDMETHODCALLTYPE DiscardResource( ID3D11Resource * pResource ) = 0;

    virtual void STDMETHODCALLTYPE DiscardView( ID3D11View * pResourceView ) = 0;

    virtual void STDMETHODCALLTYPE VSSetConstantBuffers1(
        UINT StartSlot, UINT NumBuffers, ID3D11Buffer *const *ppConstantBuffers,
        const UINT *pFirstConstant, const UINT *pNumConstants ) = 0;
    ...
    virtual void STDMETHODCALLTYPE VSGetConstantBuffers1(
        UINT StartSlot, UINT NumBuffers, ID3D11Buffer * *ppConstantBuffers, UINT * pFirstConstant,
    ...
    virtual void STDMETHODCALLTYPE SwapDeviceContextState(
        ID3DDeviceContextState * pState, ID3DDeviceContextState * *ppPreviousState ) = 0;

    virtual void STDMETHODCALLTYPE ClearView( ID3D11View * pView, const FLOAT Color[4],
                                              const D3D11_RECT *pRect, UINT NumRects ) = 0;

    virtual void STDMETHODCALLTYPE DiscardView1( ID3D11View * pResourceView, const D3D11_RECT *pRects,
                                                 UINT NumRects ) = 0;
};
#endif
...
{
    virtual int STDMETHODCALLTYPE IsWindowedStereoEnabled() = 0;
    ...
    virtual HRESULT STDMETHODCALLTYPE RegisterOcclusionStatusWindow( HWND WindowHandle, UINT wMsg,
                                                                     DWORD * pdwCookie ) = 0;
    ...
    virtual HRESULT STDMETHODCALLTYPE RegisterStereoStatusWindow( HWND WindowHandle, UINT wMsg,
                                                                  DWORD * pdwCookie ) = 0;

    virtual HRESULT STDMETHODCALLTYPE RegisterOcclusionStatusEvent( HANDLE hEvent,
                                                                    DWORD * pdwCookie ) = 0;
...
DEFINE_GUID( IID_IDXGISwapChain1, 0x790a45f7, 0x0d42, 0x4876, 0x98, 0x3a, 0x0a, 0x55, 0xcf, 0xe6, 0xf4,
             0xaa );
#if defined( __cplusplus ) && !defined( CINTERFACE )
...
IDXGISwapChain1 : public IDXGISwapChain
{
    ...
    virtual int STDMETHODCALLTYPE IsTemporaryMonoSupported() = 0;
