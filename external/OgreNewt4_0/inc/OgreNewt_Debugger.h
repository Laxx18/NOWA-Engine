...
#include "ndShape.h" // Include for ndShape
...
namespace OgreNewt
{
    ...
    */
    ...
    public:
        ...
        */
        void init(Ogre::SceneManager* smgr, bool showText = true);
        ...
        */
        ...
        //! this function is used internally
        void addConvexRay(const ndShape* col, const Ogre::Vector3& startpt, const Ogre::Quaternion& colori, const Ogre::Vector3& endpt);
    ...
    protected:
        ...
        struct BodyDebugData
        {
            BodyDebugData() :
                m_lastcol(nullptr),
                m_node(nullptr), m_lines(nullptr), /*m_text(nullptr),*/ m_updated(false) {
            }
            ndShape* m_lastcol;
