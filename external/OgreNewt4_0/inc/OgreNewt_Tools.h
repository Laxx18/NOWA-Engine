...
Updated for Newton-Dynamics 4.0: use ndMatrix / ndVector types
*/
...
#include "Components/Overlay/include/OgreFont.h"
...
namespace OgreNewt
{
	...
	namespace Converters
	{
		...
		*/
		_OgreNewtExport void MatrixToQuatPos(const ndMatrix& matrix, Ogre::Quaternion& quat, Ogre::Vector3& pos);
		...
		*/
		_OgreNewtExport void QuatPosToMatrix(const Ogre::Quaternion& quat, const Ogre::Vector3& pos, ndMatrix& matrix);
		...
		*/
		_OgreNewtExport void MatrixToMatrix4(const ndMatrix& matrix_in, Ogre::Matrix4& matrix_out);
		...
		*/
		_OgreNewtExport void Matrix4ToMatrix(const Ogre::Matrix4& matrix_in, ndMatrix& matrix_out);

		//! Take an Ogre::Vector3 and make it into a Newton ndVector
		/*!
		\param vector_in Ogre::Vector3 to be converted.
		\return vector_out ndVector
		*/
		_OgreNewtExport ndVector OgreToNewtonVector(const Ogre::Vector3& vec);

		//! Take a Newton ndVector and make it into an Ogre::Vector3
		_OgreNewtExport Ogre::Vector3 NewtonToOgreVector(const ndVector& vec);
