...
namespace OgreNewt
{
    namespace
    {
        ...
        inline void logCritical(const Ogre::String& where, const Ogre::String& text)
        {
            ...
            {
                lm->logMessage(
                    "[CollisionSerializer][" + where + "]: " + text,
                    Ogre::LML_CRITICAL
                );
            }
        }
        ...
        void exportPrimitive(std::ostream& os, const CollisionPtr& col)
        {
            ...
            default:
                logCritical("exportPrimitive",
                    "Serializer for this collision type not implemented yet.");
                break;
            }
        }
        ...
        CollisionPtr importPrimitive(std::istream& is, World* world)
        {
            ...
            case BoxPrimitiveType:
            {
                ...
                dest = CollisionPtr(new CollisionPrimitives::Box(
                    world, Ogre::Vector3(sx, sy, sz),
                    0, Ogre::Quaternion::IDENTITY, Ogre::Vector3::ZERO));
                break;
            }
            ...
            case EllipsoidPrimitiveType:
            {
                ...
                dest = CollisionPtr(new CollisionPrimitives::Ellipsoid(
                    world, size,
                    0, Ogre::Quaternion::IDENTITY, Ogre::Vector3::ZERO));
                break;
            }
            ...
            case CylinderPrimitiveType:
            {
                ...
                float r = 0.5f * (r0 + r1);
                dest = CollisionPtr(new CollisionPrimitives::Cylinder(
                    world, r, h,
                    0, Ogre::Quaternion::IDENTITY, Ogre::Vector3::ZERO));
                break;
            }
            ...
            case CapsulePrimitiveType:
            {
                ...
                dest = CollisionPtr(new CollisionPrimitives::Capsule(
                    world, r, fullH,
                    0, Ogre::Quaternion::IDENTITY, Ogre::Vector3::ZERO));
                break;
            }
            ...
            case ConePrimitiveType:
            {
                ...
                dest = CollisionPtr(new CollisionPrimitives::Cone(
                    world, r, h,
                    0, Ogre::Quaternion::IDENTITY, Ogre::Vector3::ZERO));
                break;
            }
            ...
            case ChamferCylinderPrimitiveType:
            {
                ...
                readVal(is, r);
                readVal(is, h);
                dest = CollisionPtr(new CollisionPrimitives::ChamferCylinder(
                    world, r, h,
                    0, Ogre::Quaternion::IDENTITY, Ogre::Vector3::ZERO));
                break;
            }
            ...
            case HeighFieldPrimitiveType:
            {
                ...
                for (size_t i = 0; i < elev.size(); ++i)
                    readVal(is, elev[i]);
                dest = CollisionPtr(new CollisionPrimitives::HeightField(
                    world, w, h, elev.data(), 1.0f, sx, sz,
                    Ogre::Vector3::ZERO, Ogre::Quaternion::IDENTITY, 0));
                break;
            }
            ...
            case ConcaveHullPrimitiveType:
            default:
                logCritical("importPrimitive",
                    "Deserializer for this collision type not implemented yet.");
                // dest stays empty
                break;
            }
    ...
    void CollisionSerializer::exportCollision(const CollisionPtr& collision, const Ogre::String& filename)
    {
        ...
        if (writePly)
        {
            ...
            logCritical(
                "exportCollision",
                "PLY export requires ndShapeInstance (SavePLY). "
