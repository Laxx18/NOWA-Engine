...
namespace OgreNewt
{
    ContactJoint::ContactJoint(ndContact* contact) : m_contact(contact)
    {
    }
    ...
    Contact::Contact(ndContactPointList::ndNode* contactNode, ContactJoint* parent) : m_parent(parent), m_contactNode(contactNode), m_index(0)
    {
    }
    ...
    Ogre::Vector3 Contact::getForce() const
    {
        ...
        ndVector force = contactPoint.m_normal * contactPoint.m_normal_Force.m_force + contactPoint.m_dir0 * contactPoint.m_dir0_Force.m_force + contactPoint.m_dir1 * contactPoint.m_dir1_Force.m_force;
