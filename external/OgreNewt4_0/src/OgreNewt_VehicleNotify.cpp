...
namespace OgreNewt
{
    VehicleNotify::VehicleNotify(Vehicle* vehicle) : BodyNotify(vehicle), m_vehicle(vehicle)
    {
    }
    ...
    ComplexVehicleNotify::ComplexVehicleNotify(ComplexVehicle* vehicle) : BodyNotify(vehicle), m_vehicle(vehicle)
    {
    }
