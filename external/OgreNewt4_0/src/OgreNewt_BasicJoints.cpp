...
namespace OgreNewt
{
    ...
    Hinge::Hinge(const Body* child, const Body* parent, const Ogre::Vector3& pos, const Ogre::Vector3& pin) : Joint(), m_childPinLocal(pin)
    {
        ...
        ndBodyKinematic* const parentBody = parent ? const_cast<ndBodyKinematic*>(parent->getNewtonBody()) : (child ? child->getWorld()->getNewtonWorld()->GetSentinelBody() : nullptr);
    ...
    Hinge::Hinge(const Body* child, const Body* parent, const Ogre::Vector3& childPos, const Ogre::Vector3& childPin, const Ogre::Vector3& parentPos, const Ogre::Vector3& parentPin) : Joint(), m_childPinLocal(childPin)
    {
        // convert child frame
    ...
    Slider::Slider(const Body* child, const Body* parent, const Ogre::Vector3& pos, const Ogre::Vector3& pin)
    {
    ...
    SlidingContact::SlidingContact(const OgreNewt::Body* child, const OgreNewt::Body* parent, const Ogre::Vector3& pos, const Ogre::Vector3& pin) : Joint()
    {
    ...
    PointToPoint::PointToPoint(const OgreNewt::Body* child, const OgreNewt::Body* parent, const Ogre::Vector3& pos1, const Ogre::Vector3& pos2) : Joint()
    {
        ndBodyKinematic* b0 = child ? const_cast<ndBodyKinematic*>(child->getNewtonBody()) : nullptr;
        ndBodyKinematic* b1 = parent ? const_cast<ndBodyKinematic*>(parent->getNewtonBody()) : child->getWorld()->getNewtonWorld()->GetSentinelBody();
    ...
    Joint6Dof::Joint6Dof(const OgreNewt::Body* child, const OgreNewt::Body* parent, const Ogre::Vector3& pos1, const Ogre::Vector3& pos2) : Joint()
    {
    ...
    HingeActuator::HingeActuator(const OgreNewt::Body* child, const OgreNewt::Body* parent, const Ogre::Vector3& pos, const Ogre::Vector3& pin, const Ogre::Degree& angularRate, const Ogre::Degree& minAngle, const Ogre::Degree& maxAngle) : Joint()
    {
        ...
        ndBodyKinematic* const b1 = parent ? const_cast<ndBodyKinematic*>(parent->getNewtonBody()) : (child ? child->getWorld()->getNewtonWorld()->GetSentinelBody() : nullptr);
    ...
    {
        const ndOgreHingeActuator* const joint = static_cast<const ndOgreHingeActuator*>(GetSupportJoint());
    ...
    {
        ndOgreHingeActuator* const joint = static_cast<ndOgreHingeActuator*>(GetSupportJoint());
    ...
    {
        ndOgreHingeActuator* const joint = static_cast<ndOgreHingeActuator*>(GetSupportJoint());
        joint->SetSpringAndDamping(enable, massIndependent, static_cast<ndFloat32>(springDamperRelaxation), static_cast<ndFloat32>(spring), static_cast<ndFloat32>(damper));
    }

    ///////////////////////////////////////////////////////////////////////////////////////////////

    ndOgreSliderActuator::ndOgreSliderActuator(const ndMatrix& pinAndPivotFrame, ndBodyKinematic* const child, ndBodyKinematic* const parent, ndFloat32 linearRate, ndFloat32 minPosit, ndFloat32 maxPosit) :
    ...
    SliderActuator::SliderActuator(const OgreNewt::Body* child, const OgreNewt::Body* parent, const Ogre::Vector3& pos, const Ogre::Vector3& pin, Ogre::Real linearRate, Ogre::Real minPosition, Ogre::Real maxPosition) : Joint()
    {
    ...
    {
        const ndOgreSliderActuator* const joint = static_cast<const ndOgreSliderActuator*>(GetSupportJoint());
        return static_cast<Ogre::Real>(joint->GetActuatorPosit());
    }

    void SliderActuator::SetTargetPosition(Ogre::Real targetPosition)
    {
        ndOgreSliderActuator* const joint = static_cast<ndOgreSliderActuator*>(GetSupportJoint());
    ...
    {
    public:
        ndFlexyPipeHandle(ndBodyKinematic* const body0, const ndVector& pin, const ndVector& anchorPosition) :
            ...
            m_angularFriction(200.0f)
        {
            ...
            OgreNewt::Converters::QuatPosToMatrix(q, Ogre::Vector3(anchorPosition.m_x, anchorPosition.m_y, anchorPosition.m_z), globalFrame);
    ...
    {
    public:
        ndFlexyPipeSpinner(const ndMatrix& pinAndPivotFrame, ndBodyKinematic* const child, ndBodyKinematic* const parent) : ndJointBilateralConstraint(6, child, parent, pinAndPivotFrame)
        {
            SetSolverModel(ndJointBilateralSolverModel::m_jointIterativeSoft);
        }
        ...
        void JacobianDerivative(ndConstraintDescritor& desc) override
        {
            ...
            for (int i = 0; i < 3; ++i)
            {
                ...
                SetMassSpringDamperAcceleration(desc, ndFloat32(0.01f), ndFloat32(1000.0f), ndFloat32(50.0f));
            }
        ...
        void ApplyTwistAction(ndConstraintDescritor& desc, const ndMatrix& m0, const ndMatrix& m1)
        {
            ...
            const ndFloat relOmega = m_body0->GetOmega().DotProduct(pin0).GetScalar() + m_body1->GetOmega().DotProduct(pin1).GetScalar();
        ...
        void ApplyElasticConeAction(ndConstraintDescritor& desc, const ndMatrix& m0, const ndMatrix& m1)
        {
            ...
            else
            {
                ...
                if (lateralDir.DotProduct(lateralDir).GetScalar() > ndFloat32(1.0e-6f))
                {
                    ...
                    const ndFloat coneAngle = ndAcos(ndClamp(cosAng, ndFloat32(-1.0f), ndFloat32(1.0f)));
    ...
    ActiveSliderJoint::ActiveSliderJoint(OgreNewt::Body* currentBody, OgreNewt::Body* predecessorBody, const Ogre::Vector3& anchorPosition, const Ogre::Vector3& pin, Ogre::Real minStopDistance, Ogre::Real maxStopDistance, Ogre::Real moveSpeed,
        bool repeat, bool directionChange, bool activated)
    {
        m_body0 = currentBody;
    ...
    Plane2DUpVectorJoint::Plane2DUpVectorJoint(const OgreNewt::Body* child, const Ogre::Vector3& pos, const Ogre::Vector3& normal, const Ogre::Vector3& pin) : Joint(), m_pin(pin)
    {
    ...
    {
    public:
        ndPlaneConstraintWrapper(const ndVector& pivot, const ndVector& normal, ndBodyKinematic* const child, ndBodyKinematic* const parent) : ndJointPlane(pivot, normal, child, parent)
        {
    ...
    // -----------------------------------------------------------------------------
    PlaneConstraint::PlaneConstraint(const OgreNewt::Body* child, const OgreNewt::Body* parent, const Ogre::Vector3& pos, const Ogre::Vector3& normal) : Joint()
    {
    ...
    UpVector::UpVector(const Body* body, const Ogre::Vector3& pin) : m_pin(pin)
    {
    ...
    {
    public:
        NdCustomPathFollowAdapter(const ndMatrix& pinAndPivotFrame, ndBodyDynamic* const child, ndBodyDynamic* const pathBody, const ndBezierSpline* spline) : ndJointFollowPath(pinAndPivotFrame, child, pathBody), m_spline(spline)
        {
        }
    ...
    WormGear::WormGear(const OgreNewt::Body* rotationalBody, const OgreNewt::Body* linearBody, const Ogre::Vector3& rotationalPin, const Ogre::Vector3& linearPin, Ogre::Real gearRatio) : Joint()
    {
    ...
    {
    public:
        ndJointGearAndSlide(ndFloat32 gearRatio, ndFloat32 slideRatio, const ndVector& rotPin, ndBodyKinematic* const rotBody, const ndVector& linPin, ndBodyKinematic* const linBody) :
            ndJointBilateralConstraint(1, rotBody, linBody, ndGetIdentityMatrix()),
            m_gearRatio(gearRatio),
    ...
    CustomGearAndSlide::CustomGearAndSlide(const OgreNewt::Body* rotationalBody, const OgreNewt::Body* linearBody, const Ogre::Vector3& rotationalPin, const Ogre::Vector3& linearPin, Ogre::Real gearRatio, Ogre::Real slideRatio) : Joint()
    {
        ndBodyKinematic* bRot = rotationalBody ? const_cast<ndBodyKinematic*>(rotationalBody->getNewtonBody()) : nullptr;
        ndBodyKinematic* bLin = linearBody ? const_cast<ndBodyKinematic*>(linearBody->getNewtonBody()) : nullptr;
        ...
        auto* joint = new ndJointGearAndSlide(static_cast<ndFloat32>(gearRatio), static_cast<ndFloat32>(slideRatio), rotPin, bRot, linPin, bLin);
        SetSupportJoint(rotationalBody->getWorld(), joint);
    }
    ...
    Pulley::Pulley(const OgreNewt::Body* child, const OgreNewt::Body* parent, const Ogre::Vector3& childPin, const Ogre::Vector3& parentPin, Ogre::Real pulleyRatio) : Joint()
    {
    ...
    ndOgreDoubleHingeActuator::ndOgreDoubleHingeActuator(const ndMatrix& pinAndPivotFrame, ndBodyKinematic* const child, ndBodyKinematic* const parent, ndFloat32 angularRate0, ndFloat32 minAngle0, ndFloat32 maxAngle0, ndFloat32 angularRate1,
        ndFloat32 minAngle1, ndFloat32 maxAngle1) :
    ...
    UniversalActuator::UniversalActuator(const OgreNewt::Body* child, const OgreNewt::Body* parent, const Ogre::Vector3& pos, const Ogre::Degree& angularRate0, const Ogre::Degree& minAngle0, const Ogre::Degree& maxAngle0,
        ...
        Joint()
    {
        ...
        ndOgreDoubleHingeActuator* const joint = new ndOgreDoubleHingeActuator(pinAndPivotFrame, b0, b1, rate0Rad, min0Rad, max0Rad, rate1Rad, min1Rad, max1Rad);
    ...
    {
        const ndOgreDoubleHingeActuator* const joint = static_cast<const ndOgreDoubleHingeActuator*>(GetSupportJoint());
        return Ogre::Radian(joint->GetActuatorAngle0()).valueDegrees();
    }

    void UniversalActuator::SetTargetAngle0(const Ogre::Degree& angle0)
    {
        ndOgreDoubleHingeActuator* const joint = static_cast<ndOgreDoubleHingeActuator*>(GetSupportJoint());
    ...
    public:
        ...
        ndOgreMotorHinge(const ndMatrix& pinAndPivotFrame, ndBodyKinematic* const child, ndBodyKinematic* const parent) : ndJointHinge(pinAndPivotFrame, child, parent), m_speed(ndFloat32(0.0f)), m_maxTorque(ndFloat32(1000.0f))
        {
    ...
    Motor::Motor(const Body* child, const Body* parent, const Ogre::Vector3& pin) : Joint(), m_targetSpeed(0.0f)
    {
        if (!child)
        {
            return;
    ...
    ServoHinge::ServoHinge(const Body* child, const Body* parent, const Ogre::Vector3& pos, const Ogre::Vector3& pin) : Hinge(child, parent, pos, pin), m_targetAngle(0.0f), m_stiffness(500.0f), m_damping(50.0f)
    {
    }
    ...
    Wheel::Wheel(const OgreNewt::Body* child, const OgreNewt::Body* parent, const Ogre::Vector3& pos, const Ogre::Vector3& pin) : Joint()
    {
    ...
    Wheel::Wheel(const OgreNewt::Body* child, const OgreNewt::Body* parent, const Ogre::Vector3& childPos, const Ogre::Vector3& childPin, const Ogre::Vector3& parentPos, const Ogre::Vector3& parentPin) : Joint()
    {
        Ogre::Quaternion qChild = OgreNewt::Converters::grammSchmidt(childPin);
        Ogre::Quaternion qParent = OgreNewt::Converters::grammSchmidt(parentPin);
    ...
    VehicleTire::VehicleTire(OgreNewt::Body* child, OgreNewt::Body* parentBody, const Ogre::Vector3& pos, const Ogre::Vector3& pin, Vehicle* parent, Ogre::Real radius) : Joint(), m_tireConfiguration(RayCastTire::TireConfiguration())
    {
