...
namespace OgreAL {
	...
	protected:
		...
		*/
		 ...
		 */
		WavSound(Ogre::SceneManager* sceneMgr, const Ogre::String& name, const Ogre::DataStreamPtr& soundStream, bool loop, bool stream);
	...
	public:
		...
		virtual void setSecondOffset(Ogre::Real seconds) override;
		/** Returns the current offset within the audio stream in seconds */
		virtual Ogre::Real getSecondOffset() override;
