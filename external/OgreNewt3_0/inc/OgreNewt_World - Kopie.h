...
*/
		...
		*/
		...
		//   */
		   ...
		   //int getFrictionModel(void) const
		   //{
		   ...
		   */
		   ...
		   {
			   char desc[265];
			   int mode = NewtonGetPlatformArchitecture( m_world, desc );
			   description = desc;
			   return mode;
		   }*/
		...
		*/
		...
		PlayerControllerManager* getPlayerControllerManager(void);
		...
		*/
		void ogreCriticalSectionLock() const
		{
			pthread_mutex_lock(&m_ogreMutex);
		}
		 ...
		 * This function is only used in OgreNewt and can be used by the user, it is independent of Ogre's own thread support...
		*/
		void ogreCriticalSectionUnlock() const
		{
			pthread_mutex_unlock(&m_ogreMutex);
		}
	...
	private:
		...
		PlayerControllerManager* m_playerControllerManager;
