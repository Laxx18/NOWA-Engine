...
private:
	//! internal function.
	// static int _CDECL collisionCallback_onAABBOverlap(const NewtonMaterial* const material, const NewtonBody* const newtonBody0, const NewtonBody* const newtonBody1, int threadIndex);
	static int _CDECL collisionCallback_onAABBOverlap(const NewtonJoint* const contact, dFloat timestep, int threadIndex);
	//! internal function.
	static void _CDECL collisionCallback_contactsProcess(const NewtonJoint* const contact, dFloat timeStep, int threadIndex);
