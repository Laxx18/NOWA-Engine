...
class __declspec( dllexport ) HlmsParticleDatablock;
class __declspec( dllexport ) HlmsParticleListener;

/// Class which will manage all gpu particles.
class __declspec( dllexport ) GpuParticleSystemWorld : public Ogre::MovableObject
{
public:

    /// ParticleRenderable is associated with one datablock.
    class __declspec( dllexport ) ParticleRenderable : public Ogre::Renderable
    {
    private:
    ...
    public:
        ...
        friend class __declspec( dllexport ) GpuParticleSystemWorld;
    };

    class __declspec( dllexport ) EmitterInstanceRemoveListener
    {
    public:
    ...
    class __declspec( dllexport ) EmitterInstance
    {
    public:
