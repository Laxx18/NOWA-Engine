...
namespace MyGUI
{
	...
	Widget* ColourPanel::getWidget(void) const
	{
		return this->mMainWidget;
	}

	MyGUI::ImageBox* ColourPanel::getColorRect(void) const
	{
		return this->mColourRect;
	}

	void ColourPanel::setVisible(bool visible)
	{
		this->mMainWidget->setVisible(visible);
	}
	...
	void ColourPanel::notifyMouseButtonClick(MyGUI::Widget* _sender)
	{
		...
		else if (mCancel == _sender)
		{
			eventColourCancel(this);
		}
	}
