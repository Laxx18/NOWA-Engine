#ifndef MAIN_CONFIGURATION_STATE_MY_GUI_H
#define MAIN_CONFIGURATION_STATE_MY_GUI_H
...
namespace NOWA
{
	class EXPORTED MainConfigurationStateMyGui : public AppState
	{
	public:
		DECLARE_APPSTATE_CLASS(MainConfigurationStateMyGui)

		MainConfigurationStateMyGui();

		virtual ~MainConfigurationStateMyGui() { }
	...
	private:
		...
		void notifyMouseSetFocusJoyStick(MyGUI::Widget* _sender, MyGUI::Widget* _old);
