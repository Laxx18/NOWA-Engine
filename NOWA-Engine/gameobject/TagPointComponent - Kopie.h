...
namespace NOWA
{
	...
	public:
		...
		*/
		...
		{
			return "Tags a game object to a bone. Requirements: Entity must have animations.";
		}
		 ...
		 * @return offsetOrientation The offset orientation to get
		 */
	...
	private:
		...
		PhysicsActiveCompPtr sourcePhysicsActiveCompPtr;
