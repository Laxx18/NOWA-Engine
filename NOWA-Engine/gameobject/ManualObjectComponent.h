#ifndef MANUAL_OBJECT_COMPONENT_H
#define MANUAL_OBJECT_COMPONENT_H
...
namespace NOWA
{
	 ...
	 */
	class EXPORTED ManualObjectComponent : public GameObjectComponent
	{
	public:
	...
	public:
		...
		{
			return NOWA::getIdFromName("ManualObjectComponent");
		}
		...
		*/
		...
		{
			return "Usage: Creates manual objects. It can be used in lua script e.g. for an audio spectrum visualization"
				"It is much more performant as LinesComponent, because only one manual object with x start- and end-positions is created."
				"The difference to LinesComponent is, that each end - position is also the next start position.";
		}
		...
		* 	OT_TRIANGLE_FAN = 6, Note: Note more supported!
	    */
		...
		/**
		 * @brief Sets color for the manual object
		 * @param[in] index The meant manual object index
		 * @param[in] color The color to set (r, g, b)
		 */
		void setColor(unsigned int index, const Ogre::Vector3& color);

		/**
		 * @brief Gets the color for the manual object
		 * @param[in] index The meant manual object index
		...
		/**
		 * @brief Sets the start position of the manual object
		 * @param[in] index The meant manual object index
		...
		/**
		 * @brief Gets the start position of the manual object
		 * @param[in] index The meant manual object index
		...
		/**
		 * @brief Sets the end position of the manual object
		 * @param[in] index The meant manual object index
		...
		/**
		 * @brief Gets the end position of the manual object
		 * @param[in] index The meant manual object index
		 * @return endPosition The end position to get
		 */
