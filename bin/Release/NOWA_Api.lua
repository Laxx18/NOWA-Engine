return {
	...
	{
		type = "class",
		description = "Warcraft-2-style bottom-to-top mesh construction animation. Simulation-only â€” editor always shows the full mesh. Optionally shows a progress bar and/or percentage text.",
		inherits = "GameObjectComponent",
		childs = 
		{
