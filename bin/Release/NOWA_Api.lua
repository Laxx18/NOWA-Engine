return {
	...
	{
		type = "class",
		description = "Warcraft-2-style bottom-to-top mesh construction animation. Simulation-only â€” editor always shows the full mesh. Optional camera-facing progress bar and percentage text.",
		inherits = "GameObjectComponent",
		childs = 
		{
	...
	PhysicsActiveVehicleComponentV2 =
	{
		...
		childs = 
		{
			...
			{
				type = "method",
				description = "Scales the yaw-rate target (default 1.0). Increase (2â€“4) for sharper turns, decrease for less responsive steering.",
				args = "(number strength)",
				returns = "(nil)",
				valuetype = "nil"
			},
