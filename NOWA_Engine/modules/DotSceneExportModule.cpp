...
namespace NOWA
{
	...
	void DotSceneExportModule::exportScene(const Ogre::String& projectName, const Ogre::String& sceneName, const Ogre::String& worldResourceGroupName)
	{
		...
		// Scene element
		{
			...
			// Bounds element (after bounds have been calculated for each object
			{
				...
				boundsXML->append_attribute(doc.allocate_attribute("mostLeftNearPosition", XMLConverter::ConvertString(this->mostLeftNearPosition)));
				boundsXML->append_attribute(doc.allocate_attribute("mostRightFarPosition", XMLConverter::ConvertString(this->mostRightFarPosition)));
	...
	void DotSceneExportModule::exportEnvironment(xml_node<>* environmentXML, xml_document<>& doc)
	{
		...
		// SceneManager
		{
			...
			sceneManagerXML->append_attribute(doc.allocate_attribute("name", XMLConverter::ConvertString(this->sceneManager->getName())));
			sceneManagerXML->append_attribute(doc.allocate_attribute("id", XMLConverter::ConvertString(static_cast<unsigned int>(hash(this->sceneManager->getName())))));
			sceneManagerXML->append_attribute(doc.allocate_attribute("type", XMLConverter::ConvertString(this->sceneManager->getTypeName())));
		...
		// ambient
		{
			...
			// AmbientLightUpperHemisphere
			{
				...
				colorUpperHemisphereXML->append_attribute(doc.allocate_attribute("r", XMLConverter::ConvertString(this->sceneManager->getAmbientLightUpperHemisphere().r)));
				colorUpperHemisphereXML->append_attribute(doc.allocate_attribute("g", XMLConverter::ConvertString(this->sceneManager->getAmbientLightUpperHemisphere().g)));
				colorUpperHemisphereXML->append_attribute(doc.allocate_attribute("b", XMLConverter::ConvertString(this->sceneManager->getAmbientLightUpperHemisphere().b)));
				// colourUpperHemisphereXML->append_attribute(doc.allocate_attribute("a", XMLConverter::ConvertString(this->sceneManager->getAmbientLightUpperHemisphere().a)));
			...
			// AmbientLightLowerHemisphere
			{
				...
				colorLowerHemisphereXML->append_attribute(doc.allocate_attribute("r", XMLConverter::ConvertString(this->sceneManager->getAmbientLightLowerHemisphere().r)));
				colorLowerHemisphereXML->append_attribute(doc.allocate_attribute("g", XMLConverter::ConvertString(this->sceneManager->getAmbientLightLowerHemisphere().g)));
				colorLowerHemisphereXML->append_attribute(doc.allocate_attribute("b", XMLConverter::ConvertString(this->sceneManager->getAmbientLightLowerHemisphere().b)));
				colorLowerHemisphereXML->append_attribute(doc.allocate_attribute("a", XMLConverter::ConvertString(this->sceneManager->getAmbientLightLowerHemisphere().a)));
			...
			// HemisphereDir
			{
				...
				hemisphereDirXML->append_attribute(doc.allocate_attribute("x", XMLConverter::ConvertString(this->sceneManager->getAmbientLightHemisphereDir().x)));
				hemisphereDirXML->append_attribute(doc.allocate_attribute("y", XMLConverter::ConvertString(this->sceneManager->getAmbientLightHemisphereDir().y)));
				hemisphereDirXML->append_attribute(doc.allocate_attribute("z", XMLConverter::ConvertString(this->sceneManager->getAmbientLightHemisphereDir().z)));
			...
			// EnvmapScale
			{
				...
				// Note a is used for envmapscale in ogre
				envmapScaleXML->append_attribute(doc.allocate_attribute("x", XMLConverter::ConvertString(this->sceneManager->getAmbientLightUpperHemisphere().a)));
		...
		// shadows
		{
			...
			// shadowFarDistance
			{
				...
				shadowFarDistanceXML->append_attribute(doc.allocate_attribute("distance", XMLConverter::ConvertString(this->sceneManager->getShadowFarDistance())));
			...
			// shadowDirectionalLightExtrusionDistance
			{
				...
				shadowDirectionalLightExtrusionDistanceXML->append_attribute(doc.allocate_attribute("distance", XMLConverter::ConvertString(this->sceneManager->getShadowDirectionalLightExtrusionDistance())));
			...
			// shadowDirLightTextureOffset
			{
				...
				shadowDirLightTextureOffsetXML->append_attribute(doc.allocate_attribute("offset", XMLConverter::ConvertString(this->sceneManager->getShadowDirLightTextureOffset())));
				shadows->append_node(shadowDirLightTextureOffsetXML);
			}
			// shadowColor
			{
				xml_node<>* shadowColorXML = doc.allocate_node(node_element, "shadowColor");
				shadowColorXML->append_attribute(doc.allocate_attribute("r", XMLConverter::ConvertString(this->sceneManager->getShadowColour().r)));
				shadowColorXML->append_attribute(doc.allocate_attribute("g", XMLConverter::ConvertString(this->sceneManager->getShadowColour().g)));
				shadowColorXML->append_attribute(doc.allocate_attribute("b", XMLConverter::ConvertString(this->sceneManager->getShadowColour().b)));
				// Note a is used for envmapscale in ogre
			...
			// shadowQuality
			{
				...
				shadowQualityXML->append_attribute(doc.allocate_attribute("index", XMLConverter::ConvertString(static_cast<unsigned char>(WorkspaceModule::getInstance()->getShadowQuality()))));
				// Note a is used for envmapscale in ogre
			...
			// ambientLightMode
			{
				...
				ambientLightModeXML->append_attribute(doc.allocate_attribute("index", XMLConverter::ConvertString(static_cast<unsigned char>(WorkspaceModule::getInstance()->getAmbientLightMode()))));
				// Note a is used for envmapscale in ogre
		...
		// Light Forward
		{
			...
			if (nullptr != forwardPlusBase)
			{
				...
				// forwardMode
				{
					...
					nodeXML->append_attribute(doc.allocate_attribute("value", XMLConverter::ConvertString(forwardMode)));
				...
				if (0 != forwardMode)
				{
					// lightWidth
					{
						...
						if (1 == forwardMode)
							nodeXML->append_attribute(doc.allocate_attribute("value", XMLConverter::ConvertString(dynamic_cast<Ogre::Forward3D*>(forwardPlusBase)->getWidth())));
						else
							nodeXML->append_attribute(doc.allocate_attribute("value", XMLConverter::ConvertString(dynamic_cast<Ogre::ForwardClustered*>(forwardPlusBase)->getWidth())));
						lightFoward->append_node(nodeXML);
					}
					// lightHeight
					{
						...
						if (1 == forwardMode)
							nodeXML->append_attribute(doc.allocate_attribute("value", XMLConverter::ConvertString(dynamic_cast<Ogre::Forward3D*>(forwardPlusBase)->getHeight())));
						else
							nodeXML->append_attribute(doc.allocate_attribute("value", XMLConverter::ConvertString(dynamic_cast<Ogre::ForwardClustered*>(forwardPlusBase)->getHeight())));
						lightFoward->append_node(nodeXML);
					}
					// numLightSlices
					{
						...
						if (1 == forwardMode)
							nodeXML->append_attribute(doc.allocate_attribute("value", XMLConverter::ConvertString(static_cast<Ogre::Forward3D*>(forwardPlusBase)->getNumSlices())));
						else
							nodeXML->append_attribute(doc.allocate_attribute("value", XMLConverter::ConvertString(static_cast<Ogre::ForwardClustered*>(forwardPlusBase)->getNumSlices())));
						lightFoward->append_node(nodeXML);
					}
					// lightsPerCell
					{
						...
						if (1 == forwardMode)
							nodeXML->append_attribute(doc.allocate_attribute("value", XMLConverter::ConvertString(dynamic_cast<Ogre::Forward3D*>(forwardPlusBase)->getLightsPerCell())));
						else
							nodeXML->append_attribute(doc.allocate_attribute("value", XMLConverter::ConvertString(dynamic_cast<Ogre::ForwardClustered*>(forwardPlusBase)->getLightsPerCell())));
						lightFoward->append_node(nodeXML);
					}
					// decalsPerCell
					{
						...
						if (2 == forwardMode)
							nodeXML->append_attribute(doc.allocate_attribute("value", XMLConverter::ConvertString(dynamic_cast<Ogre::ForwardClustered*>(forwardPlusBase)->getDecalsPerCell())));
						lightFoward->append_node(nodeXML);
					}
					// cubemapProbesPerCell
					{
						...
						if (2 == forwardMode)
							nodeXML->append_attribute(doc.allocate_attribute("value", XMLConverter::ConvertString(10)));
						lightFoward->append_node(nodeXML);
					}
					// minLightDistance
					{
						...
						if (1 == forwardMode)
							nodeXML->append_attribute(doc.allocate_attribute("value", XMLConverter::ConvertString(dynamic_cast<Ogre::Forward3D*>(forwardPlusBase)->getMinDistance())));
						else
							nodeXML->append_attribute(doc.allocate_attribute("value", XMLConverter::ConvertString(dynamic_cast<Ogre::ForwardClustered*>(forwardPlusBase)->getMinDistance())));
						lightFoward->append_node(nodeXML);
					}
					// maxLightDistance
					{
						...
						if (1 == forwardMode)
							nodeXML->append_attribute(doc.allocate_attribute("value", XMLConverter::ConvertString(dynamic_cast<Ogre::Forward3D*>(forwardPlusBase)->getMaxDistance())));
						else
							nodeXML->append_attribute(doc.allocate_attribute("value", XMLConverter::ConvertString(dynamic_cast<Ogre::ForwardClustered*>(forwardPlusBase)->getMaxDistance())));
						lightFoward->append_node(nodeXML);
					}
			...
			// Main Parameter
			{
				...
				// ignoreGlobalScene
				{
					...
					nodeXML->append_attribute(doc.allocate_attribute("value", XMLConverter::ConvertString(this->projectParameter.ignoreGlobalScene)));
				...
				// renderDistance
				{
					...
					nodeXML->append_attribute(doc.allocate_attribute("distance", XMLConverter::ConvertString(NOWA::Core::getSingletonPtr()->getGlobalRenderDistance())));
					mainParameterXML->append_node(nodeXML);
				}
...
#if 0
		{
			...
			skyBoxXML->append_attribute(doc.allocate_attribute("active", XMLConverter::ConvertString(active)));
			skyBoxXML->append_attribute(doc.allocate_attribute("distance", XMLConverter::ConvertString(distance)));
		...
		// Fog
		{
			...
			fogXML->append_attribute(doc.allocate_attribute("mode", XMLConverter::ConvertString(fogModes[this->sceneManager->getFogMode()])));
			fogXML->append_attribute(doc.allocate_attribute("start", XMLConverter::ConvertString(this->sceneManager->getFogStart())));
			fogXML->append_attribute(doc.allocate_attribute("end", XMLConverter::ConvertString(this->sceneManager->getFogEnd())));
			fogXML->append_attribute(doc.allocate_attribute("density", XMLConverter::ConvertString(this->sceneManager->getFogDensity())));
		...
		// Main Camera
		{
			...
			cameraXML->append_attribute(doc.allocate_attribute("polyMode", XMLConverter::ConvertString(this->mainCamera->getPolygonMode())));
			cameraXML->append_attribute(doc.allocate_attribute("fov", XMLConverter::ConvertString(this->mainCamera->getFOVy())));
			environmentXML->append_node(cameraXML);

			// Clipping
			{
				xml_node<>* clippingXML = doc.allocate_node(node_element, "clipping");
				clippingXML->append_attribute(doc.allocate_attribute("near", XMLConverter::ConvertString(this->mainCamera->getNearClipDistance())));
				clippingXML->append_attribute(doc.allocate_attribute("far", XMLConverter::ConvertString(this->mainCamera->getFarClipDistance())));
			...
			// Position
			{
				...
				positionXML->append_attribute(doc.allocate_attribute("x", XMLConverter::ConvertString(this->mainCamera->getDerivedPosition().x)));
				positionXML->append_attribute(doc.allocate_attribute("y", XMLConverter::ConvertString(this->mainCamera->getDerivedPosition().y)));
				positionXML->append_attribute(doc.allocate_attribute("z", XMLConverter::ConvertString(this->mainCamera->getDerivedPosition().z)));
			...
			// Rotation
			{
				...
				rotationXML->append_attribute(doc.allocate_attribute("qw", XMLConverter::ConvertString(this->mainCamera->getDerivedOrientation().w)));
				rotationXML->append_attribute(doc.allocate_attribute("qx", XMLConverter::ConvertString(this->mainCamera->getDerivedOrientation().x)));
				rotationXML->append_attribute(doc.allocate_attribute("qy", XMLConverter::ConvertString(this->mainCamera->getDerivedOrientation().y)));
				rotationXML->append_attribute(doc.allocate_attribute("qz", XMLConverter::ConvertString(this->mainCamera->getDerivedOrientation().z)));
	...
	void DotSceneExportModule::exportResourceLocations(rapidxml::xml_node<>* resourcesXML, rapidxml::xml_document<>& doc)
	{
		...
		for (auto& resourceGroupName : resourceLocations)
		{
			...
			for (auto& path : Ogre::ResourceGroupManager::getSingleton().getResourceLocationList(resourceGroupName))
			{
				...
				resourceLocationXML->append_attribute(doc.allocate_attribute("name", XMLConverter::ConvertString(resourceGroupName)));
				resourceLocationXML->append_attribute(doc.allocate_attribute("type", XMLConverter::ConvertString(path->archive->getType())));
				resourceLocationXML->append_attribute(doc.allocate_attribute("path", XMLConverter::ConvertString(path->archive->getName())));
		...
		for (std::vector<Ogre::String>::const_iterator it = this->additionalMeshResources.cbegin(); it != this->additionalMeshResources.cend(); ++it)
		{
			for (auto& path : Ogre::ResourceGroupManager::getSingleton().getResourceLocationList(*it))
			{
				...
				resourceLocationXML->append_attribute(doc.allocate_attribute("name", XMLConverter::ConvertString(*it)));
				resourceLocationXML->append_attribute(doc.allocate_attribute("type", XMLConverter::ConvertString(path->archive->getType())));
				resourceLocationXML->append_attribute(doc.allocate_attribute("path", XMLConverter::ConvertString(path->archive->getName())));
	...
	//			lightXML->append_attribute(doc.allocate_attribute("name", XMLConverter::ConvertString(this->mainLight->getName())));
	//			lightXML->append_attribute(doc.allocate_attribute("id", XMLConverter::ConvertString(id)));
	//			lightXML->append_attribute(doc.allocate_attribute("type", XMLConverter::ConvertString(lightType[this->mainLight->getType()])));
	//			lightXML->append_attribute(doc.allocate_attribute("castShadows", XMLConverter::ConvertString(this->mainLight->getCastShadows())));

	//			// Position
	//			{
	//				xml_node<>* positionXML = doc.allocate_node(node_element, "position");
	//				positionXML->append_attribute(doc.allocate_attribute("x", XMLConverter::ConvertString(this->mainLight->getParentSceneNode()->_getDerivedPositionUpdated().x)));
	//				positionXML->append_attribute(doc.allocate_attribute("y", XMLConverter::ConvertString(this->mainLight->getParentSceneNode()->_getDerivedPositionUpdated().y)));
	//				positionXML->append_attribute(doc.allocate_attribute("z", XMLConverter::ConvertString(this->mainLight->getParentSceneNode()->_getDerivedPositionUpdated().z)));
	...
	//				directionVectorXML->append_attribute(doc.allocate_attribute("x", XMLConverter::ConvertString(this->mainLight->getDirection().x)));
	//				directionVectorXML->append_attribute(doc.allocate_attribute("y", XMLConverter::ConvertString(this->mainLight->getDirection().y)));
	//				directionVectorXML->append_attribute(doc.allocate_attribute("z", XMLConverter::ConvertString(this->mainLight->getDirection().z)));
	...
	//				colourDiffuseXML->append_attribute(doc.allocate_attribute("r", XMLConverter::ConvertString(this->mainLight->getDiffuseColour().r)));
	//				colourDiffuseXML->append_attribute(doc.allocate_attribute("g", XMLConverter::ConvertString(this->mainLight->getDiffuseColour().g)));
	//				colourDiffuseXML->append_attribute(doc.allocate_attribute("b", XMLConverter::ConvertString(this->mainLight->getDiffuseColour().b)));
	//				colourDiffuseXML->append_attribute(doc.allocate_attribute("a", XMLConverter::ConvertString(this->mainLight->getDiffuseColour().a)));
	...
	//				colourSpecularXML->append_attribute(doc.allocate_attribute("r", XMLConverter::ConvertString(this->mainLight->getSpecularColour().r)));
	//				colourSpecularXML->append_attribute(doc.allocate_attribute("g", XMLConverter::ConvertString(this->mainLight->getSpecularColour().g)));
	//				colourSpecularXML->append_attribute(doc.allocate_attribute("b", XMLConverter::ConvertString(this->mainLight->getSpecularColour().b)));
	//				colourSpecularXML->append_attribute(doc.allocate_attribute("a", XMLConverter::ConvertString(this->mainLight->getSpecularColour().a)));
		...
		if (nullptr != this->ogreNewt)
		{
			// OgreNewt
			{
				// Main parameters
				{
					...
					xmlNode->append_attribute(doc.allocate_attribute("solverModel", XMLConverter::ConvertString(this->ogreNewt->getSolverModel())));
					xmlNode->append_attribute(doc.allocate_attribute("multithreadSolverOnSingleIsland", XMLConverter::ConvertString(this->ogreNewt->getMultithreadSolverOnSingleIsland())));
					xmlNode->append_attribute(doc.allocate_attribute("broadPhaseAlgorithm", XMLConverter::ConvertString(this->ogreNewt->getBroadPhaseAlgorithm())));
					xmlNode->append_attribute(doc.allocate_attribute("threadCount", XMLConverter::ConvertString(this->ogreNewt->getThreadCount())));
					xmlNode->append_attribute(doc.allocate_attribute("desiredFps", XMLConverter::ConvertString(this->ogreNewt->getDesiredFps())));
					xmlNode->append_attribute(doc.allocate_attribute("defaultLinearDamping", XMLConverter::ConvertString(this->ogreNewt->getDefaultLinearDamping())));

					xml_node<>*  dampingXML = doc.allocate_node(node_element, "defaultAngularDamping");
					dampingXML->append_attribute(doc.allocate_attribute("x", XMLConverter::ConvertString(this->ogreNewt->getDefaultAngularDamping().x)));
					dampingXML->append_attribute(doc.allocate_attribute("y", XMLConverter::ConvertString(this->ogreNewt->getDefaultAngularDamping().y)));
					dampingXML->append_attribute(doc.allocate_attribute("z", XMLConverter::ConvertString(this->ogreNewt->getDefaultAngularDamping().z)));
					xmlNode->append_node(dampingXML);

					xml_node<>* gravityXML = doc.allocate_node(node_element, "globalGravity");
					gravityXML->append_attribute(doc.allocate_attribute("x", XMLConverter::ConvertString(AppStateManager::getSingletonPtr()->getOgreNewtModule()->getGlobalGravity().x)));
					gravityXML->append_attribute(doc.allocate_attribute("y", XMLConverter::ConvertString(AppStateManager::getSingletonPtr()->getOgreNewtModule()->getGlobalGravity().y)));
					gravityXML->append_attribute(doc.allocate_attribute("z", XMLConverter::ConvertString(AppStateManager::getSingletonPtr()->getOgreNewtModule()->getGlobalGravity().z)));
	...
	void DotSceneExportModule::exportOgreRecast(rapidxml::xml_node<>* xmlNode, rapidxml::xml_document<>& doc)
	{
		// Ogre Recast
		{
			// Main parameters
			{
				...
				if (nullptr != recast)
				{
					xmlNode->append_attribute(doc.allocate_attribute("CellSize", XMLConverter::ConvertString(recast->getConfigParams().getCellSize())));
					xmlNode->append_attribute(doc.allocate_attribute("CellHeight", XMLConverter::ConvertString(recast->getConfigParams().getCellHeight())));
					xmlNode->append_attribute(doc.allocate_attribute("AgentMaxSlope", XMLConverter::ConvertString(recast->getConfigParams().getAgentMaxSlope())));
					xmlNode->append_attribute(doc.allocate_attribute("AgentMaxClimb", XMLConverter::ConvertString(recast->getConfigParams().getAgentMaxClimb())));
					xmlNode->append_attribute(doc.allocate_attribute("AgentHeight", XMLConverter::ConvertString(recast->getConfigParams().getAgentHeight())));
					xmlNode->append_attribute(doc.allocate_attribute("AgentRadius", XMLConverter::ConvertString(recast->getConfigParams().getAgentRadius())));
					xmlNode->append_attribute(doc.allocate_attribute("EdgeMaxLen", XMLConverter::ConvertString(recast->getConfigParams().getEdgeMaxLen())));
					xmlNode->append_attribute(doc.allocate_attribute("EdgeMaxError", XMLConverter::ConvertString(recast->getConfigParams().getEdgeMaxError())));
					xmlNode->append_attribute(doc.allocate_attribute("RegionMinSize", XMLConverter::ConvertString(recast->getConfigParams().getRegionMinSize())));
					xmlNode->append_attribute(doc.allocate_attribute("RegionMergeSize", XMLConverter::ConvertString(recast->getConfigParams().getRegionMergeSize())));
					xmlNode->append_attribute(doc.allocate_attribute("VertsPerPoly", XMLConverter::ConvertString(recast->getConfigParams().getVertsPerPoly())));
					xmlNode->append_attribute(doc.allocate_attribute("DetailSampleDist", XMLConverter::ConvertString(recast->getConfigParams().getDetailSampleDist())));
					xmlNode->append_attribute(doc.allocate_attribute("DetailSampleMaxError", XMLConverter::ConvertString(recast->getConfigParams().getDetailSampleMaxError())));
					xmlNode->append_attribute(doc.allocate_attribute("KeepInterResults", XMLConverter::ConvertString(recast->getConfigParams().getKeepInterResults())));

					xml_node<>*  pointExtendsXML = doc.allocate_node(node_element, "PointExtends");
					pointExtendsXML->append_attribute(doc.allocate_attribute("x", XMLConverter::ConvertString(recast->getPointExtents().x)));
					pointExtendsXML->append_attribute(doc.allocate_attribute("y", XMLConverter::ConvertString(recast->getPointExtents().y)));
					pointExtendsXML->append_attribute(doc.allocate_attribute("z", XMLConverter::ConvertString(recast->getPointExtents().z)));
	...
	//		cameraXML->append_attribute(doc.allocate_attribute("name", XMLConverter::ConvertString(this->mainCamera->getName())));
	//		cameraXML->append_attribute(doc.allocate_attribute("id", XMLConverter::ConvertString(hash(this->mainCamera->getName()))));
	//		cameraXML->append_attribute(doc.allocate_attribute("fov", XMLConverter::ConvertString(this->mainCamera->getFOVy())));
	//		cameraXML->append_attribute(doc.allocate_attribute("projectionType", XMLConverter::ConvertString(projectionTypes[this->mainCamera->getProjectionType()])));
	...
	//			orientationXML->append_attribute(doc.allocate_attribute("qw", XMLConverter::ConvertString(this->mainCamera->getDerivedOrientation().w)));
	//			orientationXML->append_attribute(doc.allocate_attribute("qx", XMLConverter::ConvertString(this->mainCamera->getDerivedOrientation().x)));
	//			orientationXML->append_attribute(doc.allocate_attribute("qy", XMLConverter::ConvertString(this->mainCamera->getDerivedOrientation().y)));
	//			orientationXML->append_attribute(doc.allocate_attribute("qz", XMLConverter::ConvertString(this->mainCamera->getDerivedOrientation().z)));
...
// Attention: Check this! As ragdoll will store lots of nodes without name (bones)
		...
		// Node
		{
			...
			nodeXML->append_attribute(doc.allocate_attribute("name", XMLConverter::ConvertString(ogreNode->getName())));

			nodeXML->append_attribute(doc.allocate_attribute("id", XMLConverter::ConvertString(static_cast<unsigned int>(hash(ogreNode->getName())))));
			...
			// Position
			{
				...
				xml_node<>* positionXML = doc.allocate_node(node_element, "position");
				positionXML->append_attribute(doc.allocate_attribute("x", XMLConverter::ConvertString(position.x)));
				positionXML->append_attribute(doc.allocate_attribute("y", XMLConverter::ConvertString(position.y)));
				positionXML->append_attribute(doc.allocate_attribute("z", XMLConverter::ConvertString(position.z)));
			...
			// Rotation
			{
				...
				xml_node<>* rotationXML = doc.allocate_node(node_element, "rotation");
				rotationXML->append_attribute(doc.allocate_attribute("qw", XMLConverter::ConvertString(orientation.w)));
				rotationXML->append_attribute(doc.allocate_attribute("qx", XMLConverter::ConvertString(orientation.x)));
				rotationXML->append_attribute(doc.allocate_attribute("qy", XMLConverter::ConvertString(orientation.y)));
				rotationXML->append_attribute(doc.allocate_attribute("qz", XMLConverter::ConvertString(orientation.z)));
			...
			// Scale
			{
				...
				scaleXML->append_attribute(doc.allocate_attribute("x", XMLConverter::ConvertString(scale.x)));
				scaleXML->append_attribute(doc.allocate_attribute("y", XMLConverter::ConvertString(scale.y)));
				scaleXML->append_attribute(doc.allocate_attribute("z", XMLConverter::ConvertString(scale.z)));
	...
	void DotSceneExportModule::exportEntity(GameObject* gameObject, Ogre::v1::Entity* entity, rapidxml::xml_node<>* nodeXML, rapidxml::xml_document<>& doc, const Ogre::String& filePath)
	{
		// Entity
		{
			...
			entityXML->append_attribute(doc.allocate_attribute("name", XMLConverter::ConvertString(entity->getName())));
			...
			entityXML->append_attribute(doc.allocate_attribute("meshFile", XMLConverter::ConvertString(meshFile)));
			entityXML->append_attribute(doc.allocate_attribute("castShadows", XMLConverter::ConvertString(entity->getCastShadows())));
			entityXML->append_attribute(doc.allocate_attribute("visible", XMLConverter::ConvertString(entity->getVisible())));
			...
			// SubEntity
			{
				for (unsigned int i = 0; i < entity->getNumSubEntities(); i++)
				{
					...
					subEntityXML->append_attribute(doc.allocate_attribute("index", XMLConverter::ConvertString(i)));
					subEntityXML->append_attribute(doc.allocate_attribute("datablockName", XMLConverter::ConvertString(*subEntity->getDatablock()->getNameStr())));
	...
	void DotSceneExportModule::exportItem(GameObject* gameObject, Ogre::Item* item, rapidxml::xml_node<>* nodeXML, rapidxml::xml_document<>& doc, const Ogre::String& filePath)
	{
		// Entity
		{
			...
			entityXML->append_attribute(doc.allocate_attribute("name", XMLConverter::ConvertString(item->getName())));
			...
			entityXML->append_attribute(doc.allocate_attribute("meshFile", XMLConverter::ConvertString(meshFile)));
			entityXML->append_attribute(doc.allocate_attribute("castShadows", XMLConverter::ConvertString(item->getCastShadows())));
			entityXML->append_attribute(doc.allocate_attribute("visible", XMLConverter::ConvertString(item->getVisible())));
			...
			// SubItem
			{
				for (unsigned int i = 0; i < item->getNumSubItems(); i++)
				{
					...
					subEntityXML->append_attribute(doc.allocate_attribute("index", XMLConverter::ConvertString(i)));
					subEntityXML->append_attribute(doc.allocate_attribute("datablockName", XMLConverter::ConvertString(*subItem->getDatablock()->getNameStr())));
					entityXML->append_node(subEntityXML);
				}
			}
	...
	void DotSceneExportModule::exportManualObject(GameObject* gameObject, Ogre::ManualObject* manualObject, rapidxml::xml_node<>* nodeXML, rapidxml::xml_document<>& doc, const Ogre::String& filePath)
	{
		// ManualObject
		{
			...
			manualObjectXML->append_attribute(doc.allocate_attribute("name", XMLConverter::ConvertString(manualObject->getName())));

			manualObjectXML->append_attribute(doc.allocate_attribute("castShadows", XMLConverter::ConvertString(manualObject->getCastShadows())));
			manualObjectXML->append_attribute(doc.allocate_attribute("visible", XMLConverter::ConvertString(manualObject->getVisible())));
	...
	void DotSceneExportModule::exportTerra(GameObject* gameObject, Ogre::Terra* terra, rapidxml::xml_node<>* nodeXML, rapidxml::xml_document<>& doc, const Ogre::String& filePath)
	{
		// Terra
		{
			...
			terraXML->append_attribute(doc.allocate_attribute("name", XMLConverter::ConvertString(terra->getName())));
			terraXML->append_attribute(doc.allocate_attribute("visible", XMLConverter::ConvertString(terra->getVisible())));
