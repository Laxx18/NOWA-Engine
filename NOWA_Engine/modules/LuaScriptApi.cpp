...
#define AddClassToCollection(className, function, description) LuaScriptApi::getInstance()->addClassToCollection(className, function, description)

#define AddFunctionToCollection(function, description) LuaScriptApi::getInstance()->addFunctionToCollection(function, description)
...
namespace NOWA
{
    ...
    {
        module(lua)[class_<String>("String")];

        luabind::module(lua)[luabind::def("log", &luaLogNormal)];

        luabind::module(lua)[luabind::def("logCritical", &luaLogCritical)];

        luabind::module(lua)[luabind::def("toString", (Ogre::String (*)(const Vector2&))&toString)];

        luabind::module(lua)[luabind::def("toString", (Ogre::String (*)(const Vector3&))&toString)];

        luabind::module(lua)[luabind::def("toString", (Ogre::String (*)(const Vector4&))&toString)];

        luabind::module(lua)[luabind::def("toString", (Ogre::String (*)(const Quaternion&))&toString)];

        luabind::module(lua)[luabind::def("toString", (Ogre::String (*)(double))&toString)];

        luabind::module(lua)[luabind::def("toString", (Ogre::String (*)(const ColourValue&))&toString)];
        ...
        */
        luabind::module(lua)[luabind::def("toStringRadian", (Ogre::String (*)(const Radian&))&toString)];

        luabind::module(lua)[luabind::def("toStringDegree", (Ogre::String (*)(const Degree&))&toString)];

        luabind::module(lua)[luabind::def("toString", (Ogre::String (*)(bool))&toString)];

        luabind::module(lua)[luabind::def("matches", &matches)];
    ...
    {
        module(lua)[class_<Degree>("Degree")
                .def(constructor<>())
                .def(constructor<const Degree&>())
                .def(constructor<Real>())
                .def(constructor<const Radian&>())
    ...
    {
        module(lua)[class_<Vector2>("Vector2")
    ...
    {
        module(lua)[class_<Vector3>("Vector3")
        ...
        AddClassToCollection("Vector3", "Radian getRotationTo(Vector3 other, Vector3 fallbackAxis)",
        ...
        AddClassToCollection("Vector3", "bool positionCloses(Vector3 other, float tolerance)",
            "Returns whether this vector is within a positional tolerance of another vector, also take scale of the vectors into account. Note: Default tolerance is 1e-03f");
    ...
    {
        module(lua)[class_<Vector4>("Vector4")
    ...
    {
        module(lua)[class_<Ogre::Quaternion>("Quaternion")
        ...
        AddClassToCollection("Quaternion", "Quaternion unitInverse()",
            "Returns the inverse quaternion for angle subtract operations. Note: Apply to unit-length quaternion. That means quaternion must be normalized! After that this operation is cheaper.");
        ...
        AddClassToCollection("Quaternion", "Radian getRoll(bool reprojectAxis)",
            "Calculate the local roll element of this quaternion. Note: reprojectAxis By default the method returns the 'intuitive' result"
        ...
        AddClassToCollection("Quaternion", "Radian getPitch(bool reprojectAxis)",
            "Calculate the local pitch element of this quaternion. Note: reprojectAxis By default the method returns the 'intuitive' result"
        ...
        AddClassToCollection("Quaternion", "Radian getYaw(bool reprojectAxis)",
            "Calculate the local yaw element of this quaternion. Note: reprojectAxis By default the method returns the 'intuitive' result"
        ...
        AddClassToCollection("Quaternion", "bool orientationEquals(Quaternion other, float tolerance)",
            "Compare two quaternions which are assumed to be used as orientations. Note:"
        ...
        AddClassToCollection("Quaternion", "Quaternion slerp(float fT, Quaternion rkP, Quaternion rkQ, bool shortestPath",
        ...
        AddClassToCollection("Quaternion", "Quaternion slerpExtraSpins (float fT, Quaternion rkP, Quaternion rkQ, int iExtraSpins)",
            "@see Slerp. It adds extra 'spins' (i.e. rotates several times) specified by parameter 'iExtraSpins' while interpolating before arriving to the final values");
        ...
        AddClassToCollection("Quaternion", "Quaternion nlerp(float fT, Quaternion rkP,  Quaternion rkQ, bool shortestPath",
    ...
    {
        module(lua)[class_<ColourValue>("ColorValue")
                .def(constructor<>())
                .def(constructor<Real, Real, Real, Real>())
                .def(constructor<Real, Real, Real>())
                .def(tostring(self))
    ...
    {
        module(lua)[class_<MovableObject>("MovableObject")
    ...
    {
        module(lua)[class_<Node>("Node").enum_("TransformSpace")[value("TS_LOCAL", Ogre::Node::TS_LOCAL), value("TS_PARENT", Ogre::Node::TS_PARENT), value("TS_WORLD", Ogre::Node::TS_WORLD)]];

        module(lua)[class_<SceneNode, Node>("SceneNode")
        ...
        AddClassToCollection("SceneNode", "void setPosition2(float x, float y, float z)",
            "Sets the position of this node. Note: When a PhysicsComponent is used, this function has no effect. The function must then be called for the PhysicsComponent.");
        AddClassToCollection("SceneNode", "void translate(Vector3 vector)",
            "Translates the node by the given vector from its current position. Note: When a PhysicsComponent is used, this function has no effect. The function must then be called for the PhysicsComponent.");
        AddClassToCollection("SceneNode", "void translate2(float x, float y, float z)",
            "Translates the node by the given vector from its current position. Note: When a PhysicsComponent is used, this function has no effect. The function must then be called for the PhysicsComponent.");
        AddClassToCollection("SceneNode", "void setDirection(Vector3 vector, TransformSpace space)",
            "Sets the direction of this node. Note: When a PhysicsComponent is used, this function has no effect. The function must then be called for the PhysicsComponent.");
        AddClassToCollection("SceneNode", "void setDirection2(float x, float y, float z, TransformSpace space)",
            "Sets the direction of this node. Note: When a PhysicsComponent is used, this function has no effect. The function must then be called for the PhysicsComponent.");
        ...
        AddClassToCollection("SceneNode", "void setOrientation(Quaternion quaternion)",
            "Sets the absolute orientation of this node. Note: When a PhysicsComponent is used, this function has no effect. The function must then be called for the PhysicsComponent.");
        AddClassToCollection("SceneNode", "void setOrientation2(float w, float x, float y, float z)",
            "Sets the absolute orientation of this node. Note: When a PhysicsComponent is used, this function has no effect. The function must then be called for the PhysicsComponent.");
        ...
        AddClassToCollection("SceneNode", "void rotate2(float w, float x, float y, float z)",
            "Rotates the node relative. Note: When a PhysicsComponent is used, this function has no effect. The function must then be called for the PhysicsComponent.");
    ...
    {
        module(lua)[class_<Ogre::SceneManager>("SceneManager")
            // destroy funcs
        ...
        module(lua)[class_<Ogre::v1::OldNode>("OldNode")
                .enum_("TransformSpace")[value("TS_LOCAL", Ogre::v1::OldNode::TS_LOCAL), value("TS_PARENT", Ogre::v1::OldNode::TS_PARENT), value("TS_WORLD", Ogre::v1::OldNode::TS_WORLD)]
        ...
        module(lua)[class_<Ogre::v1::Skeleton>("Skeleton").def("setBindingPose", &Ogre::v1::Skeleton::setBindingPose).def("reset", &Ogre::v1::Skeleton::reset)];
        // ??

        module(lua)[class_<Ogre::v1::OldBone, Ogre::v1::OldNode>("OldBone")
        ...
        AddClassToCollection("OldBone", "Quaternion convertLocalToWorldOrientation(Quaternion localOrientation)",
    ...
    {
        module(lua)[class_<Camera>("Camera")
...
*/
    ...
    void bindGameObject(lua_State* lua, class_<GameObject>& gameObjectClass)
    {
        ...
        AddClassToCollection("GameObject", "string getCategory()",
            "Gets the category to which this game object does belong. Note: This is useful when doing ray-casts on graphics base or physics base or creating physics materials between categories.");
        AddClassToCollection("GameObject", "string getTagName()",
            "Gets the tag name of game object. Note: Tags are like sub-categories. E.g. several game objects may belong to the category 'Enemy', but one group may have a tag name 'Stone', the other 'Ship1', 'Ship2' etc. "
        ...
        AddClassToCollection("GameObject", "setActivatedSpecific(bool activated, table ids)",
            "Like setActivated, but only affects components whose class id (or a parent class id) is contained in the given table of component class ids (numbers). Only affects components that have not yet been connected (e.g. freshly cloned at "
            "runtime).");
        AddClassToCollection("GameObject", "setActivatedSpecific2(bool activated, table componentNames)",
            "Like setActivated, but only affects components whose (custom or class) name is contained in the given table of strings. Only affects components that have not yet been connected (e.g. freshly cloned at runtime).");
        AddClassToCollection("GameObject", "string getCategoryId()",
            "Gets the category id to which this game object does belong. Note: This is useful when doing ray-casts on graphics base or physics base or creating physics materials between categories.");
        ...
        AddClassToCollection("GameObject", "void setReferenceId(String referenceId)",
            "Sets the reference id. Note: If this game object is referenced by another game object, a component with the same id as this game object can be get for activation etc.");
        ...
        AddClassToCollection("GameObject", "PhysicsMaterialComponent getPhysicsMaterialComponentFromIndex(unsigned int occurrenceIndex)",
            "Gets the physics material component by the given occurence index, since a game object may have besides other components several physics material components.");
        ...
        AddClassToCollection("GameObject", "SimpleSoundComponent getSimpleSoundComponentFromIndex(unsigned int occurrenceIndex)",
            "Gets the simple sound component by the given occurence index, since a game object may have besides other components several simple sound components.");
        ...
        AddClassToCollection("GameObject", "SoundComponent getSoundComponentFromIndex(unsigned int occurrenceIndex)",
            "Gets the sound component by the given occurence index, since a game object may have besides other components several sound components.");
        ...
        AddClassToCollection("GameObject", "TagChildNodeComponent getTagChildNodeComponent(unsigned int occurrenceIndex)",
            "Gets the tag child node component by the given occurence index, since a game object may have besides other components several tag child node components.");
        ...
        AddClassToCollection("GameObject", "MyGUIWindowComponent getMyGUIWindowComponentFromIndex(unsigned int occurrenceIndex)",
            "Gets the MyGUI window component by the given occurence index, since a game object may have besides other components several MyGUI window components.");
        ...
        AddClassToCollection("GameObject", "MyGUITextComponent getMyGUITextComponentFromIndex(unsigned int occurrenceIndex)",
            "Gets the MyGUI text component by the given occurence index, since a game object may have besides other components several MyGUI text components.");
        ...
        AddClassToCollection("GameObject", "MyGUIButtonComponent getMyGUIButtonComponentFromIndex(unsigned int occurrenceIndex)",
            "Gets the MyGUI button component by the given occurence index, since a game object may have besides other components several MyGUI button components.");
        ...
        AddClassToCollection("GameObject", "MyGUICheckBoxComponent getMyGUICheckBoxComponentFromIndex(unsigned int occurrenceIndex)",
            "Gets the MyGUI check box component by the given occurence index, since a game object may have besides other components several MyGUI check box components.");
        ...
        AddClassToCollection("GameObject", "MyGUIImageBoxComponent getMyGUIImageBoxComponentFromIndex(unsigned int occurrenceIndex)",
            "Gets the MyGUI image box component by the given occurence index, since a game object may have besides other components several MyGUI image box components.");
        ...
        AddClassToCollection("GameObject", "MyGUIProgressBarComponent getMyGUIProgressBarComponentFromIndex(unsigned int occurrenceIndex)",
            "Gets the MyGUI progress bar component by the given occurence index, since a game object may have besides other components several MyGUI progress bar components.");
        ...
        AddClassToCollection("GameObject", "MyGUIListBoxComponent getMyGUIListBoxComponentFromIndex(unsigned int occurrenceIndex)",
            "Gets the MyGUI list box component by the given occurence index, since a game object may have besides other components several MyGUI list box components.");
        ...
        AddClassToCollection("GameObject", "MyGUIComboBoxComponent getMyGUIComboBoxComponentFromIndex(unsigned int occurrenceIndex)",
            "Gets the MyGUI combo box component by the given occurence index, since a game object may have besides other components several MyGUI combo box components.");
        ...
        AddClassToCollection("GameObject", "MyGUIMessageBoxComponent getMyGUIMessageBoxComponentFromIndex(unsigned int occurrenceIndex)",
            "Gets the MyGUI message box component by the given occurence index, since a game object may have besides other components several MyGUI message box components.");
        ...
        AddClassToCollection("GameObject", "MyGUIPositionControllerComponent getMyGUIPositionControllerComponentFromIndex(unsigned int occurrenceIndex)",
            "Gets the MyGUI position controller component by the given occurence index, since a game object may have besides other components several MyGUI position controller components.");
        AddClassToCollection("GameObject", "MyGUIPositionControllerComponent getMyGUIPositionControllerComponent()",
            "Gets the MyGUI position controller component. This can be used if the game object just has one MyGUI position controller component.");
        AddClassToCollection("GameObject", "MyGUIFadeAlphaControllerComponent getMyGUIFadeAlphaControllerComponentFromIndex(unsigned int occurrenceIndex)",
            "Gets the MyGUI fade alpha controller component by the given occurence index, since a game object may have besides other components several MyGUI fade alpha components.");
        AddClassToCollection("GameObject", "MyGUIFadeAlphaControllerComponent getMyGUIFadeAlphaControllerComponent()",
            "Gets the MyGUI fade alpha controller component. This can be used if the game object just has one MyGUI fade alpha controller component.");
        AddClassToCollection("GameObject", "MyGUIScrollingMessageControllerComponent getMyGUIScrollingMessageControllerComponentFromIndex(unsigned int occurrenceIndex)",
            "Gets the MyGUI scrolling message controller component by the given occurence index, since a game object may have besides other components several MyGUI scrolling message components.");
        AddClassToCollection("GameObject", "MyGUIScrollingMessageControllerComponent getMyGUIFScrollingMessageControllerComponent()",
            "Gets the MyGUI scrolling message controller component. This can be used if the game object just has one MyGUI scrolling message controller component.");
        AddClassToCollection("GameObject", "MyGUIEdgeHideControllerComponent getMyGUIEdgeHideControllerComponentFromIndex(unsigned int occurrenceIndex)",
            "Gets the MyGUI hide edge controller component by the given occurence index, since a game object may have besides other components several MyGUI hide edge components.");
        AddClassToCollection("GameObject", "MyGUIEdgeHideControllerComponent getMyGUIEdgeHideControllerComponent()",
            "Gets the MyGUI hide edge controller component. This can be used if the game object just has one MyGUI hide edge controller component.");
        AddClassToCollection("GameObject", "MyGUIRepeatClickControllerComponent getMyGUIRepeatClickControllerComponentFromIndex(unsigned int occurrenceIndex)",
            "Gets the MyGUI repeat click controller component by the given occurence index, since a game object may have besides other components several MyGUI repeat click components.");
        AddClassToCollection("GameObject", "MyGUIRepeatClickControllerComponent getMyGUIRepeatClickControllerComponent()",
            "Gets the MyGUI repeat click controller component. This can be used if the game object just has one MyGUI repeat click controller component.");
        ...
        AddClassToCollection("GameObject", "PlayerControllerJumpNRunLuaComponent getPlayerControllerJumpNRunLuaComponentFromName(String name)",
            "Gets the player controller Jump N Run Lua component. Requirements: A physics active component and a LuaScriptComponent.");
        ...
        AddClassToCollection("GameObject", "TagChildNodeComponent getTagChildNodeComponentFromName(String nameunsigned int occurrenceIndex)",
            "Gets the tag child node component by the given occurence index, since a game object may have besides other components several tag child node components.");
    ...
    GameObject* clone(GameObjectController* instance, const Ogre::String& originalGameObjectId, Ogre::SceneNode* parentNode, const Ogre::String& targetId, const Ogre::Vector3& targetPosition, const Ogre::Quaternion& targetOrientation,
    ...
    {
        ENQUEUE_RENDER_COMMAND_MULTI_NO_THIS("PointerManager::showMouse", _2(instance, bShow), { instance->setVisible(bShow); });
    }
    ...
    void bindMyGUI(lua_State* lua)
    {
        ...
        module(lua)[class_<MyGUI::Align>("Align").enum_("Enum")[value("H_CENTER", MyGUI::Align::HCenter), value("V_CENTER", MyGUI::Align::VCenter), value("CENTER", MyGUI::Align::Center), value("LEFT", MyGUI::Align::Left),
            value("RIGHT", MyGUI::Align::Right), value("H_STRECH", MyGUI::Align::HStretch), value("TOP", MyGUI::Align::Top), value("BOTTOM", MyGUI::Align::Bottom), value("V_STRETCH", MyGUI::Align::VStretch), value("STRETCH", MyGUI::Align::Stretch),
        ...
        module(lua)[class_<MyGUI::WidgetStyle>("WidgetStyle").enum_("Enum")[value("CHILD", MyGUI::WidgetStyle::Child), value("POPUP", MyGUI::WidgetStyle::Popup), value("OVERLAPPED", MyGUI::WidgetStyle::Overlapped)]];
        ...
        module(lua)[class_<MyGUI::IntCoord>("IntCoord")
        ...
        module(lua)[class_<MyGUI::FloatCoord>("FloatCoord")
        ...
        module(lua)[class_<MyGUI::IntSize>("IntSize")
        ...
        module(lua)[class_<MyGUI::FloatSize>("FloatSize")
        ...
        module(lua)[class_<MyGUI::Widget>("Widget")
        ...
        module(lua)[class_<MyGUI::EditBox, MyGUI::Widget>("EditBox")
        ...
        module(lua)[class_<MyGUI::Button, MyGUI::Widget>("Button").def("setStateCheck", &MyGUI::Button::setStateCheck).def("getStateCheck", &MyGUI::Button::getStateCheck)];
        ...
        module(lua)[class_<MyGUI::Window, MyGUI::Widget>("Window").def("setMovable", &MyGUI::Window::setMovable).def("getMovable", &MyGUI::Window::getMovable)];
        ...
        module(lua)[class_<MyGUI::ImageBox, MyGUI::Widget>("ImageBox").def("setImageTexture", &MyGUI::ImageBox::setImageTexture)];
        ...
        module(lua)[class_<MyGUI::ListBox, MyGUI::Widget>("ListBox")
        ...
        module(lua)[class_<MyGUI::PointerManager>("PointerManager")
    ...
    void bindGameProgressModule(lua_State* lua)
    {
        ...
        AddClassToCollection("GameProgressModule", "void saveProgress(String saveName, bool crypted, bool sceneSnapshot)",
            "Saves the current progress for all game objects with its attribute components. "
            "Optionally crypts the content, so that it is not readable anymore. Optionally can saves a whole scene snapshot");
        AddClassToCollection("GameProgressModule", "String saveValue(String saveName, String gameObjectId, unsigned int attributeIndex, bool crypted)",
        ...
        AddClassToCollection("GameProgressModule", "bool loadValue(String saveName, String gameObjectId)",
            "Loads all values for the given game object id and the given save name. Returns false, if no save file could be found or game object id is invalid.");

        AddClassToCollection("GameProgressModule", "Variant getGlobalValue(String attributeName)",
            "Gets the Variant global value from attribute name. Note: Global values are stored directly in GameProgressModule. Note: Global values are stored directly in GameProgressModule."
            "They can be used for the whole game logic, like which boss has been defeated etc.");
        AddClassToCollection("GameProgressModule", "Variant setGlobalBoolValue(String attributeName, bool value)",
            "Sets the bool value for the given attribute name and returns the global Variant. Note: Global values are stored directly in GameProgressModule. "
            "They can be used for the whole game logic, like which boss has been defeated etc.");
        AddClassToCollection("GameProgressModule", "Variant setGlobalNumberValue(String attributeName, number value)",
            "Sets the number value for the given attribute name and returns the global Variant. Note: Global values are stored directly in GameProgressModule. "
            "They can be used for the whole game logic, like which boss has been defeated etc.");
        AddClassToCollection("GameProgressModule", "Variant setGlobalStringValue(String attributeName, String value)",
            "Sets the string value for the given attribute name and returns the global Variant. Note: Global values are stored directly in GameProgressModule. "
            "They can be used for the whole game logic, like which boss has been defeated etc.");
        AddClassToCollection("GameProgressModule", "Variant setGlobalVector2Value(String attributeName, Vector2 value)",
            "Sets the Vector2 value for the given attribute name and returns the global Variant. Note: Global values are stored directly in GameProgressModule. "
            "They can be used for the whole game logic, like which boss has been defeated etc.");
        AddClassToCollection("GameProgressModule", "Variant setGlobalVector3Value(String attributeName, Vector3 value)",
            "Sets the Vector3 value for the given attribute name and returns the global Variant. Note: Global values are stored directly in GameProgressModule. "
            "They can be used for the whole game logic, like which boss has been defeated etc.");
    ...
    void bindGameObjectController(lua_State* lua, class_<GameObjectController>& gameObjectControllerClass)
    {
        ...
        gameObjectControllerClass.def("castContact", &GameObjectController::cast<OgreNewt::ContactSnapshot>);
        ...
        AddClassToCollection("GameObjectController", "void undoAll()",
            "Does undo all steps in the simulation. Note: This function is really important to get back a scene before e.g. in the NOWA-Design the play button has been clicked. "
        ...
        AddClassToCollection("GameObjectController", "void deleteGameObjectWithUndo(String gameObjectId)",
            "Deletes the game object by id.Note: The game object by the given id will not be deleted immediately but in the next update turn. "
        ...
        AddClassToCollection("GameObjectController", "void clone(String originalGameObjectId, SceneNode parentNode, String targetId, Vector3 targetPosition, Quaternion targetOrientation, Vector3 targetScale)",
            "Clones a game object with all its components.");
        ...
        AddClassToCollection("GameObjectController", "GameObject getClonedGameObjectFromPriorId(String gameObjectId)",
            "Gets a cloned game object by its prior id. This can be used, when a game object has been cloned, it gets a new id, but a trace of its prior id can be made, so that a matching can be done, which game object has been cloned.");
        AddClassToCollection("GameObjectController", "Table[number][GameObject] getGameObjectsFromCategory(string category)",
            "Gets all game objects that are belonging to the given category as lua table. Which can be traversed via 'for key, category in categories do'.");
        AddClassToCollection("GameObjectController", "Table[number][GameObject] getGameObjectsFromRenderCategory(string Renderategory)",
            "Gets all game objects that are belonging to the given render category as lua table. Which can be traversed via 'for key, renderCategory in renderCategories do'.");
        AddClassToCollection("GameObjectController", "Table[number][GameObject] getGameObjectsFromComponent(string componentClassName)",
            "Gets all game objects that are belonging to the given category as lua table. Which can be traversed via 'for key, gameObject in gameObjects do'.");
        AddClassToCollection("GameObjectController", "Table[number][GameObject] getGameObjectsControlledByClientId(unsigned int clientId)",
            "Gets all game objects that are belonging to the given client id in a network scenario as lua table. Which can be traversed via 'for key, gameObject in gameObjects do'.");
        AddClassToCollection("GameObjectController", "Table[number][GameObject] getGameObjectsFromTagName(string tagName)",
            "Gets all game objects that are belonging to the given tag name as lua table. Which can be traversed via 'for key, gameObject in gameObjects do'.");
        ...
        AddClassToCollection("GameObjectController", "Table[number][string] getIdsFromCategory(string category)",
            "Gets all game object ids that are belonging to the given category as lua table. Which can be traversed via 'for key, category in categories do'.");
        AddClassToCollection("GameObjectController", "Table[number][string] getIdsFromRenderCategory(string RenderCategory)",
            "Gets all game object ids that are belonging to the given render category as lua table. Which can be traversed via 'for key, renderCategory in renderCategories do'.");
        AddClassToCollection("GameObjectController", "Table[number][string] getOtherIdsFromCategory(GameObject excludedGameObject, string category)",
            "Gets all game object ids besides the excluded one that are belonging to the given category as lua table. Which can be traversed via 'for key, category in categories do'.");
        AddClassToCollection("GameObjectController", "Table[number][string] getOtherIdsFromRenderCategory(GameObject excludedGameObject, string renderCategory)",
            "Gets all game object ids besides the excluded one that are belonging to the given renderCategory as lua table. Which can be traversed via 'for key, renderCategory in renderCategories do'.");
        ...
        AddClassToCollection("GameObjectController", "Table[number][GameObject] getGameObjectsFromNamePrefix(string pattern)",
            "Gets all game objects that are matching the given pattern as lua table. Which can be traversed via 'for key, gameObject in gameObjects do'.");
        ...
        AddClassToCollection("GameObjectController", "void activatePlayerController(bool active, string gameObjectId, bool onlyOneActive)",
            "Activates the given player component from the given game object id. "
        ...
        AddClassToCollection("GameObjectController", "void activatePlayerControllerForCamera(bool active, string gameObjectId, string cameraGameObjectId, bool onlyOneActive)",
            "Activates the given player component from the given game object id and the given camera game object id. "
            "If set to true, the given player component will be activated, else deactivated. Sets whether only one player instance can be controller. If set to false more player can be controlled, that is each player, that is currently selected."
        ...
        AddClassToCollection("GameObjectController", "GameObject getNextGameObject(int categoryIds)",
            "Gets the next game object from the given group id. "
            "The category ids for filtering. Using ALL_CATEGORIES_ID, everything is selectable.");
        AddClassToCollection("GameObjectController", "GameObject getNextGameObject(int categoryIds)",
            "Gets the next game object from the given group id as string. E.g. 'Player+Enemy'. "
            "The category ids for filtering. Using ALL_CATEGORIES_ID, everything is selectable.");
        ...
        AddClassToCollection("GameObjectController", "MyGUIScrollingMessageControllerComponent castMyGUIScrollingMessageControllerComponent(MyGUIScrollingMessageControllerComponent other)",
    ...
    {
        module(lua)[class_<GameObjectComponent>("GameObjectComponent")
        ...
        AddClassToCollection("GameObject", "void setReferenceId(String referenceId)",
            "Sets the reference id. Note: If this game object is referenced by another game object, a component with the same id as this game object can be get for activation etc.");
        AddClassToCollection("GameObject", "String getReferenceId()", "Gets the reference if another game object does reference it.");
        AddClassToCollection("GameObjectComponent", "number getOccurrenceIndex()",
            "Gets the occurence index of game object component. That is, if a game object has several components of the same time, each component that occurs more than once has a different occurence index than 0.");
        ...
        module(lua)[class_<NodeComponent, GameObjectComponent>("NodeComponent")];
    }
    ...
    {
        module(lua)[class_<Ogre::SkeletonAnimation>("SkeletonAnimation").def("getCurrentTime", &Ogre::SkeletonAnimation::getCurrentTime).def("getDuration", &Ogre::SkeletonAnimation::getDuration).def("setTime", &Ogre::SkeletonAnimation::setTime)];
        ...
        module(lua)[class_<AnimationBlenderV2::BlendSpaceEntryList>("BlendSpaceEntryList")
                .def(constructor<>())
        ...
        AddClassToCollection("BlendSpaceEntryList", "void add(AnimID animationId, float parameter)",
            "Adds a clip and the parameter value it represents, e.g. the speed at which this animation looks right. Entries must be added sorted by parameter ascending.");
        ...
        AddClassToCollection("AnimationBlender", "void blend5(AnimID animationId, BlendingTransition blendingTransition, float duration, bool loop)",
            "Blends to the given animation id with a transition. Sets how long the animation should be played and if the animation should be looped.");
        AddClassToCollection("AnimationBlender", "void blend6(String animationName, BlendingTransition blendingTransition, float duration, bool loop)",
            "Blends to the given animation name with a transition. Sets how long the animation should be played and if the animation should be looped.");
        ...
        AddClassToCollection("AnimationBlender", "void blendAndContinue3(AnimID animationId, float duration)",
            "Blends to the given animation id with a transition. Sets how long the animation should be played. After the animation is finished, the previous one will continue.");
        AddClassToCollection("AnimationBlender", "void blendAndContinue4(String animationName, float duration)",
            "Blends to the given animation name with a transition. Sets how long the animation should be played. After the animation is finished, the previous one will continue.");
        AddClassToCollection("AnimationBlender", "void blendExclusive1(AnimID animationId, BlendingTransition blendingTransition)",
            "Blends to the given animation id with a transition exclusively. The animation will only be blend, if it is not active currently.");
        AddClassToCollection("AnimationBlender", "void blendExclusive2(String animationName, BlendingTransition blendingTransition)",
            "Blends to the given animation name with a transition exclusively. The animation will only be blend, if it is not active currently.");
        AddClassToCollection("AnimationBlender", "void blendExclusive3(AnimID animationId, BlendingTransition blendingTransition, bool loop)",
    ...
    {
        module(lua)[class_<DistributedComponent, GameObjectComponent>("DistributedComponent")
    ...
    {
        module(lua)[class_<GameObjectTitleComponent, GameObjectComponent>("GameObjectTitleComponent")
        ...
        AddClassToCollection("GameObjectTitleComponent", "void setOffsetPosition(Vector3 offsetPosition)",
            "Sets the offset position for the title. Note: Normally the title is placed at the same position as its carrying game object. Hence setting an offset is necessary.");
    ...
    {
        module(lua)[class_<PhysicsBuoyancyComponent, PhysicsComponent>("PhysicsBuoyancyComponent")
        ...
        AddClassToCollection("PhysicsBuoyancyComponent", "void setCategories(String categories)",
            "Sets categories which can be managed by buoyancy (may be composed: e.g. ALL or ALL-House+Floor to get specifig game objects with physics active component to manage.");
        ...
        AddClassToCollection("PhysicsBuoyancyComponent", "void reactOnEnter(func closure, visitorGameObject)", "Lua closure function gets called in order to react when a game object enters the trigger area.");
        ...
        AddClassToCollection("PhysicsBuoyancyComponent", "void reactOnLeave(func closure, visitorGameObject)", "Lua closure function gets called in order to react when a game object leaves the trigger area.");
    }

    void bindTriggerComponent(lua_State* lua)
    {
        module(lua)[class_<PhysicsTriggerComponent, PhysicsComponent>("PhysicsTriggerComponent")
        ...
        AddClassToCollection("PhysicsTriggerComponent", "void reactOnEnter(func closure, visitorGameObject)", "Lua closure function gets called in order to react when a game object enters the trigger area.");
        AddClassToCollection("PhysicsTriggerComponent", "void reactOnInside(func closure, visitorGameObject)",
            "Lua closure function gets called in order to react when a game object is inside the trigger area. Note: This function should only be used if really necessary, because this function gets triggered permanently.");
        AddClassToCollection("PhysicsTriggerComponent", "void reactOnLeave(func closure, visitorGameObject)", "Lua closure function gets called in order to react when a game object leaves the trigger area.");
    ...
    {
        module(lua)[class_<MoveMathFunctionComponent, GameObjectComponent>("MoveMathFunctionComponent")
        ...
        AddClassToCollection("MoveMathFunctionComponent", "void reactOnFunctionFinished(func closureFunction)", "Sets wheather to react the game object function movement has finished.");
    }
    ...
    {
        module(lua)[class_<TagChildNodeComponent, GameObjectComponent>("TagChildNodeComponent")
    ...
    {
        module(lua)[class_<LineComponent, GameObjectComponent>("LineComponent")
        ...
        AddClassToCollection("LineComponent", "void setTargetOffsetPosition(Vector3 targetOffsetPosition)",
            "Sets the target offset position the line end point is attached at this target game object. "
        ...
        module(lua)[class_<LinesComponent, GameObjectComponent>("LinesComponent")
        ...
        AddClassToCollection("LinesComponent", "void setOperationType(String operationType)",
            "Sets the operation type. Possible values are: A list of points, "
        ...
        module(lua)[class_<ManualObjectComponent, GameObjectComponent>("ManualObjectComponent")
        ...
        AddClassToCollection("ManualObjectComponent", "void setOperationType(String operationType)",
            "Sets the operation type. Possible values are: A list of points, "
            "1 vertex per point OT_POINT_LIST = 1, A list of lines, 2 vertices per line OT_LINE_LIST = 2, A strip of connected lines, 1 vertex per line plus 1 start vertex "
            " OT_LINE_STRIP = 3, A list of triangles, 3 vertices per triangle OT_TRIANGLE_LIST = 4, A strip of triangles, 3 vertices for the first triangle, "
            " and 1 per triangle after that OT_TRIANGLE_STRIP = 5");
        ...
        module(lua)[class_<RectangleComponent, GameObjectComponent>("RectangleComponent")
        ...
        AddClassToCollection("RectangleComponent", "void setStartOrientation(unsigned int index, Vector3 startOrientation)",
            "Sets the start orientation vector in degrees for the rectangle. Note: Orientation is set in the form: (degreeX, degreeY, degreeZ).");
        ...
        module(lua)[class_<ValueBarComponent, GameObjectComponent>("ValueBarComponent")
        ...
        AddClassToCollection("ValueBarComponent", "void setOffsetPosition(Vector3 offsetPosition)",
            "Sets the offset position for the value bar. Note: Normally the value bar is placed at the same position as its carrying game object. Hence setting an offset is necessary.");
    ...
    */
    ...
    {
        module(lua)[class_<OgreNewt::Body>("Body")
    ...
    {
        module(lua)[class_<AiComponent, GameObjectComponent>("AiComponent")
        ...
        AddClassToCollection("AiComponent", "void reactOnPathGoalReached(func closureFunction)", "Sets whether to react the agent reached the goal.");
        AddClassToCollection("AiComponent", "void reactOnAgentStuck(func closureFunction)", "Sets whether to react the agent got stuck.");
        ...
        AddClassToCollection("AiComponent", "void setAutoAnimation(bool autoAnimation)",
            "Sets whether to use auto animation during ai movement. That is, the animation speed is adapted dynamically depending the velocity, which will create a much more realistic effect. Note: The game object must have a proper configured "
            "animation component.");
        AddClassToCollection("AiComponent", "void setAgentId(string agentId)", "Sets agent id, which shall be moved.");

        module(lua)[class_<AiMoveComponent, AiComponent>("AiMoveComponent")
        ...
        module(lua)[class_<AiWanderComponent, AiComponent>("AiWanderComponent")
        ...
        module(lua)[class_<AiFlockingComponent, AiComponent>("AiFlockingComponent")
        ...
        module(lua)[class_<AiRecastPathNavigationComponent, AiComponent>("AiRecastPathNavigationComponent")
        ...
        AddClassToCollection("AiRecastPathNavigationComponent", "void setTargetId(String targetId)",
            "Sets a target id game object as goal to go to walk to that game object on shortest path. Note: The target game object may move and the path is recalculated at @getActualizePathDelay rate.");
        ...
        AddClassToCollection("AiRecastPathNavigationComponent", "void setActualizePathDelay(float delayMS)",
            "Sets the path recalculation delay in milliseconds. This is the rate the path is recalculated due to performance reasons when the target id game object changes its position. Default is set to -1 (off)");
        ...
        module(lua)[class_<AiObstacleAvoidanceComponent, AiComponent>("AiObstacleAvoidanceComponent")
        ...
        module(lua)[class_<AiHideComponent, AiComponent>("AiHideComponent")
        ...
        module(lua)[class_<AiMoveComponent2D, AiComponent>("AiMoveComponent2D")
        ...
        module(lua)[class_<AiPathFollowComponent2D, AiComponent>("AiPathFollowComponent2D")
        ...
        module(lua)[class_<AiWanderComponent2D, AiComponent>("AiWanderComponent2D")
    ...
    {
        module(lua)[class_<CameraComponent, GameObjectComponent>("CameraComponent")
        ...
        // AddClassToCollection("CameraComponent", "void setWorkspaceName(String workspaceName)", "Sets the workspace name to use for rendering. Possible values are e.g. NOWAPbsWorkspace, NOWASkyWorkspace, NOWASkyReflectionWorkspace,
        // NOWASkyPlanarReflectionWorkspace, NOWABackgroundPlanarReflectionWorkspace, NOWATerraWorkspace, NOWABackgroundWorkspace"); AddClassToCollection("CameraComponent", "String getWorkspaceName()", "Gets the currently used workspace name to use
        // for rendering."); AddClassToCollection("CameraComponent", "void setSkyBoxName(String skyBoxName)", "Sets the sky box name. Note: Only usable when workspace is set to  NOWASkyWorkspace, NOWASkyReflectionWorkspace,
        // NOWASkyPlanarReflectionWorkspace, NOWATerraWorkspace"); AddClassToCollection("CameraComponent", "String getSkyBoxName()", "Gets the currently used sky box name."); AddClassToCollection("CameraComponent", "void setColor(Vector3 color)",
        // "Sets the background color for the camera. Note: Does only make sense for NOWAPbsWorkspace"); AddClassToCollection("CameraComponent", "Vector3 getColor()", "Gets the currently used background color.");
    }

    void bindCompositorEffects(lua_State* lua)
    {
        module(lua)[class_<CompositorEffectBaseComponent, GameObjectComponent>("CompositorEffectBaseComponent")
        ...
        module(lua)[class_<CompositorEffectBloomComponent, CompositorEffectBaseComponent>("CompositorEffectBloomComponent")
        ...
        module(lua)[class_<CompositorEffectGlassComponent, CompositorEffectBaseComponent>("CompositorEffectGlassComponent")
        ...
        module(lua)[class_<CompositorEffectOldTvComponent, CompositorEffectBaseComponent>("CompositorEffectOldTvComponent")
        ...
        module(lua)[class_<CompositorEffectBlackAndWhiteComponent, CompositorEffectBaseComponent>("CompositorEffectBlackAndWhiteComponent")
        ...
        module(lua)[class_<CompositorEffectColorComponent, CompositorEffectBaseComponent>("CompositorEffectColorComponent").def("setColor", &CompositorEffectColorComponent::setColor).def("getColor", &CompositorEffectColorComponent::getColor)];
        ...
        module(lua)[class_<CompositorEffectEmbossedComponent, CompositorEffectBaseComponent>("CompositorEffectEmbossedComponent")
        ...
        module(lua)[class_<CompositorEffectSharpenEdgesComponent, CompositorEffectBaseComponent>("CompositorEffectSharpenEdgesComponent")
    ...
    {
        module(lua)[class_<DatablockPbsComponent, GameObjectComponent>("DatablockPbsComponent")
        ...
        module(lua)[class_<Ogre::HlmsPbsDatablock::TransparencyModes>("TransparencyModes")
                .enum_("TransparencyModes")[value("NONE", Ogre::HlmsPbsDatablock::None), value("TRANSPARENT", Ogre::HlmsPbsDatablock::Transparent), value("FADE", Ogre::HlmsPbsDatablock::Fade)]];
        ...
        AddClassToCollection("DatablockPbsComponent", "void setFresnel(Vector3 fresnel, bool separateFresnel)",
            "Sets the fresnel (F0) directly. The fresnel of the material for each color component. When separateFresnel = false, the Y and Z components are ignored. Note: Only visible/usable when fresnel workflow is active.");
        ...
        AddClassToCollection("DatablockPbsComponent", "void setIndexOfRefraction(Vector3 colorIndex, bool separateFresnel)",
            "Calculates fresnel (F0 in most books) based on the IOR. Note: If 'separateFresnel' was different from the current setting, it will call flushRenderables. "
            "If the another shader must be created, it could cause a stall. The index of refraction of the material for each colour component. When separateFresnel = false, the Y and Z components are ignored. Whether to use the same fresnel term "
            "for RGB channel, or individual ones.");
        ...
        AddClassToCollection("DatablockPbsComponent", "void setRefractionStrength(float refractionStrength)",
            "Sets the strength of the refraction, i.e. how much displacement in screen space. Note: This value is not physically based. Only used when 'setTransparency' was set to HlmsPbsDatablock::Refractive");
        AddClassToCollection("DatablockPbsComponent", "float getRefractionStrength()", "Gets the roughness value..");
        AddClassToCollection("DatablockPbsComponent", "void setBrdf(String brdf)",
            "Sets brdf mode. Possible values are: Default (Most physically accurate BRDF performance heavy), CookTorrance (Ideal for silk (use high roughness values), synthetic fabric), "
            ...
            "DefaultSeparateDiffuseFresnel (for complex refractions and reflections like glass, transparent plastics, fur, and surface with refractions and multiple rescattering, achieve a perfect mirror effect, raise the fresnel term to 1 and the "
        ...
        AddClassToCollection("DatablockPbsComponent", "void setOneSidedShadowCastCullingMode(String cullingMode)",
            "Sets the one sided shadow cast culling mode. While CULL_NONE is usually the 'correct' option, setting CULL_ANTICLOCKWISE can prevent ugly self-shadowing on interiors.");
        ...
        AddClassToCollection("DatablockPbsComponent", "void setAlphaTestThreshold(float threshold)",
            "Sets threshold for alpha. Alpha testing works on the alpha channel of the diffuse texture. If there is no diffuse texture, the first diffuse detail map after.");
        ...
        AddClassToCollection("DatablockPbsComponent", "void setBackgroundColor(Vector3 backgroundColor)",
            "Sets the diffuse background color. When no diffuse texture is present, this solid color replaces it, and can act as a background for the detail maps.");
        ...
        AddClassToCollection("DatablockPbsComponent", "void setNormalMapWeight(float normalMapWeight)",
            "Sets the normal mapping weight. Note: A value of 0 means no effect (tangent space normal is 0, 0, 1); and would be. A value of 1 means full normal map effect. A value outside the [0; 1] range extrapolates.");
        AddClassToCollection("DatablockPbsComponent", "float getNormalMapWeight()", "Gets the normal map weight.");
        AddClassToCollection("DatablockPbsComponent", "void setClearCoat(float clearCoat)",
            "Sets the strength of the of the clear coat layer. Note: This should be treated as a binary value, set to either 0 or 1. Intermediate values are useful to control transitions between parts of the surface that have a clear coat layers "
        ...
        AddClassToCollection("DatablockPbsComponent", "void setBlendMode0(String blendMode0)",
            "Sets the blend mode 0. The following values are possible: 'PBSM_BLEND_NORMAL_NON_PREMUL', 'PBSM_BLEND_NORMAL_PREMUL'"
        ...
        AddClassToCollection("DatablockPbsComponent", "void setBlendMode1(String blendMode1)",
            "Sets the blend mode 1. The following values are possible: 'PBSM_BLEND_NORMAL_NON_PREMUL', 'PBSM_BLEND_NORMAL_PREMUL'"
            "'PBSM_BLEND_ADD', 'PBSM_BLEND_SUBTRACT', 'PBSM_BLEND_MULTIPLY', 'PBSM_BLEND_MULTIPLY2X', 'PBSM_BLEND_SCREEN', 'PBSM_BLEND_OVERLAY', 'PBSM_BLEND_LIGHTEN', 'PBSM_BLEND_DARKEN'"
            "'PBSM_BLEND_GRAIN_EXTRACT', 'PBSM_BLEND_GRAIN_MERGE', 'PBSM_BLEND_DIFFERENCE'");
        ...
        AddClassToCollection("DatablockPbsComponent", "void setBlendMode2(String blendMode2)",
            "Sets the blend mode 2. The following values are possible: 'PBSM_BLEND_NORMAL_NON_PREMUL', 'PBSM_BLEND_NORMAL_PREMUL'"
            "'PBSM_BLEND_ADD', 'PBSM_BLEND_SUBTRACT', 'PBSM_BLEND_MULTIPLY', 'PBSM_BLEND_MULTIPLY2X', 'PBSM_BLEND_SCREEN', 'PBSM_BLEND_OVERLAY', 'PBSM_BLEND_LIGHTEN', 'PBSM_BLEND_DARKEN'"
            "'PBSM_BLEND_GRAIN_EXTRACT', 'PBSM_BLEND_GRAIN_MERGE', 'PBSM_BLEND_DIFFERENCE'");
        ...
        AddClassToCollection("DatablockPbsComponent", "void setBlendMode3(String blendMode3)",
            "Sets the blend mode 3. The following values are possible: 'PBSM_BLEND_NORMAL_NON_PREMUL', 'PBSM_BLEND_NORMAL_PREMUL'"
            "'PBSM_BLEND_ADD', 'PBSM_BLEND_SUBTRACT', 'PBSM_BLEND_MULTIPLY', 'PBSM_BLEND_MULTIPLY2X', 'PBSM_BLEND_SCREEN', 'PBSM_BLEND_OVERLAY', 'PBSM_BLEND_LIGHTEN', 'PBSM_BLEND_DARKEN'"
            "'PBSM_BLEND_GRAIN_EXTRACT', 'PBSM_BLEND_GRAIN_MERGE', 'PBSM_BLEND_DIFFERENCE'");
        ...
        AddClassToCollection("DatablockPbsComponent", "void setUseAlphaFromTextures(bool useAlphaFromTextures)",
            "Sets whether to use transparency from textures or not. "
        ...
        module(lua)[class_<DatablockTerraComponent, GameObjectComponent>("DatablockTerraComponent")
        ...
        module(lua)[class_<DatablockUnlitComponent, GameObjectComponent>("DatablockUnlitComponent")
        ...
        AddClassToCollection("DatablockUnlitComponent", "void setBackgroundColor(Vector3 backgroundColor)",
            "Sets the diffuse background color. When no diffuse texture is present, this solid color replaces it, and can act as a background for the detail maps.");
    ...
    {
        module(lua)[class_<TerraComponent, GameObjectComponent>("TerraComponent")
        ...
        AddClassToCollection("TerraComponent", "void modifyTerrainStart(Vector3 position, number strength)",
            "Starts modifying the terrain at the given position and strength. Must be always called once before modifyTerrain is called frequently in order to satisfy undo/redo feature.");
        AddClassToCollection("TerraComponent", "void smoothTerrainStart(Vector3 position, number strength)",
            "Starts smoothing the terrain at the given position and strength. Must be always called once before msmootTerrain is called frequently in order to satisfy undo/redo feature.");
        AddClassToCollection("TerraComponent", "void paintTerrainStart(Vector3 position, number intensity, number imageLayer)",
            "Starts painting the terrain at the given position with the given intensity and the image layer. Must be always called once before paintTerrain is called frequently in order to satisfy undo/redo feature.");

        AddClassToCollection("TerraComponent", "void modifyTerrain(Vector3 position, number strength)",
            "Modifies the terrain at the given position and strength. Note: modifyTerrainStart must be called first one time in order to satisfy undo/redo feature.");
        AddClassToCollection("TerraComponent", "void smoothTerrain(Vector3 position, number strength)",
            "Smoothes the terrain at the given position and strength. Note: modifyTerrainStart must be called first one time in order to satisfy undo/redo feature.");
        AddClassToCollection("TerraComponent", "void paintTerrain(Vector3 position, number intensity, number imageLayer)",
            "Paints the terrain at the given position with the given intensity and the image layer. Note: modifyTerrainStart must be called first one time in order to satisfy undo/redo feature.");
        ...
        AddClassToCollection("TerraComponent", "void modifyTerrainLoop(Vector3 position, number strength, number loopCount)",
            "Abreviation for modifying the terrain at the given position and strength and loop of times. It calles all necessary other methods internally in order to satisfy undo/redo feature");
        AddClassToCollection("TerraComponent", "void smoothTerrainLoop(Vector3 position, number strength, number loopCount)",
            "Abreviation for smoothing the terrain at the given position and strength and loop of times. It calles all necessary other methods internally in order to satisfy undo/redo feature");
        AddClassToCollection("TerraComponent", "void paintTerrainLoop(Vector3 position, number intensity, number imageLayer, number loopCount)",
            "Abreviation for painting the terrain at the given position and strength and loop of times. It calles all necessary other methods internally in order to satisfy undo/redo feature");
    }

    void bindOceanComponent(lua_State* lua)
    {
        module(lua)[class_<OceanComponent, GameObjectComponent>("OceanComponent")
        ...
        AddClassToCollection("OceanComponent", "void setUseSkirts(boolean useSkirts)", "Enables or disables skirts on distant ocean cells to hide LOD cracks.");

        AddClassToCollection("OceanComponent", "boolean getUseSkirts()", "Returns whether ocean skirts are enabled.");

        // ==================== Wave shape ====================

        AddClassToCollection("OceanComponent", "void setWavesIntensity(number intensity)", "Sets the wave amplitude which controls vertical displacement and wave height.");

        AddClassToCollection("OceanComponent", "number getWavesIntensity()", "Returns the current wave amplitude.");

        AddClassToCollection("OceanComponent", "void setOceanWavesScale(number scale)", "Sets the overall wave size and wavelength. Higher values create large, slow swells.");

        AddClassToCollection("OceanComponent", "number getOceanWavesScale()", "Returns the wave size / wavelength scale.");

        AddClassToCollection("OceanComponent", "void setShaderWavesScale(number scale)", "Sets the shader-side wave detail scale controlling fine surface detail and ripples.");

        AddClassToCollection("OceanComponent", "number getShaderWavesScale()", "Returns the shader-side wave detail scale.");

        // ==================== Wave animation ====================

        AddClassToCollection("OceanComponent", "void setWaveTimeScale(number timeScale)", "Sets the global wave animation speed multiplier (1.0 = default).");

        AddClassToCollection("OceanComponent", "number getWaveTimeScale()", "Returns the wave animation speed multiplier.");

        AddClassToCollection("OceanComponent", "void setWaveFrequencyScale(number frequencyScale)", "Sets the wave frequency controlling how dense the wave pattern is.");

        AddClassToCollection("OceanComponent", "number getWaveFrequencyScale()", "Returns the wave frequency scale.");

        AddClassToCollection("OceanComponent", "void setWaveChaos(number chaos)", "Adds time-varying chaotic motion to reduce visible repetition in waves.");

        AddClassToCollection("OceanComponent", "number getWaveChaos()", "Returns the wave chaos amount.");

        // ==================== Shading / reflection ====================

        AddClassToCollection("OceanComponent", "void setReflectionStrength(number strength)", "Sets the intensity of specular environment reflections on the water surface.");

        AddClassToCollection("OceanComponent", "number getReflectionStrength()", "Returns the reflection strength.");

        AddClassToCollection("OceanComponent", "void setBaseRoughness(number roughness)", "Sets the base water surface roughness controlling reflection sharpness.");

        AddClassToCollection("OceanComponent", "number getBaseRoughness()", "Returns the base water surface roughness.");

        AddClassToCollection("OceanComponent", "void setFoamRoughness(number roughness)", "Sets the roughness of foam areas, affecting highlight softness.");

        AddClassToCollection("OceanComponent", "number getFoamRoughness()", "Returns the foam roughness.");

        AddClassToCollection("OceanComponent", "void setAmbientReduction(number reduction)", "Reduces the contribution of ambient lighting on the ocean surface.");

        AddClassToCollection("OceanComponent", "number getAmbientReduction()", "Returns the ambient light reduction factor.");

        AddClassToCollection("OceanComponent", "void setDiffuseScale(number scale)", "Sets the diffuse lighting contribution on the water surface.");

        AddClassToCollection("OceanComponent", "number getDiffuseScale()", "Returns the diffuse lighting scale.");

        AddClassToCollection("OceanComponent", "void setFoamIntensity(number intensity)", "Sets the overall intensity and visibility of foam.");

        AddClassToCollection("OceanComponent", "number getFoamIntensity()", "Returns the foam intensity.");

        // ==================== Water colours ====================

        AddClassToCollection("OceanComponent", "void setDeepColour(Vector3 colour)", "Sets the deep water colour used for shading large water depths.");

        AddClassToCollection("OceanComponent", "Vector3 getDeepColour()", "Returns the deep water colour.");

        AddClassToCollection("OceanComponent", "void setShallowColour(Vector3 colour)", "Sets the shallow water colour used for wave crests and foam.");

        AddClassToCollection("OceanComponent", "Vector3 getShallowColour()", "Returns the shallow water colour.");

        // ==================== Queries ====================

        AddClassToCollection("OceanComponent", "boolean isCameraUnderwater()", "Returns whether the active ocean camera is currently underwater.");

        AddClassToCollection("OceanComponent", "boolean isPositionUnderWater(Vector3 position)", "Returns whether the given world position is underwater.");

        AddClassToCollection("OceanComponent", "boolean isGameObjectUnderWater(GameObject gameObject)", "Returns whether the given game object is underwater.");
    }
    ...
    {
        module(lua)[class_<JointComponent, GameObjectComponent>("JointComponent")
        ...
        module(lua)[class_<JointHingeComponent, JointComponent>("JointHingeComponent")
        ...
        AddClassToCollection("JointHingeComponent", "void setTorgue(float torque)",
            "Sets the torque rotation for this joint. Note: Without a friction the torque will not work. So get a balance between torque and friction (1, 20) e.g. The more friction, the more powerful the motor will become.");
        AddClassToCollection("JointHingeComponent", "void setFriction(float maxTorque)",
            "Sets the friction (max. torque) for torque. Note: Without a friction the torque will not work. So get a balance between torque and friction (1, 20) e.g. The more friction, the more powerful the motor will become.");
        ...
        AddClassToCollection("JointHingeComponent", "void setSpring(bool asSpringDamper, bool massIndependent, float springDamperRelaxation, float springK, float springD)",
            "Sets the spring values for this joint. Note: When 'asSpringDamper' is activated the joint will use spring values for rotation.");
        ...
        module(lua)[class_<JointHingeActuatorComponent, JointComponent>("JointHingeActuatorComponent")
        ...
        AddClassToCollection("JointHingeActuatorComponent", "void setMinAngleLimit(Degree minAngleLimit)",
            "Sets the min angle limit in degree. "
        ...
        AddClassToCollection("JointHingeActuatorComponent", "void setMaxAngleLimit(Degree maxAngleLimit)",
            "Sets the max angle limit in degree. "
            "Note: If 'setDirectionChange' is enabled, this is the angle at which the rotation direction will be changed.");
        AddClassToCollection("JointHingeActuatorComponent", "Degree getMaxAngleLimit()", "Gets the max angle limit.");
        AddClassToCollection("JointHingeActuatorComponent", "void setMaxTorque(float maxTorque)",
            "Sets max torque during rotation. Note: This will affect the rotation rate. "
        ...
        AddClassToCollection("JointHingeActuatorComponent", "void setRepeat(bool repeat)",
            "Sets whether to repeat the direction changed rotation. Note: If set to false the rotation will only go from min angle limit and back to max angular limit once.");
        ...
        AddClassToCollection("JointHingeActuatorComponent", "void setSpring(bool asSpringDamper, bool massIndependent, float springDamperRelaxation, float springK, float springD)",
            "Sets the spring values for this joint. Note: When 'asSpringDamper' is activated the joint will use spring values for rotation.");
        ...
        module(lua)[class_<JointTargetTransformComponent, JointComponent>("JointTargetTransformComponent")
        ...
        module(lua)[class_<JointBallAndSocketComponent, JointComponent>("JointBallAndSocketComponent")
        ...
        AddClassToCollection("JointBallAndSocketComponent", "void setMinMaxConeAngleLimit(Degree minAngleLimit, Degree minAngleLimit, Degree maxConeLimit)",
            "Sets the min and max angle and cone limit in degree. "
        ...
        AddClassToCollection("JointBallAndSocketComponent", "void setTwistSpringDamper(bool asSpringDamper, float springDamperRelaxation, float spring, float damper)",
            "Sets the twist spring values for this joint. Note: When 'asSpringDamper' is activated the joint will use spring values for twist.");

        module(lua)[class_<JointPinComponent, JointComponent>("JointPinComponent").def("setPin", &JointPinComponent::setPin).def("getPin", &JointPinComponent::getPin)];
        ...
        module(lua)[class_<JointPlaneComponent, JointComponent>("JointPlaneComponent")
        ...
        module(lua)[class_<JointSpringComponent, JointComponent>("JointSpringComponent")
        ...
        module(lua)[class_<JointAttractorComponent, JointComponent>("JointAttractorComponent")
        ...
        AddClassToCollection("JointAttractorComponent", "class inherits JointComponent",
            "Derived class from JointComponent. With this joint its possible to influence other physics active game object (repeller) by magnetic strength. "
        ...
        AddClassToCollection("JointAttractorComponent", "void setRepellerCategory(String repellerCategory)",
            "Sets the repeller category. Note: All other game objects with a physics active component, that are belonging to this category, will be attracted.");
        AddClassToCollection("JointAttractorComponent", "String getRepellerCategory()", "Gets the repeller category.");

        module(lua)[class_<JointCorkScrewComponent, JointComponent>("JointCorkScrewComponent")
        ...
        AddClassToCollection("JointCorkScrewComponent", "class inherits JointComponent",
            "Derived class from JointComponent. This joint type is an enhanched version of a slider joint which allows the attached child body to not "
        ...
        AddClassToCollection("JointCorkScrewComponent", "void setMinMaxStopDistance(float minStopDistance, float maxStopDistance)",
            "Sets the min and max distance limit. "
        ...
        AddClassToCollection("JointCorkScrewComponent", "void setMinMaxAngleLimit(Degree minAngleLimit, float maxAngleLimit)",
            "Sets the min and max angle limit. "
        ...
        module(lua)[class_<JointPassiveSliderComponent, JointComponent>("JointPassiveSliderComponent")
        ...
        AddClassToCollection("JointPassiveSliderComponent", "void setMinMaxStopDistance(float minStopDistance, float maxStopDistance)",
            "Sets the min and max stop distance. "
        ...
        AddClassToCollection("JointPassiveSliderComponent", "void setSpring2(bool asSpringDamper, float springDamperRelaxation, float springK, float springD)",
            "Sets the spring values for this joint. Note: When 'asSpringDamper' is activated the slider will use spring values for motion.");

        module(lua)[class_<JointSliderActuatorComponent, JointComponent>("JointSliderActuatorComponent")
        ...
        AddClassToCollection("JointSliderActuatorComponent", "class inherits JointComponent",
            "Derived class from JointComponent. A child body attached via a slider joint can only slide up and down (move along) the axis it is attached to. "
        ...
        AddClassToCollection("JointSliderActuatorComponent", "void setMaxStopDistance(float maxStopDistance)",
            "Sets the max stop distance limit. "
        ...
        AddClassToCollection("JointSliderActuatorComponent", "void setMinForce(float minForce)",
            "Sets min force during motion. Note: This will affect the motion rate. "
        ...
        AddClassToCollection("JointSliderActuatorComponent", "void setMaxForce(float maxForce)",
            "Sets max force during motion. Note: This will affect the motion rate. "
            "Note: A high value will cause that the motion will start slow and will be faster and at the end slow again.");
        ...
        AddClassToCollection("JointSliderActuatorComponent", "void setRepeat(bool repeat)",
            "Sets whether to repeat the direction changed motion. Note: If set to false the motion will only go from min stop distance and back to max stop distance once.");
        ...
        module(lua)[class_<JointSlidingContactComponent, JointComponent>("JointSlidingContactComponent")
        ...
        AddClassToCollection("JointSlidingContactComponent", "class inherits JointComponent",
            "Derived class from JointComponent. A child body attached via a slider joint can only slide up and down (move along) the axis it is attached to and rotate around given pin-axis.");
        ...
        AddClassToCollection("JointSlidingContactComponent", "void setMinMaxStopDistance(float minStopDistance, float maxStopDistance)",
            "Sets the min and max stop distance. "
            "Note: This will only be applied if 'setLinearLimitsEnabled' is set to 'true'.");
        ...
        AddClassToCollection("JointSlidingContactComponent", "void setMinMaxAngleLimit(Degree minAngleLimit, float maxAngleLimit)",
            "Sets the min and max angle limit. "
            "Note: This will only be applied if 'setAngleLimitsEnabled' is set to 'true'.");
        ...
        AddClassToCollection("JointSlidingContactComponent", "void setSpring2(bool asSpringDamper, float springDamperRelaxation, float springK, float springD)",
            "Sets the spring values for this joint. Note: When 'asSpringDamper' is activated the slider will use spring values for motion.");

        module(lua)[class_<JointActiveSliderComponent, JointComponent>("JointActiveSliderComponent")
        ...
        AddClassToCollection("JointActiveSliderComponent", "class inherits JointComponent",
            "Derived class from JointComponent. A child body attached via a slider joint can only slide up and down (move along) the axis it is attached to. "
        ...
        AddClassToCollection("JointActiveSliderComponent", "void setMinStopDistance(float minStopDistance)",
            "Sets the min stop limit."
            "Note: If 'setDirectionChange' is enabled, this is the min stop limit at which the motion direction will be changed.");
        AddClassToCollection("JointActiveSliderComponent", "float getMinStopDistance()", "Gets the min stop distance limit.");
        AddClassToCollection("JointActiveSliderComponent", "void setMaxStopDistance(float maxStopDistance)",
            "Sets the max stop distance limit. "
            "Note: If 'setDirectionChange' is enabled, this is the max stop limit at which the motion direction will be changed.");
        ...
        AddClassToCollection("JointActiveSliderComponent", "void setRepeat(bool repeat)",
            "Sets whether to repeat the direction changed motion. Note: If set to false the motion will only go from min stop distance and back to max stop distance once.");
        AddClassToCollection("JointActiveSliderComponent", "bool getRepeat()", "Gets whether the direction changed motion is repeated.");

        module(lua)[class_<JointMathSliderComponent, JointComponent>("JointMathSliderComponent")
        ...
        AddClassToCollection("JointMathSliderComponent", "void setMinMaxStopDistance(float minStopDistance, float maxStopDistance)",
            "Sets the min and max stop limit."
            "Note: If 'setDirectionChange' is enabled, this is the min stop limit at which the motion direction will be changed.");
        ...
        module(lua)[class_<JointPointToPointComponent, JointComponent>("JointPointToPointComponent")
        ...
        module(lua)[class_<JointKinematicComponent, JointComponent>("JointKinematicComponent")
        ...
        AddClassToCollection("JointKinematicComponent", "void setPickingMode(string picking mode)",
        ...
        AddClassToCollection("JointKinematicComponent", "String getPickingMode()",
            "Gets the currently set picking mode. "
            "Possible values are: Linear, Full 6 Degree Of Freedom, Linear And Twist, Linear And Cone, Linear Plus Angluar Friction");
        ...
        AddClassToCollection("JointKinematicComponent", "void setShortTimeActivation(bool shortTimeActivation)",
            "If set to true, this component will be deactivated shortly after it has been activated. Which means, the kinematic joint will take its target transform and remain there.");
        AddClassToCollection("JointKinematicComponent", "bool getShortTimeActivation()",
            "Gets whether this component is deactivated shortly after it has been activated. Which means, the kinematic joint will take its target transform and remain there.");

        AddClassToCollection("JointKinematicComponent", "void reactOnTargetPositionReached(func closure, otherGameObject)", "Sets whether to react at the moment when the game object has reached the target position.");

        module(lua)[class_<JointDryRollingFrictionComponent, JointComponent>("JointDryRollingFrictionComponent")
        ...
        AddClassToCollection("JointDryRollingFrictionComponent", "void setRollingFrictionCoefficient(float rollingFrictionCoefficient)", "Sets the dimensionless rolling friction coefficient. Higher values increase the rolling resistance torque.");
        ...
        AddClassToCollection("JointDryRollingFrictionComponent", "float getContactTrail()", "Gets the effective contact trail (lever arm) used to compute the rolling friction torque.");

        module(lua)[class_<JointGearComponent, JointComponent>("JointGearComponent").def("setGearRatio", &JointGearComponent::setGearRatio).def("getGearRatio", &JointGearComponent::getGearRatio)];
        AddClassToCollection("JointGearComponent", "class inherits JointComponent",
            "Derived class from JointComponent. This joint is for use in conjunction with Hinge of other spherical joints"
        ...
        module(lua)[class_<JointWormGearComponent, JointComponent>("JointWormGearComponent")
        ...
        AddClassToCollection("JointWormGearComponent", "class inherits JointComponent",
            "Derived class from JointComponent. This joint is for use in conjunction with Hinge of other slider joints"
        ...
        module(lua)[class_<JointPulleyComponent, JointComponent>("JointPulleyComponent").def("setPulleyRatio", &JointPulleyComponent::setPulleyRatio).def("getPulleyRatio", &JointPulleyComponent::getPulleyRatio)];
        AddClassToCollection("JointPulleyComponent", "class inherits JointComponent",
            "Derived class from JointComponent. This joint is for use in conjunction with Slider of other linear joints"
        ...
        module(lua)[class_<JointUniversalComponent, JointComponent>("JointUniversalComponent")
        ...
        AddClassToCollection("JointUniversalComponent", "class inherits JointComponent",
            "Derived class from JointComponent. An object attached to a universal joint can rotate around two dimensions perpendicular to the axes it is attached to. It is to be seen like a double hinge joint.");
        ...
        AddClassToCollection("JointUniversalComponent", "void setMinMaxAngleLimit0(Degree minAngleLimit, Degree minAngleLimit)",
            "Sets the first min and max angle limit in degree. Note: This will only be applied if 'setLimitsEnabled' is set to 'true'.");
        ...
        AddClassToCollection("JointUniversalComponent", "void setMotorSpeed0(float speed)",
            "Sets the first motor rotation speed. Note: Without a friction the torque will not work. So get a balance between torque and friction (1, 20) e.g. The more friction, the more powerful the motor will become.");
        AddClassToCollection("JointUniversalComponent", "float getMotorSpeed0()", "Gets the first motor rotation speed.");
        AddClassToCollection("JointUniversalComponent", "void setFriction0(float friction)",
            "Sets the friction (max. torque) for torque. Note: Without a friction the torque will not work. So get a balance between torque and friction (1, 20) e.g. The more friction, the more powerful the motor will become.");
        ...
        AddClassToCollection("JointUniversalComponent", "void setMinMaxAngleLimit1(Degree minAngleLimit, Degree minAngleLimit)",
            "Sets the second min and max angle limit in degree. Note: This will only be applied if 'setLimitsEnabled' is set to 'true'.");
        ...
        AddClassToCollection("JointUniversalComponent", "void setMotorSpeed1(float speed)",
            "Sets the second motor rotation speed. Note: Without a friction the torque will not work. So get a balance between torque and friction (1, 20) e.g. The more friction, the more powerful the motor will become.");
        ...
        AddClassToCollection("JointUniversalComponent", "void setSpring0(bool asSpringDamper, float springDamperRelaxation, float springK, float springD)",
            "Sets the first spring values for this joint. Note: When 'asSpringDamper' is activated the joint will use spring values for rotation.");
        ...
        AddClassToCollection("JointUniversalComponent", "void setSpring1(bool asSpringDamper, float springDamperRelaxation, float springK, float springD)",
            "Sets the second spring values for this joint. Note: When 'asSpringDamper' is activated the joint will use spring values for rotation.");
        AddClassToCollection("JointUniversalComponent", "void setFriction1(float friction)",
            "Sets the friction (max. torque) for torque. Note: Without a friction the torque will not work. So get a balance between torque and friction (1, 20) e.g. The more friction, the more powerful the motor will become.");
        AddClassToCollection("JointUniversalComponent", "float getFriction1()", "Gets the second motor rotation friction.");

        module(lua)[class_<JointUniversalActuatorComponent, JointComponent>("JointUniversalActuatorComponent")
        ...
        AddClassToCollection("JointUniversalActuatorComponent", "class inherits JointComponent",
            "Derived class from JointComponent. An object attached to a universal actuator joint can rotate around two dimensions perpendicular to the axes it is attached to. "
        ...
        AddClassToCollection("JointUniversalActuatorComponent", "void setMinAngleLimit0(Degree minAngleLimit)",
            "Sets the first min angle limit in degree. "
        ...
        AddClassToCollection("JointUniversalActuatorComponent", "void setMaxAngleLimit0(Degree maxAngleLimit)",
            "Sets the first max angle limit in degree. "
            "Note: If 'setDirectionChange0' is enabled, this is the angle at which the rotation direction will be changed.");
        AddClassToCollection("JointUniversalActuatorComponent", "Degree getMaxAngleLimit0()", "Gets the first max angle limit.");
        AddClassToCollection("JointUniversalActuatorComponent", "void setMaxTorque0(float maxTorque)",
            "Sets the first max torque during rotation. Note: This will affect the rotation rate. "
            "Note: A high value will cause that the rotation will start slow and will be faster and at the end slow again.");
        ...
        AddClassToCollection("JointUniversalActuatorComponent", "void setRepeat0(bool repeat)",
            "Sets whether to repeat the first direction changed rotation. Note: If set to false the rotation will only go from min angle limit and back to max angular limit once.");
        ...
        AddClassToCollection("JointUniversalActuatorComponent", "void setMinAngleLimit1(Degree minAngleLimit)",
            "Sets the second min angle limit in degree. "
        ...
        AddClassToCollection("JointUniversalActuatorComponent", "void setMaxAngleLimit1(Degree maxAngleLimit)",
            "Sets the second max angle limit in degree. "
            "Note: If 'setDirectionChange1' is enabled, this is the angle at which the rotation direction will be changed.");
        AddClassToCollection("JointUniversalActuatorComponent", "Degree getMaxAngleLimit1()", "Gets the second max angle limit.");
        AddClassToCollection("JointUniversalActuatorComponent", "void setMaxTorque1(float maxTorque)",
            "Sets the second max torque during rotation. Note: This will affect the rotation rate. "
            "Note: A high value will cause that the rotation will start slow and will be faster and at the end slow again.");
        ...
        AddClassToCollection("JointUniversalActuatorComponent", "void setRepeat1(bool repeat)",
            "Sets whether to repeat the second direction changed rotation. Note: If set to false the rotation will only go from min angle limit and back to max angular limit once.");
        ...
        module(lua)[class_<Joint6DofComponent, JointComponent>("Joint6DofComponent")
        ...
        module(lua)[class_<JointMotorComponent, JointComponent>("JointMotorComponent")
        ...
        AddClassToCollection("JointMotorComponent", "class inherits JointComponent",
            "Derived class from JointComponent. A motor joint, which needs another joint component as reference (predecessor), which should be rotated. Its also possible to use a second joint component (target) and pin for a different rotation.");
        ...
        module(lua)[class_<JointWheelComponent, JointComponent>("JointWheelComponent")
        ...
        AddClassToCollection("JointWheelComponent", "class inherits JointComponent",
            "Derived class from JointComponent. An object attached to a wheel joint can only rotate around one dimension perpendicular to the axis it is attached to and also steer.");
        ...
        module(lua)[class_<JointPathFollowComponent, JointComponent>("JointPathFollowComponent")
        ...
        AddClassToCollection("JointPathFollowComponent", "Vector3 getStartMoveDirection()",
            "Gets the starting move direction of the game object on the path. It can be used e.g. in order to add a force in that direction, in order to start movement the game object along the path.");
        AddClassToCollection("JointPathFollowComponent", "Vector3 getCurrentMoveDirection()",
            "Gets the current move direction of the game object on the path. It can be used e.g. in order to add a force in that direction, in order to continue movement the game object along the path.");
    ...
    {
        module(lua)[class_<LightDirectionalComponent, GameObjectComponent>("LightDirectionalComponent")
        ...
        AddClassToCollection("LightDirectionalComponent", "void setShowDummyEntity(bool showDummyEntity)",
            "Sets whether to show a dummy entity, "
        ...
        module(lua)[class_<LightPointComponent, GameObjectComponent>("LightPointComponent")
        ...
        AddClassToCollection("LightPointComponent", "void setShowDummyEntity(bool showDummyEntity)",
            "Sets whether to show a dummy entity, "
            "because normally a light is not visible and its hard to find out, where it actually is, so this function might help for analysis purposes.");
        AddClassToCollection("LightPointComponent", "bool getShowDummyEntity()", "Gets whether dummy entity is shown.");

        module(lua)[class_<LightSpotComponent, GameObjectComponent>("LightSpotComponent")
        ...
        AddClassToCollection("SpotLightComponent", "void setShowDummyEntity(bool showDummyEntity)",
            "Sets whether to show a dummy entity, "
            "because normally a light is not visible and its hard to find out, where it actually is, so this function might help for analysis purposes.");
        AddClassToCollection("SpotLightComponent", "bool getShowDummyEntity()", "Gets whether dummy entity is shown.");

        module(lua)[class_<LightAreaComponent, GameObjectComponent>("LightAreaComponent")
        ...
        AddClassToCollection("LightAreaComponent", "class inherits GameObjectComponent",
        ...
        AddClassToCollection("LightAreaComponent", "void setTextureName(String textureName)",
            "Sets the texture name for the area light for the light shining pattern. "
    ...
    {
        module(lua)[class_<FadeComponent, GameObjectComponent>("FadeComponent")
    ...
    void bindPhysicsComponent(lua_State* lua)
    {
        ...
        AddClassToCollection("PhysicsComponent", "void setDirection(Vector3 direction, Vector3 localDirectionVector)",
            "Sets the direction vector of the physics component. Note: local direction vector is NEGATIVE_UNIT_Z by default. Attention: Never ever use this function in an update function for physics, as it will mess up parts of physics like "
            "ragdolls etc. Only use it for initialization!");
        AddClassToCollection("PhysicsComponent", "void setOrientation(Quaternion orientation)",
        ...
        AddClassToCollection("PhysicsComponent", "void setPosition(Vector3 position)",
            "Sets the position of the physics component. Attention: Never ever use this function in an update function for physics, as it will mess up parts of physics like ragdolls etc. Only use it for initialization!");
        AddClassToCollection("PhysicsComponent", "void setPosition2(float x, float, y, float z)",
            "Sets the position of the physics component. Attention: Never ever use this function in an update function for physics, as it will mess up parts of physics like ragdolls etc. Only use it for initialization!");
        ...
        AddClassToCollection("PhysicsComponent", "void translate(Vector3 relativePosition)",
            "Sets relative position of the physics component. Attention: Never ever use this function in an update function for physics, as it will mess up parts of physics like ragdolls etc. Only use it for initialization!");
        AddClassToCollection("PhysicsComponent", "void rotate(Quaternion relativeOrientation)",
            "Sets the relative orientation of the physics component. Attention: Never ever use this function in an update function for physics, as it will mess up parts of physics like ragdolls etc. Only use it for initialization!");
    ...
    PhysicsActiveComponent::ContactData getContactToDirection(PhysicsActiveComponent* instance, int index, const Ogre::Vector3& direction, const Ogre::Vector3& offset, Ogre::Real from, Ogre::Real to, bool forceDrawLine,
        const Ogre::String& categoryIds)
    {
    ...
    PhysicsActiveComponent::ContactData getContactToDirection2(PhysicsActiveComponent* instance, int index, const Ogre::Vector3& direction, const Ogre::Vector3& offset, Ogre::Real from, Ogre::Real to, bool forceDrawLine,
        const Ogre::String& categoryNames)
    {
    ...
    {
        module(lua)[class_<PhysicsActiveComponent::ContactData>("ContactData")
        ...
        module(lua)[class_<PhysicsActiveComponent, PhysicsComponent>("PhysicsActiveComponent")
        ...
        /*AddClassToCollection("PhysicsActiveComponent", "void setDirection(Vector3 direction, Vector3 localDirectionVector)", "Sets the direction vector of the physics component. Note: local direction vector is NEGATIVE_UNIT_Z by default. Attention:
        Never ever use this function in an update function for physics, as it will mess up parts of physics like ragdolls etc. Only use it for initialization!"); AddClassToCollection("PhysicsActiveComponent", "void setOrientation(Quaternion
        orientation)", "Sets the orientation of the physics component. Attention: Never ever use this function in an update function for physics, as it will mess up parts of physics like ragdolls etc. Only use it for initialization!");
        AddClassToCollection("PhysicsActiveComponent", "Quaternion setOrientation()", "Gets the orientation of the physics component.");
        AddClassToCollection("PhysicsActiveComponent", "void setPosition(Vector3 position)", "Sets the position of the physics component. Attention: Never ever use this function in an update function for physics, as it will mess up parts of physics
        like ragdolls etc. Only use it for initialization!"); AddClassToCollection("PhysicsActiveComponent", "void setPosition2(float x, float, y, float z)", "Sets the position of the physics component. Attention: Never ever use this function in an
        update function for physics, as it will mess up parts of physics like ragdolls etc. Only use it for initialization!"); AddClassToCollection("PhysicsActiveComponent", "Vector3 getPosition()", "Gets the position of the physics component.");
        ...
        AddClassToCollection("PhysicsActiveComponent", "void translate(Vector3 relativePosition)", "Sets relative position of the physics component. Attention: Never ever use this function in an update function for physics, as it will mess up parts
        of physics like ragdolls etc. Only use it for initialization!"); AddClassToCollection("PhysicsActiveComponent", "void rotate(Quaternion relativeOrientation)", "Sets the relative orientation of the physics component. Attention: Never ever use
        this function in an update function for physics, as it will mess up parts of physics like ragdolls etc. Only use it for initialization!");
        */
        ...
        AddClassToCollection("PhysicsActiveComponent", "void setVelocity(Vector3 velocity)",
        ...
        AddClassToCollection("PhysicsActiveComponent", "void setDirectionVelocity(float speed)",
            "Sets the velocity speed for the current direction. Note: The default direction axis is applied. See: @GameObject::getDefaultDirection(). Note: This should only be set for initialization and not during simulation, as It could break "
            "physics calculation, or it may be called if its a physics active kinematic body.");
        ...
        AddClassToCollection("PhysicsActiveComponent", "void setMassOrigin(Vector3 massOrigin)",
            "Sets mass origin for the body. Note: The mass origin is calculated automatically, but there are cases, in which the user wants"
        ...
        AddClassToCollection("PhysicsActiveComponent", "void applyOmegaForce(Vector3 omegaForce)",
            "Applies omega force vector of the physics body. Note: This should be used during simulation instead of @setOmegaVelocity, if its not a kinematic component.");
        AddClassToCollection("PhysicsActiveComponent", "void applyOmegaForceRotateTo(Quaternion resultOrientation, Vector3 axes, number strength)",
        ...
        AddClassToCollection("PhysicsActiveComponent", "void applyOmegaForceRotateToDirection(Vector3 resultDirection, number strength)",
            "Applies omega force in order to rotate the game object to the given result direction. "
            "The strength at which the rotation should occur. "
            "Note: This should be used during simulation instead of @setOmegaVelocity, if its not a kinematic component.");
        ...
        AddClassToCollection("PhysicsActiveComponent", "void applyRequiredForceForVelocity(Vector3 velocity)",
            "Applies the required force for the given velocity. Note: This should be used instead of setVelocity in simulation, for realistic physics behavior.");
        AddClassToCollection("PhysicsActiveComponent", "void applyRequiredForceForJumpVelocity(Vector3 velocity)",
            "Applies the required force for the given jump velocity. "
            "Note: This should be used instead of setVelocity in simulation, for realistic physics behavior. Note: @applyRequiredForceForJumpVelocity has been separated from @applyRequiredForceForVelocity, because using "
            "applyRequiredForceForVelocity with movement and jump did bite itself.");
        ...
        AddClassToCollection("PhysicsActiveComponent", "void setGyroscopicTorqueEnabled(bool enable)",
            "Sets whether to enable gyroscopic precision for torque. See: https://www.youtube.com/watch?v=BCVQFoPO5qQ, https://www.youtube.com/watch?v=UlErvZoU7Q0.");
        ...
        AddClassToCollection("PhysicsActiveComponent", "void reactOnContactSolving(func closure(otherGameObject, contact))",
            "Registers a closure called once when the ship landed. Note: setContactSolvingEnabled(true) must be called first to enable the contact solving.");

        AddClassToCollection("PhysicsActiveComponent", "void setCollisionDirection(Vector3 collisionOffsetDirection)",
            "Sets an offset collision direction for the collision hull. "
        ...
        AddClassToCollection("PhysicsActiveComponent", "void setCollisionDirection(Vector3 collisionOffsetPosition)",
            "Sets an offset to the collision position of the collision hull. "
        ...
        AddClassToCollection("PhysicsActiveComponent", "void setConstraintAxis(Vector3 constraintAxis)",
            "Sets the constraint axis. The axis in the vector, that is set to '1' will be no more available for movement. "
        ...
        AddClassToCollection("PhysicsActiveComponent", "void applyConstraintDirection(Vector3 constraintDirection)",
            "Sets the constraint direction. The physics body can only be rotated on that axis. "
        ...
        AddClassToCollection("PhysicsActiveComponent", "void setGravitySourceCategory(String gravitySourceCategory)",
            "Sets the gravity source category. If there is a gravity source game object, gravity in that direction of the source will be calculated, "
        ...
        AddClassToCollection("PhysicsActiveComponent", "ContactData getContactAhead(int index,  Vector3 offset, float length, bool forceDrawLine, string categoryIds)",
            "Gets a contact data if there was a physics ray contact a head of the physics body. "
        ...
        AddClassToCollection("PhysicsActiveComponent", "ContactData getContactAhead2(int index,  Vector3 offset, float length, bool forceDrawLine, string categoryNames)",
            "Gets a contact data if there was a physics ray contact a head of the physics body. "
            "The direction is for the ray direction to shoot and the offset, at which offset position away from the physics component. "
            "The length of the ray in meters. If 'drawLine' is set to true, a debug line is shown. In order to remove the line call this function once with this value set to false. "
        ...
        AddClassToCollection("PhysicsActiveComponent",
            "ContactData getContactToDirection(int index, const Vector3 direction, Vector3 offset, "
            "float from, float to, bool forceDrawLine, string categoryIds)",
            "Gets a contact data if there was a physics ray contact with a physics body. "
            "The direction is for the ray direction to shoot and the offset, at which offset position away from the physics component. "
            "The value 'from' is from which distance to shoot the ray and the value 'to' is the length of the ray in meters. If 'forceDrawLine' is set to true, a debug line is shown. In order to remove the line call this function once with this "
            "value set to false.");

        AddClassToCollection("PhysicsActiveComponent",
            "ContactData getContactToDirection2(int index, const Vector3 direction, Vector3 offset, "
            "float from, float to, bool forceDrawLine, string categoryNames)",
            "Gets a contact data if there was a physics ray contact with a physics body. "
            "The direction is for the ray direction to shoot and the offset, at which offset position away from the physics component. "
            "The value 'from' is from which distance to shoot the ray and the value 'to' is the length of the ray in meters. If 'forceDrawLine' is set to true, a debug line is shown. In order to remove the line call this function once with this "
            "value set to false. "
        ...
        AddClassToCollection("PhysicsActiveComponent", "ContactData getContactBelow(int index, Vector3 offset, bool forceDrawLine, string categoryIds, bool useLocalOrientation)",
            "Gets a contact data below the physics body. "
        ...
        AddClassToCollection("PhysicsActiveComponent", "ContactData getContactBelow2(int index, Vector3 offset, bool forceDrawLine, string categoryNames, bool useLocalOrientation)",
            "Gets a contact data below the physics body. "
            "The offset is used to set the offset position away from the physics component. "
            "If 'forceDrawLine' is set to true, a debug line is shown. In order to remove the line call this function once with this value set to false. "
            "Note: This method is slower, as the category names must first be translated in to the int category id. "
        ...
        AddClassToCollection("PhysicsActiveComponent", "ContactData getContactAbove(int index, Vector3 offset, bool forceDrawLine, string categoryIds, bool useLocalOrientation)",
            "Gets a contact data above the physics body. "
            "The offset is used to set the offset position away from the physics component. "
            "If 'forceDrawLine' is set to true, a debug line is shown. In order to remove the line call this function once with this value set to false. "
            "If 'useLocalOrientation' is used, the ray will take the local game object orientation into account");

        AddClassToCollection("PhysicsActiveComponent", "ContactData getContactAbove2(int index, Vector3 offset, bool forceDrawLine, string categoryNames, bool useLocalOrientation)",
            "Gets a contact data above the physics body. "
            "The offset is used to set the offset position away from the physics component. "
            "If 'forceDrawLine' is set to true, a debug line is shown. In order to remove the line call this function once with this value set to false. "
            "Note: This method is slower, as the category names must first be translated in to the int category id."
        ...
        AddClassToCollection("PhysicsActiveComponent", "Vector3 getGravityDirection()",
            "Gets the normalized gravity direction vector, if a gravity source game objects are (like planets) are involved. Note: Ogre::VECTOR3_ZERO will be returned if no gravity source game objects are involved.");
        AddClassToCollection("PhysicsActiveComponent", "number getCurrentGravityStrength()",
            "Gets the current gravity direction strength for e.g. player jumps on a planet, if a gravity source game objects are (like planets) are involved. "
    ...
    {
        module(lua)[class_<PhysicsActiveCompoundComponent, PhysicsActiveComponent>("PhysicsActiveCompoundComponent")
        ...
        AddClassToCollection("PhysicsActiveCompoundComponent", "class inherits PhysicsActiveComponent",
            "Derived class of PhysicsActiveComponent. It can be used for more complex compound collision hulls for physically active game objects (movable).");
        AddClassToCollection("PhysicsActiveCompoundComponent", "void setMeshCompoundConfigFile(String collisionHullFileXML)",
            "Sets the collision hull XML file name, which describes the sub-collision hull, that are forming the compound. "
    ...
    {
        module(lua)[class_<PhysicsActiveDestructableComponent, PhysicsActiveComponent>("PhysicsActiveDestructableComponent")
        ...
        AddClassToCollection("PhysicsActiveDestructableComponent", "class inherits PhysicsActiveComponent",
            "Derived class of PhysicsActiveComponent. It can be used to created several random pieces for a collision hull and tied together for desctruction. "
        ...
        AddClassToCollection("PhysicsActiveDestructableComponent", "void setVelocity(Vector3 velocity)",
            "Sets the global linear velocity on the physics body. Note: This should only be used for initzialisation. Use @applyRequiredForceForVelocity in simualtion instead. Or it may be called if its a physics active kinematic body.");
    ...
    {
        module(lua)[class_<PhysicsActiveKinematicComponent, PhysicsActiveComponent>("PhysicsActiveKinematicComponent")
        ...
        AddClassToCollection("PhysicsActiveKinematicComponent", "class inherits PhysicsActiveComponent",
            "Derived class of PhysicsActiveComponent. It is a special kind of physics component. It does not react on forces but just on velocity and collision system.");
        ...
        AddClassToCollection("PhysicsActiveKinematicComponent", "void setOmegaVelocityRotateTo(Quaternion resultOrientation, Vector3 axes, Ogre::Real strength)",
            "Sets the omega velocity to rotate the game object to the given result orientation. "
            "The axes at which the rotation should occur (Vector3::UNIT_Y for y, Vector3::UNIT_SCALE for all axes, or just Vector3(1, 1, 0) for x,y axis etc.). "
            "The strength at which the rotation should occur.");

        AddClassToCollection("PhysicsActiveComponent", "void setKinematicContactSolvingEnabled(bool enable)",
            "Enables kinematic contact solving, to react at the moment when another game object collided with this kinematic game object. "
    ...
    {
        module(lua)[class_<PhysicsArtifactComponent, PhysicsComponent>("PhysicsArtifactComponent")
        ...
        AddClassToCollection("PhysicsArtifactComponent", "void setCollisionFaceId(number id)",
            "Changes the user defined collision attribute stored with faces of the collision mesh. "
    ...
    {
        module(lua)[class_<PhysicsCompoundConnectionComponent, PhysicsActiveComponent>("PhysicsCompoundConnectionComponent")
    ...
    {
        module(lua)[class_<PhysicsPlayerControllerComponent, PhysicsActiveComponent>("PhysicsPlayerControllerComponent")
        ...
        module(lua)[class_<PlayerContact>("PlayerContact")
    ...
    {
        module(lua)[class_<PhysicsActiveVehicleComponent, PhysicsActiveComponent>("PhysicsActiveVehicleComponent")
        ...
        AddClassToCollection("PhysicsActiveVehicleComponent", "void applyPitch(boolean left, number strength, number steeringStrength)",
            "Applies a drift at the given strength (jump) and if left side, at the given steering strength and vice versa. Note: A high force strength is required to put the vehicle in the air, e.g. 50000NM.");
        AddClassToCollection("PhysicsActiveVehicleComponent", "void applyDrift(number strength, number dt)",
            "Apply angular impulse (stable + timestep aware). Strength is in 'torque - like' units; start with something like 1500..6000 depending on mass.");
        ...
        module(lua)[class_<VehicleDrivingManipulation>("VehicleDrivingManipulation")
        ...
        module(lua)[class_<PhysicsActiveComplexVehicleComponent, PhysicsActiveComponent>("PhysicsActiveComplexVehicleComponent")
        ...
        AddClassToCollection("PhysicsActiveComplexVehicleComponent", "void applyDrift(boolean left, number strength, number steeringStrength)",
            "Applies a drift at the given strength (jump) and if left side, at the given steering strength and vice versa. Note: A high force strength is required to put the vehicle in the air, e.g. 50000NM.");

        module(lua)[class_<ComplexVehicleDrivingManipulation>("ComplexVehicleDrivingManipulation")
    ...
    {
        module(lua)[class_<OgreNewt::ContactSnapshot>("Contact")
        ...
        AddClassToCollection("Contact", "Table[Vector3][Vector3] getPositionAndNormal()",
            "Gets the contact position and normal. Usage: local data = contact:getPositionAndNormal(); "
        ...
        AddClassToCollection("Contact", "void setFrictionState(int state, int index)",
            "Enables or disables friction calculation for this contact. Note: State 0 makes the contact frictionless along the index tangent vector. The index 0 is for primary tangent vector or 1 for the secondary tangent.");
        AddClassToCollection("Contact", "void setFrictionCoefficient(float static, float kinetic, int index)",
            "Overrides the default value of the kinetic and static coefficient of friction for this contact. Note: Static friction coefficient must be positive. Kinetic friction coeeficient must be positive. The index 0 is for primary tangent "
            "vector or 1 for the secondary tangent.");
        AddClassToCollection("Contact", "void setTangentAcceleration(float acceleration)",
            "Forces the contact point to have a non-zero acceleration along the surface plane. Note: The index 0 is for primary tangent vector or 1 for the secondary tangent.");
        AddClassToCollection("Contact", "void setRotateTangentDirections(Vector3 direction)",
            "Rotates the tangent direction of the contacts until the primary direction is aligned with the align Vector. Details: This function rotates the tangent vectors of the "
            "contact point until the primary tangent vector and the align vector are perpendicular (ex. when the dot product between the primary tangent vector and the alignVector is 1.0). This function can be used in conjunction with "
            "@setTangentAcceleration in order to create special effects. For example, conveyor belts, cheap low LOD vehicles, slippery surfaces, etc.");
        AddClassToCollection("Contact", "void setNormalDirection(Vector3 direction)",
            "Sets the new direction of the for this contact point. Note: This function changes the basis of the contact point to one where the contact normal is aligned to the new direction vector and the tangent direction are recalculated to be "
            "perpendicular to the new contact normal.");
        AddClassToCollection("Contact", "void setNormalAcceleration(float acceleration)",
            "Forces the contact point to have a non-zero acceleration aligned this the contact normal. Note: This function can be used for special effects like implementing jump, of explosive contact in a call back.");
        AddClassToCollection("Contact", "float getContactForce()",
            "Gets the contact force vector in global space. Note: The contact force value is only valid when calculating resting contacts. This means if two bodies collide with non zero relative velocity, the reaction force will be an impulse, "
            "which is not a reaction force, this will return zero vector. "
        ...
        AddClassToCollection("Contact", "void setContactTangentFriction(float friction, int index)",
            "Sets the contact tangent friction along the surface plane. Note: State 0 makes the contact frictionless along the index tangent vector. The index 0 is for primary tangent vector or 1 for the secondary tangent.");
        ...
        module(lua)[class_<PhysicsMaterialComponent, GameObjectComponent>("PhysicsMaterialComponent")
        ...
        AddClassToCollection("PhysicsMaterialComponent", "void setFriction(Vector2 frictionData)",
            "Overrides the friction for this two material categories. Note: Friction data x value is the static friction and y the kinetic friction. "
            "Note: static friction and kinetic friction must be positive values. Kinetic friction must be lower than static friction. It is recommended that static friction and kinetic friction be set to a value lower or equal to 1.0, however "
        ...
        AddClassToCollection("PhysicsMaterialComponent", "void setSoftness(float softness)",
            "Overrides the softness for this two material categories. Details: A typical value for softness coefficient is 0.15, default value is 0.1. "
        ...
        AddClassToCollection("PhysicsMaterialComponent", "void setElasticity(float elasticity)",
            "Overrides the default coefficients of restitution (elasticity) for the material interaction between two physics material categories. Note: Must be a positive value. It is recommended that elastic coefficient be set to a value lower or "
            "equal to 1.0.");
        AddClassToCollection("PhysicsMaterialComponent", "float getElasticity()", "Gets the elasticity this two material categories.");
        AddClassToCollection("PhysicsMaterialComponent", "void setSurfaceThickness(float surfaceThickness)",
            "Overrides the surface thickness for this two material categories. "
        ...
        AddClassToCollection("PhysicsMaterialComponent", "void setCollideable(bool collideable)",
            "Overrides the collidable state for this two material categories. Note: False means that those two material groups will not collide against each other.");
    ...
    {
        module(lua)[class_<PlaneComponent, GameObjectComponent>("PlaneComponent")
        ...
        AddClassToCollection("PlaneComponent", "void setNumTexCoordSets(float numTexCoordSets)",
            "Sets number of texture coordinate sets of the plane. Note: Plane will be reconstructed, if there is a @PhysicsArtifactComponent, the collision hull will also be re-generated.");
    ...
    {
        module(lua)[class_<PhysicsTerrainComponent, PhysicsComponent>("PhysicsTerrainComponent")
        ...
        AddClassToCollection("PhysicsTerrainComponent", "void setCollisionFaceId(number id)",
            "Changes the user defined collision attribute stored with faces of the collision mesh. "
            "This function is used to obtain the user data stored in faces of the collision geometry. "
            "The application can use this user data to achieve per polygon material behavior in large static collision meshes. "
            "By changing the value of this user data the application can achieve modifiable surface behavior with the collision geometry. "
    ...
    {
        module(lua)[class_<SimpleSoundComponent, GameObjectComponent>("SimpleSoundComponent")
        ...
        AddClassToCollection("SimpleSoundComponent", "void setStream(bool stream)",
            "Sets whether this sound should be streamed instead of fully loaded to buffer. "
        ...
        AddClassToCollection("SimpleSoundComponent", "void setRelativeToListener(bool relativeToListener)",
            "Sets whether this should should be played relative to the listener. Note: "
        ...
        AddClassToCollection("SimpleSoundComponent", "void setFadeInOutTime(Vector2 fadeInFadeOutTime)",
            "Setting fadeInFadeOutTime.x, the sound starts playing while fading in. Setting fadeInFadeOutTime.y fades out, but keeps playing at volume 0, so it can be faded in again.");
        AddClassToCollection("SimpleSoundComponent", "void setInnerOuterConeAngle(Vector2 innerOuterConeAngle)",
            "Setting innerOuterConeAngle.x sets the inner angle of the sound cone for a directional sound. Valid values are [0 - 360]. "
        ...
        AddClassToCollection("SimpleSoundComponent", "void setOuterConeGain(float outerConeGain)",
            "Sets the gain outside the sound cone of a directional sound. Note: "
        ...
        AddClassToCollection("SimpleSoundComponent", "void setDistanceValues(Vector3 distanceValues)",
        ...
        AddClassToCollection("SimpleSoundComponent", "void setDirection(Vector3 direction)",
            "Sets the direction of the sound. Note: In the case that this sound is attached to a SceneNode this directions becomes relative to the parent's direction. Default value is NEGATIVE_UNIT_Z.");
        ...
        AddClassToCollection("SimpleSoundComponent", "void enableSpectrumAnalysis(bool enable, int processingSize, int numberOfBands, WindowType windowType, SpectrumPreparationType spectrumPreparationType, float smoothFactor)",
            "Enables spectrum analysis."
            "Sets the spectrum processing size. Note: addSoundSpectrumHandler must be used and stream must be set to true and spectrumProcessingSize must always be higher as mSpectrumNumberOfBands and divisible by 2. Default value is 1024. It must "
            "not go below 1024"
        ...
        AddClassToCollection("SimpleSoundComponent", "Ogre::Real getSpectrumAreaIntensity(SpectrumArea spectrumArea)", "Returns the current intensity (energy level) of the requested audio spectrum area. \
    ...
    {
        module(lua)[class_<SpawnComponent, GameObjectComponent>("SpawnComponent")
        ...
        AddClassToCollection("SpawnComponent", "void setLifeTimeMS(int lifeTimeMS)",
            "Sets the spawned game object life time in milliseconds. When the life time is set to 0, the spawned gameobject will live forever. Details: E.g. a life time of 10000 would let live the spawned game object for 10 seconds.");
        ...
        AddClassToCollection("SpawnComponent", "void setOffsetOrientation(Quaternion offsetOrientation)",
            "Sets an offset orientation at which the spawned game objects will occur relative to the origin game object. Note: The offset orientation to set (degreeX, degreeY, degreeZ).");
        ...
        AddClassToCollection("SpawnComponent", "void setSpawnAtOrigin(bool spawnAtOrigin)",
            "Sets whether the spawn new game objects always at the init position or the current position of the original game object. Note: "
        ...
        AddClassToCollection("SpawnComponent", "void setSpawnTargetId(String spawnTargetId)",
            "Sets spawn target game object id. Note: "
        ...
        AddClassToCollection("SpawnComponent", "void reactOnSpawn(func closure, spawnedGameObject, originGameObject)", "Sets whether to react at the moment when a game object is spawned.");
        AddClassToCollection("SpawnComponent", "void reactOnVanish(func closure, spawnedGameObject, originGameObject)", "Sets whether to react at the moment when a game object is vanished.");
    }
    ...
    {
        module(lua)[class_<KI::Path>("Path")
        ...
        AddClassToCollection("MovingBehavior", "void setObstacleHideData(String obstaclesHideCategories, float obstacleRangeRadius)",
            "Sets the categories of game objects which do count as obstacle and a range radius, "
            "at which the agent will hide, if 'HIDE' behavior is set. Note: Combined categories can be used like 'ALL-Player' etc.");
        AddClassToCollection("MovingBehavior", "void setObstacleAvoidanceData(String obstaclesHideCategories, float obstacleRangeRadius)",
            "Sets the categories of game objects which do count as obstacle and a range radius, "
            "at which the agent will start turning from the obstacle. Note: Combined categories can be used like 'ALL-Player' etc.");
        AddClassToCollection("MovingBehavior", "void setGoalRadius(float radius)",
            "Sets the tolerance radius, at which the agent is considered to be at the goal. Note: If the radius is to small, It may happen, that the agent never reaches the goal. Default value is 0.2.");
        ...
        AddClassToCollection("MovingBehavior", "void setPathFindData(int pathSlot, int targetSlot, bool drawPath)",
            "Sets the path find data, if recast navigation is enabled. "
        ...
        AddClassToCollection("MovingBehavior", "void findPath()",
            "Tries to find an optimal path. It takes a start point and an end point and, if possible, generates a list of lines in a path. "
            "It might fail if the start or end points aren't near any navigation mesh polygons, or if the path is too long, or it can't make a path, or various other reasons.So far I've not had problems though. Note: Recast navigation must be "
            "enabled.");
        ...
        AddClassToCollection("MovingBehavior", "void setAutoAnimation(bool autoAnimation)",
            "Sets whether to use auto animation during ai movement. That is, the animation speed is adapted dynamically depending the velocity, which will create a much more realistic effect. Note: The game object must have a proper configured "
            "animation component.");
        ...
        module(lua)[class_<LuaStateMachine<GameObject>>("LuaStateMachine")
        ...
        module(lua)[class_<AiLuaComponent, GameObjectComponent>("AiLuaComponent")
        ...
        AddClassToCollection("AiLuaComponent", "void setGlobalState(Table stateName)",
            "Sets the global state name, which will be loaded in lua script and executed besides the current state. Important: Do not use state function in 'connect' function, because at this time the AiLuaComponent is not ready!");
        ...
        AddClassToCollection("AiLuaComponent", "String getPreviousState()",
            "Gets the previous state name, that has been loaded bevor the current state name. Important: Do not use state function in 'connect' function, because at this time the AiLuaComponent is not ready!");
        AddClassToCollection("AiLuaComponent", "String getGlobalState()",
            "Gets the global state name, if existing, else empty string. Important: Do not use state function in 'connect' function, because at this time the AiLuaComponent is not ready!");
        AddClassToCollection("AiLuaComponent", "void changeState(Table newStateName)",
            "Changes the current state name to a new one. Calles 'exit' function on the current state and 'enter' on the new state in lua script. Important: Do not use state function in 'connect' function, because at this time the AiLuaComponent is "
            "not ready!");
        AddClassToCollection("AiLuaComponent", "void revertToPreviousState()",
            "Changes the current state name to the previous one. Calles 'exit' function on the current state and 'enter' on the previous state in lua script. Important: Do not use state function in 'connect' function, because at this time the "
            "AiLuaComponent is not ready!");
        AddClassToCollection("AiLuaComponent", "void reactOnPathGoalReached(func closure, GameObject targetGameObject, string functionName, GameObject gameObject)", "Sets whether to react the agent reached the goal.");
        AddClassToCollection("AiLuaComponent", "void reactOnAgentStuck(func closure, GameObject targetGameObject, string functionName, GameObject gameObject)", "Sets whether to react the agent got stuck.");
    }
    ...
    {
        module(lua)[class_<MyGUIComponent, GameObjectComponent>("MyGUIComponent")
        ...
        AddClassToCollection("MyGUIComponent", "void setLayer(String layer)",
            "Sets the widget's layer (z-order). Possible values are: 'Wallpaper', 'ToolTip', 'Info', 'FadeMiddle', 'Popup', 'Main', 'Modal', 'Middle', 'Overlapped', 'Back', 'DragAndDrop', 'FadeBusy', 'Pointer', 'Fade', 'Statistic'. Default value is "
            "'POPUP'");
        ...
        AddClassToCollection("MyGUIComponent", "String getId()",
            "Gets the id of this widget. Note: Widgets can be attached as child of other widgets and be transformed relatively to their parent widget. Hence each widget has an id and its parent id can be filled with the id of another widget "
            "component in the same game object..");
        AddClassToCollection("MyGUIComponent", "void setParentId(String parentId)",
            "Sets the parent widget id. Note: Widgets can be attached as child of other widgets and be transformed relatively to their parent widget. Hence each widget has an id and its parent id can be filled with the id of another widget "
            "component in the same game object..");
        AddClassToCollection("MyGUIComponent", "bool getParentId()", "Gets the parent id of this widget.");
        AddClassToCollection("MyGUIComponent", "void reactOnMouseButtonClick(func closureFunction)", "Sets whether to react if a mouse button has been clicked on the given widget.");
        AddClassToCollection("MyGUIComponent", "void reactOnMouseEnter(func closureFunction)", "Sets whether to react if mouse has entered the given widget (hover start).");
        AddClassToCollection("MyGUIComponent", "void reactOnMouseEnter(func closureFunction)", "Sets whether to react if mouse has left the given widget (hover end).");

        module(lua)[class_<MyGUIWindowComponent, MyGUIComponent>("MyGUIWindowComponent")
        ...
        AddClassToCollection("MyGUIWindowComponent", "void setSkin(String skin)",
            "Sets the widgets skin. Possible values are: 'WindowCSX', 'Window', 'WindowC', 'WindowCX', 'WindowCS', 'WindowCX2_Dark', 'WindowCXS2_Dark', 'Back1Skin_Dark', 'PanelSkin'.");
        ...
        module(lua)[class_<MyGUITextComponent, MyGUIComponent>("MyGUITextComponent")
        ...
        AddClassToCollection("MyGUITextComponent", "void setFontHeight(int fontHeight)",
            "Sets the font height for this widget. Note: Minimum value is 10 and maximum value is 60. Odd font sizes will be rounded to the next even font size. E.g. 23 will become 24.");
        AddClassToCollection("MyGUITextComponent", "int getFontHeight()", "Gets the font height of this widget.");
        AddClassToCollection("MyGUITextComponent", "void setTextAlign(String align)",
            "Sets the widget text alignment. Possible values are: 'HCenter', 'Center', 'Left', 'Right', 'HStretch', 'Top', 'Bottom', 'VStretch', 'Stretch', 'Default' (LEFT|TOP).");
        ...
        module(lua)[class_<MyGUIButtonComponent, MyGUIComponent>("MyGUIButtonComponent")
        ...
        AddClassToCollection("MyGUIButtonComponent", "void setFontHeight(int fontHeight)",
            "Sets the font height for this widget. Note: Minimum value is 10 and maximum value is 60. Odd font sizes will be rounded to the next even font size. E.g. 23 will become 24.");
        AddClassToCollection("MyGUIButtonComponent", "int getFontHeight()", "Gets the font height of this widget.");
        AddClassToCollection("MyGUIButtonComponent", "void setTextAlign(String align)",
            "Sets the widget text alignment. Possible values are: 'HCenter', 'Center', 'Left', 'Right', 'HStretch', 'Top', 'Bottom', 'VStretch', 'Stretch', 'Default' (LEFT|TOP).");
        ...
        module(lua)[class_<MyGUICheckBoxComponent, MyGUIComponent>("MyGUICheckBoxComponent")
        ...
        AddClassToCollection("MyGUICheckBoxComponent", "void setFontHeight(int fontHeight)",
            "Sets the font height for this widget. Note: Minimum value is 10 and maximum value is 60. Odd font sizes will be rounded to the next even font size. E.g. 23 will become 24.");
        AddClassToCollection("MyGUICheckBoxComponent", "int getFontHeight()", "Gets the font height of this widget.");
        AddClassToCollection("MyGUICheckBoxComponent", "void setTextAlign(String align)",
            "Sets the widget text alignment. Possible values are: 'HCenter', 'Center', 'Left', 'Right', 'HStretch', 'Top', 'Bottom', 'VStretch', 'Stretch', 'Default' (LEFT|TOP).");
        ...
        module(lua)[class_<MyGUIImageBoxComponent, MyGUIComponent>("MyGUIImageBoxComponent")
        ...
        module(lua)[class_<MyGUIProgressBarComponent, MyGUIComponent>("MyGUIProgressBarComponent")
        ...
        module(lua)[class_<MyGUIListBoxComponent, MyGUIComponent>("MyGUIListBoxComponent")
        ...
        AddClassToCollection("MyGUIListBoxComponent", "void reactOnSelected(func closureFunction, int index)", "Sets whether to react if a list item has been selected. The clicked list item index will be received.");
        AddClassToCollection("MyGUIListBoxComponent", "void reactOnAccept(func closureFunction, int index)", "Sets whether to react if a list item change has been accepted. The accepted list item index will be received.");

        module(lua)[class_<MyGUIComboBoxComponent, MyGUIComponent>("MyGUIComboBoxComponent")
        ...
        AddClassToCollection("MyGUIComboBoxComponent", "void reactOnSelected(func closureFunction, int index)", "Sets whether to react if a list item has been selected. The clicked list item index will be received.");
        ...
        module(lua)[class_<MyGUI::MessageBoxStyle>("MessageBoxStyle")
                .enum_("Enum")[value("Ok", MyGUI::MessageBoxStyle::Ok), value("Yes", MyGUI::MessageBoxStyle::Yes), value("No", MyGUI::MessageBoxStyle::No), value("Abort", MyGUI::MessageBoxStyle::Abort), value("Retry", MyGUI::MessageBoxStyle::Retry),
                    value("Ignore", MyGUI::MessageBoxStyle::Ignore), value("Cancel", MyGUI::MessageBoxStyle::Cancel), value("Try", MyGUI::MessageBoxStyle::Try), value("Continue", MyGUI::MessageBoxStyle::Continue)]];
        ...
        module(lua)[class_<MyGUIMessageBoxComponent, GameObjectComponent>("MyGUIMessageBoxComponent")
        ...
        AddClassToCollection("MyGUIMessageBoxComponent", "void setStyle(unsigned int index, String style)",
            "Sets the style at the given index. Possible values are: "
        ...
        module(lua)[class_<MyGUIControllerComponent, GameObjectComponent>("MyGUIControllerComponent")
        ...
        module(lua)[class_<MyGUIPositionControllerComponent, MyGUIControllerComponent>("MyGUIPositionControllerComponent")
        ...
        AddClassToCollection("MyGUIPositionControllerComponent", "void setCoordinate(Vector4 coordinate)",
            "Sets the target transform coordinate at which the widget will be moved and resized. Note: x,y is the new relative position and z,w is the new size. If z,w is set to 0, the widget will keep its current size.");
        ...
        module(lua)[class_<MyGUIFadeAlphaControllerComponent, MyGUIControllerComponent>("MyGUIFadeAlphaControllerComponent")
        ...
        module(lua)[class_<MyGUIScrollingMessageControllerComponent, MyGUIControllerComponent>("MyGUIScrollingMessageControllerComponent")
        ...
        module(lua)[class_<MyGUIEdgeHideControllerComponent, MyGUIControllerComponent>("MyGUIEdgeHideControllerComponent")
        ...
        module(lua)[class_<MyGUIRepeatClickControllerComponent, MyGUIControllerComponent>("MyGUIRepeatClickControllerComponent")
        ...
        module(lua)[class_<MyGUIMiniMapComponent, MyGUIWindowComponent>("MyGUIMiniMapComponent")
        ...
        AddClassToCollection("MyGUIMiniMapComponent", "void setStartPosition(Vector2 startPosition)",
            "Sets the relative start position, at which the whole minimap will be generated. Default value is 0,0 (left, top corner). E.g. setting to 0.5, 0.5 would start in the middle of the screen.");
        ...
        AddClassToCollection("MyGUIMiniMapComponent", "void setTrackableId(int index, String id)",
            "Sets the trackable id for the given trackable index, that is shown on the mini map. Note: "
        ...
        AddClassToCollection("MyGUIMiniMapComponent", "void setTrackableImageTileSize(int index, Vector2 tileSize)",
            "Sets the image tile size for the given trackable index. Details: Image may be of size: 32x64, but tile size 32x32, so that sprite animation is done automatically switching the image tiles from 0 to 32 and 32 to 64 automatically.");
        ...
        AddClassToCollection("MyGUIMiniMapComponent", "void reactOnMouseButtonClick(func closureFunction, int mapTileIndex)", "Sets whether to react if a mouse button has been clicked on the minimap. The clicked map tile index will be received.");
    }
    ...
    {
        module(lua)[class_<OgreAL::AudioProcessor>("AudioProcessor")
                .enum_("SpectrumPreparationType")[value("RAW", OgreAL::AudioProcessor::SpectrumPreparationType::RAW), value("LINEAR", OgreAL::AudioProcessor::SpectrumPreparationType::LINEAR),
                    value("LOGARITHMIC", OgreAL::AudioProcessor::SpectrumPreparationType::LOGARITHMIC)]
                .enum_("SpectrumArea")[value("KICK_DRUM", OgreAL::AudioProcessor::SpectrumArea::KICK_DRUM), value("SNARE_DRUM", OgreAL::AudioProcessor::SpectrumArea::SNARE_DRUM), value("DEEP_BASS", OgreAL::AudioProcessor::SpectrumArea::DEEP_BASS),
                    value("LOW_BASS", OgreAL::AudioProcessor::SpectrumArea::LOW_BASS), value("MID_BASS", OgreAL::AudioProcessor::SpectrumArea::MID_BASS), value("UPPER_BASS", OgreAL::AudioProcessor::SpectrumArea::UPPER_BASS),
                    value("LOWER_MIDRANGE", OgreAL::AudioProcessor::SpectrumArea::LOWER_MIDRANGE), value("MIDDLE_MIDRANGE", OgreAL::AudioProcessor::SpectrumArea::MIDDLE_MIDRANGE),
                    value("UPPER_MIDRANGE", OgreAL::AudioProcessor::SpectrumArea::UPPER_MIDRANGE), value("PRESENCE_RANGE", OgreAL::AudioProcessor::SpectrumArea::PRESENCE_RANGE), value("HIGH_END", OgreAL::AudioProcessor::SpectrumArea::HIGH_END),
                    value("EXTREMELY_HIGH_END", OgreAL::AudioProcessor::SpectrumArea::EXTREMELY_HIGH_END), value("HI_HAT", OgreAL::AudioProcessor::SpectrumArea::HI_HAT)]];

        module(lua)[class_<OgreAL::AudioProcessor::SpectrumPreparationType>("SpectrumPreparationType")
                .enum_("SpectrumPreparationType")[value("RAW", OgreAL::AudioProcessor::SpectrumPreparationType::RAW), value("LINEAR", OgreAL::AudioProcessor::SpectrumPreparationType::LINEAR),
                    value("LOGARITHMIC", OgreAL::AudioProcessor::SpectrumPreparationType::LOGARITHMIC)]];

        module(lua)[class_<OgreAL::AudioProcessor::SpectrumArea>("SpectrumArea")
                .enum_("SpectrumArea")[value("KICK_DRUM", OgreAL::AudioProcessor::SpectrumArea::KICK_DRUM), value("SNARE_DRUM", OgreAL::AudioProcessor::SpectrumArea::SNARE_DRUM), value("DEEP_BASS", OgreAL::AudioProcessor::SpectrumArea::DEEP_BASS),
                    value("LOW_BASS", OgreAL::AudioProcessor::SpectrumArea::LOW_BASS), value("MID_BASS", OgreAL::AudioProcessor::SpectrumArea::MID_BASS), value("UPPER_BASS", OgreAL::AudioProcessor::SpectrumArea::UPPER_BASS),
                    value("LOWER_MIDRANGE", OgreAL::AudioProcessor::SpectrumArea::LOWER_MIDRANGE), value("MIDDLE_MIDRANGE", OgreAL::AudioProcessor::SpectrumArea::MIDDLE_MIDRANGE),
                    value("UPPER_MIDRANGE", OgreAL::AudioProcessor::SpectrumArea::UPPER_MIDRANGE), value("PRESENCE_RANGE", OgreAL::AudioProcessor::SpectrumArea::PRESENCE_RANGE), value("HIGH_END", OgreAL::AudioProcessor::SpectrumArea::HIGH_END),
        ...
        module(lua)[class_<OgreAL::MathWindows>("MathWindows")
                .enum_("WindowType")[value("RECTANGULAR", OgreAL::MathWindows::WindowType::RECTANGULAR), value("BLACKMAN", OgreAL::MathWindows::WindowType::BLACKMAN), value("BLACKMAN_HARRIS", OgreAL::MathWindows::WindowType::BLACKMAN_HARRIS),
                    value("TUKEY", OgreAL::MathWindows::WindowType::TUKEY), value("HANNING", OgreAL::MathWindows::WindowType::HANNING), value("HAMMING", OgreAL::MathWindows::WindowType::HAMMING),
        ...
        module(lua)[class_<OgreAL::Sound, Ogre::MovableObject>("Sound")
        ...
        module(lua)[class_<OgreALModule>("OgreALModule")
        ...
        AddClassToCollection("OgreALModule", "void setContinue(bool bContinue)",
            "Sets whether the sound manager continues with the current scene manager. "
    ...
    {
        module(lua)[class_<OgreNewtModule>("OgreNewtModule")
    ...
    void bindOgreRecastModule(lua_State* lua)
    {
        ...
        module(lua)[class_<OgreRecastModule>("OgreRecastModule")
    ...
    {
        module(lua)[class_<ParticleBlendingMethod::ParticleBlendingMethod>("ParticleBlendingMethod")
                .enum_("ParticleBlendingMethod")[value("AlphaHashing", ParticleBlendingMethod::AlphaHashing), value("AlphaHashingA2C", ParticleBlendingMethod::AlphaHashingA2C), value("AlphaBlending", ParticleBlendingMethod::AlphaBlending),
                    value("AlphaTransparent", ParticleBlendingMethod::AlphaTransparent), value("TransparentColour", ParticleBlendingMethod::TransparentColour), value("FromMaterial", ParticleBlendingMethod::FromMaterial)]];

        module(lua)[class_<ParticleFadeState::ParticleFadeState>("ParticleFadeState")
                .enum_("ParticleFadeState")[value("None", ParticleFadeState::None), value("FadingIn", ParticleFadeState::FadingIn), value("FadingOut", ParticleFadeState::FadingOut)]];

        module(lua)[class_<ParticleFxModule>("ParticleFxModule")
        ...
        AddClassToCollection("ParticleFxModule",
            "void createParticleSystem(String name, String templateName, float playTimeMS, Quaternion orientation, Vector3 position, Vector2 scale, bool repeat, float playSpeed, "
            "ParticleBlendingMethod blendingMethod, bool fadeIn, float fadeInTimeMS, bool fadeOut, float fadeOutTimeMS)",
            "Creates a particle system instance with the given settings. Lua must pass all parameters (no default values via luabind).");
    ...
    {
        module(lua)[class_<Interpolator>("Interpolator")
        ...
        AddClassToCollection("Interpolator", "float value, float xLowBorder, float xHighBorder,float yLowBorder, float yHighBorder)",
        ...
        AddClassToCollection("Interpolator", "float easeOutBack(float t, float magnitude)",
            "Fast snap to backwards point then slow resolve to finish. The time t e.g. t = (time - animationStart) / duration. Info: Good value for magnitude is 1.70158");
        ...
        AddClassToCollection("Interpolator", "float easeInOutElastic(float t, float magnitude)",
            "Slow start and end, two bounces sandwich a fast motion. The time t e.g. t = (time - animationStart) / duration. Info: Good value for magnitude is 0.65");
    ...
    {
        module(lua)[class_<MathHelper>("MathHelper")
        ...
        AddClassToCollection("MathHelper", "Vector4 getCalibratedWindowCoordinates(float x, float y, float width, float height, Viewport viewport)",
            "Gets the relative position to the window size. For example mapping an crosshair overlay object and conrolling it via mouse or Wii controller..");
        AddClassToCollection("MathHelper", "float lowPassFilter(float value, float oldValue, float scale)",
            "A low pass filter in order to smooth chaotic values. This is for example useful for the position determination of infrared camera of the Wii controller or smooth movement at all.");
        AddClassToCollection("MathHelper", "Vector3 lowPassFilter(Vector3 value, Vector3 oldValue, float scale)",
            "A low pass filter for vector3 in order to smooth chaotic values. This is for example useful for the position determination of infrared camera of the Wii controller or smooth movement at all.");
        ...
        AddClassToCollection("MathHelper", "Vector3 extractEuler(Quaternion quat)",
            "Extracts the yaw (heading), pitch and roll out of the quaternion. "
        ...
        AddClassToCollection("MathHelper", "Quaternion getOrientationFromHeadingPitch(Quaternion orientation, number steeringAngle, number pitchAngle, Vector3 defaultModelDirection)",
            "Gets the new orientation out from the current orientation and its steering angle in radians and pitch angle in radians, taking the default model direction into account.");
        ...
        AddClassToCollection("MathHelper", "Quaternion faceTarget(SceneNode source, SceneNode dest, Vector3 defaultDirection)",
            "Gets the orientation in order to face a target, this orientation can be set directly, taking the default direction of the source game object into account.");
        ...
        AddClassToCollection("MathHelper", "Radian getAngle(Vector3 dir1, Vector3 dir2, Vector3 normal, bool signedAngle)",
        ...
        AddClassToCollection("MathHelper", "Quaternion lookAt(Vector3 unnormalizedDirection)",
            "Gets the orientation in order to look a the target direction with a fixed axis. Note: The fixed axis y is used so that the result quaternion will not pitch or roll.");
        ...
        AddClassToCollection("MathHelper", "Quaternion faceDirectionSlerp(Quaternion sourceOrientation, Vector3 direction, Vector3 localDirectionVector, float dt, float speed)", "Computes the quaternion using slerp for face a direction.");
    ...
    {
        module(lua)[class_<LuaScriptComponent, GameObjectComponent>("LuaScriptComponent").def("callDelayedMethod", &LuaScriptComponent::callDelayedMethod).def("callMethodOnce", &LuaScriptComponent::callMethodOnce)];
    ...
    void bindLuaScriptEventManager(lua_State* lua)
    {
        ...
        AddClassToCollection("ScriptEventManager", "class",
            "ScriptEventManager can be used to define events in lua. Its possible to register an event and subscribe for that event in any other lua script file. Note: Its also possible to react in C++ on a lua event.");
        AddClassToCollection("ScriptEventManager", "void registerEvent(String eventName)",
            "Registers a new event name. Note: registered events must be known by all other lua scripts. Hence its a good idea to use the init.lua script for event registration. For example: 'AppStateManager:getScriptEventManager():registerEvent("
            "/DestroyStone"
            "/);'");
        AddClassToCollection("ScriptEventManager", "void registerEventListener(EventType eventType, luabind::object callbackFunction)",
            "Registers an event listener, that wants to react on an event. When the events gets trigger somewhere, the callback function in lua is called. "
    ...
    void bindCore(lua_State* lua)
    {
        ...
        AddClassToCollection("Core", "String getSaveFilePathName(String saveGameName)",
            "Gets the save file path name, or empty string, if does not exist. Note: This is usefull for debug purposes, to see, where a game does store its content and open those files for analysis etc.");
    ...
    {
        module(lua)[class_<AppStateManager>("AppStateManager")
        ...
        AddClassToCollection("AppStateManager", "singleton",
            "Some functions for NOWA game loop and applictation state management. That is, normally only one scene can be running at a time. But putting a scene into an own state. "
        ...
        AddClassToCollection("AppStateManager", "bool hasAppStateStarted(String stateName)",
            "Gets whether the given AppState has started. Note: This can be used to ask from another AppState like a MenuState, "
            " whether a GameState has already started, so that e.g. a continue button can be shown in the Menu.");
        AddClassToCollection("AppStateManager", "bool isInAppstate(String stateName)",
            "Gets whether the simulation is in the given app state. Note: This can be used to ask if the simulation e.g. is in a MenuState, "
    ...
    LuaScriptApi::LuaScriptApi() : lua(0)
    {
    ...
    void LuaScriptApi::init(const Ogre::String& resourceGroupName)
    {
        ...
        if (nullptr == this->lua)
        {
            ...
            try
            {
                ...
                bindPlayerControllerComponents(this->lua, gameObjectClass, gameObjectControllerClass);
    ...
    void LuaScriptApi::errorHandler(luabind::error& err, Ogre::String file, Ogre::String function)
    {
        ...
        Ogre::LogManager::getSingletonPtr()->logMessage(Ogre::LML_CRITICAL, "[LuaScriptApi] Error in lua script: '" + file + "' and function '" + function + "': " + error + " - " + err.what());
    }
    ...
    void LuaScriptApi::errorHandler(luabind::cast_failed& castError, Ogre::String file, Ogre::String function)
    {
        ...
        Ogre::LogManager::getSingletonPtr()->logMessage(Ogre::LML_CRITICAL, "[LuaScriptApi] Cast error on return function in lua script: '" + file + "' and function '" + function + "': " + castError.what());
    }
    ...
    void LuaScriptApi::printErrorMessage(luabind::error& error, const Ogre::String& function)
    {
        ...
        {
            Ogre::LogManager::getSingleton().logMessage(Ogre::LML_CRITICAL, "[LuaScriptApi] Caught error in '" + function + "' Error: " + Ogre::String(error.what()) + " details: " + msg.str());
            ...
            else
            {
                ...
                for (auto subIt = it->second.cbegin(); subIt != it->second.cend(); ++subIt)
                {
                    ...
                    else
                    {
                        ...
                        // AddClassToCollection("NodeTrackComponent", "void setNodeTrackId(unsigned int index, String id)", "Sets the node track id for the given index in the node track list with @nodeTrackCount elements. Note: The order is
                        // controlled by the index, from which node to which node this game object will be tracked.");
                        Ogre::String description = replaceAll(subIt->second, "\n", " ");
                        luaJsonApiContent += "\t\t\t\tdescription = \"" + description + "\",\n";
                        // Args
                        Ogre::String argsPart = "";
