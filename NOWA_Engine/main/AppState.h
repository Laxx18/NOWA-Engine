...
namespace NOWA
{
    ...
    protected:
        ...
        // Attention: never cache the WorkspaceBaseComponent pointer across a pause/resume.
        // The owning game object can be destroyed while this state sits paused on the stack, and
        // the cached pointer then dangles (reads as 0xdddddddddddddddd in a debug build), which
...
// pAppState bsp. Gamestate oder Menustate werden �ber das Makro erstellt
