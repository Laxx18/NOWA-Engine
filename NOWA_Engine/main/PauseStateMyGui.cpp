...
namespace NOWA
{
	...
	void PauseStateMyGui::enter(void)
	{
		...
		ENQUEUE_RENDER_COMMAND_WAIT("PauseStateMyGui::enter",
		{
	...
	void PauseStateMyGui::exit(void)
	{
		...
		ENQUEUE_RENDER_COMMAND_WAIT("PauseStateMyGui::exit",
		{
	...
	void PauseStateMyGui::buttonHit(MyGUI::WidgetPtr _sender)
	{
		...
		{
			ENQUEUE_RENDER_COMMAND_WAIT("PauseStateMyGui::buttonHit QuitButton",
			{
