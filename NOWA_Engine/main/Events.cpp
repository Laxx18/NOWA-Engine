...
// To define a new event - you need a 32-bit unsigned long. 
// In Visual Studio, go to Tools->Create unsigned long and grab the first bit.

// const EventType EventDataNewGameObject::eventType(0xe86c7c31);
// const EventType EventDataMoveGameObject::eventType(0xeeaa0a40);
