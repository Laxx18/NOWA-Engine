...
namespace NOWA
{
	...
	void MenuStateMyGui::enter(void)
	{
		...
		ENQUEUE_RENDER_COMMAND_WAIT("MenuStateMyGui::enter",
		{
	...
	void MenuStateMyGui::exit()
	{
		...
		ENQUEUE_RENDER_COMMAND_WAIT("MenuStateMyGui::exit",
		{
	...
	void MenuStateMyGui::createBackgroundMusic(void)
	{
		...
		ENQUEUE_RENDER_COMMAND_WAIT("MenuStateMyGui::createBackgroundMusic menuMusic play",
		{
			this->menuMusic->play();
		});
	}
	...
	{
		ENQUEUE_RENDER_COMMAND_WAIT("MenuStateMyGui::populateOptions",
		{
	...
	void MenuStateMyGui::buttonHit(MyGUI::Widget* _sender)
	{
		...
		{
			ENQUEUE_RENDER_COMMAND("MenuStateMyGui::buttonHit optionsButton",
			{
		...
		{
			ENQUEUE_RENDER_COMMAND_WAIT("MenuStateMyGui::buttonHit quitButton",
			{
		...
		{
			this->applyOptions();
			ENQUEUE_RENDER_COMMAND("MenuStateMyGui::buttonHit applyButton",
			{
		...
		{
			ENQUEUE_RENDER_COMMAND("MenuStateMyGui::buttonHit abordButton",
			{
				MyGUI::Gui::getInstance().findWidget<MyGUI::Window>("menueStatePanel")->setVisible(true);
				MyGUI::Gui::getInstance().findWidget<MyGUI::Window>("configurationPanel")->setVisible(false);
	...
	{
		ENQUEUE_RENDER_COMMAND_MULTI("MenuStateMyGui::notifyMouseSetFocus", _1(_sender),
		{
	...
	{
		ENQUEUE_RENDER_COMMAND_MULTI("MenuStateMyGui::sliderMoved", _1(_sender),
		{
	...
	bool MenuStateMyGui::keyPressed(const OIS::KeyEvent &keyEventRef)
	{
		...
		ENQUEUE_RENDER_COMMAND_MULTI_WAIT("MenuStateMyGui::sliderMoved", _2(keyEventRef, &keepMappingActive),
		{
