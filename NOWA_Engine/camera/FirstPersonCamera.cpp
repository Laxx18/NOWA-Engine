...
namespace NOWA
{
    ...
    void FirstPersonCamera::moveCamera(Ogre::Real dt)
    {
        ...
        Ogre::Quaternion delta = Ogre::Quaternion::Slerp(dt * 100.0f * this->rotateSpeed * this->rotateCameraWeight, this->camera->getOrientation(), targetOrientation, true);
        ...
        Ogre::Vector3 targetVector = playerPosition + (transformedOffset * this->moveCameraWeight * dt * 100.0f);
