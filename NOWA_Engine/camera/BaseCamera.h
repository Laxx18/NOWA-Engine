...
namespace NOWA
{
	...
	public:
		...
		BaseCamera(Ogre::Real moveSpeed = 20.0f, Ogre::Real rotateSpeed = 20.0f, Ogre::Real smoothValue = 0.1f, const Ogre::Vector3& defaultDirection = Ogre::Vector3::NEGATIVE_UNIT_Z);
