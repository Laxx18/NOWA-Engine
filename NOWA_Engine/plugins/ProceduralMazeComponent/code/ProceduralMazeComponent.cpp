...
namespace NOWA
{
	...
	void ProceduralMazeComponent::addFloorQuad(Ogre::Real minX, Ogre::Real maxX,
		Ogre::Real minZ, Ogre::Real maxZ,
		Ogre::Real y, bool faceUp)
	{
	...
	void ProceduralMazeComponent::createStaticApiForLua(lua_State* lua, class_<GameObject>& gameObjectClass,
		class_<GameObjectController>& gameObjectControllerClass)
	{
		module(lua)
		[
			class_<ProceduralMazeComponent, GameObjectComponent>("ProceduralMazeComponent")
