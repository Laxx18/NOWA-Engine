...
namespace NOWA
{
	 ...
	 */
	class EXPORTED ProceduralRoadComponent : public GameObjectComponent, public Ogre::Plugin, public OIS::MouseListener, public OIS::KeyListener
	{
	public:
	...
	private:
		...
		void createRoadMeshInternal(const std::vector<float>& centerVertices, const std::vector<Ogre::uint32>& centerIndices, size_t numCenterVertices,
			const std::vector<float>& edgeVertices, const std::vector<Ogre::uint32>& edgeIndices, size_t numEdgeVertices, const Ogre::Vector3& roadOrigin);
		...
		void addRoadQuad(const Ogre::Vector3& v0, const Ogre::Vector3& v1,
			const Ogre::Vector3& v2, const Ogre::Vector3& v3,
			const Ogre::Vector3& normal, Ogre::Real u0, Ogre::Real u1, Ogre::Real v0Val, Ogre::Real v1Val, bool isCenter);
