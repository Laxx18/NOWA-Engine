...
void ProceduralRoadComponent::confirmRoad(void)
{
    ...
    NOWA::AppStateManager::getSingletonPtr()->getEventManager()->triggerEvent(eventDataRoadModifyEnd);
                                                     ...
                                                     size_t numEdgeVerts, const Ogre::Vector3& origin)
{
    ...
    Ogre::LogManager::getSingletonPtr()->logMessage(Ogre::LML_TRIVIAL, "[ProceduralRoadComponent] Road mesh created with " + Ogre::StringConverter::toString(numCenterVerts) + " center vertices and " + Ogre::StringConverter::toString(numEdgeVerts) +
                                                                           " edge vertices, attached to scene");
}
...
bool ProceduralRoadComponent::loadRoadDataFromFile(void)
{
    ...
    try
    {
        ...
        Ogre::LogManager::getSingletonPtr()->logMessage(Ogre::LML_TRIVIAL, "[ProceduralRoadComponent] Loading: " + Ogre::StringConverter::toString(numSegments) + " segments, " + Ogre::StringConverter::toString(numCenterVerts) + " center verts, " +
                                                                               Ogre::StringConverter::toString(numCenterIdx) + " center idx, " + Ogre::StringConverter::toString(numEdgeVerts) + " edge verts, " +
        ...
        if (!this->roadSegments.empty())
        {
            ...
            if (!lastSegment.controlPoints.empty())
            {
                ...
                Ogre::LogManager::getSingletonPtr()->logMessage(Ogre::LML_TRIVIAL, "[ProceduralRoadComponent] Loaded road endpoint for continuation: " + Ogre::StringConverter::toString(this->loadedRoadEndpoint) +
                                                                                       ", height: " + Ogre::StringConverter::toString(this->loadedRoadEndpointHeight));
            }
        }
