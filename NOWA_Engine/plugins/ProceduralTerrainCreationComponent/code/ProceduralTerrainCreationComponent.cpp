...
namespace NOWA
{
	...
	ProceduralTerrainCreationComponent::ProceduralTerrainCreationComponent()
		...
		baseHeight(new Variant(ProceduralTerrainCreationComponent::AttrBaseHeight(), 50.0f, this->attributes)),
		hillAmplitude(new Variant(ProceduralTerrainCreationComponent::AttrHillAmplitude(), 100.0f, this->attributes)),
		hillFrequency(new Variant(ProceduralTerrainCreationComponent::AttrHillFrequency(), 0.01f, this->attributes)),
...
// Permutation table for Perlin noise
	...
	void ProceduralTerrainCreationComponent::generateProceduralTerrain(void)
	{
		...
		Ogre::LogManager::getSingletonPtr()->logMessage(Ogre::LML_NORMAL,
			"[ProceduralTerrainCreationComponent] Generating terrain " +
		...
		Ogre::LogManager::getSingletonPtr()->logMessage(Ogre::LML_NORMAL,
			"[ProceduralTerrainCreationComponent] Terrain generation complete!");
