...
namespace NOWA
{
    ...
    ProceduralDungeonComponent::ProceduralDungeonComponent() :
        ...
        wallHeight(new Variant(ProceduralDungeonComponent::AttrWallHeight(), 8.0f, this->attributes)),
        ...
        adaptToGround(new Variant(ProceduralDungeonComponent::AttrAdaptToGround(), false, this->attributes)),
