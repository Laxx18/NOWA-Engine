...
namespace NOWA
{
    ...
    public:
        ...
        // Ported from AnimationBlender (v1) to AnimationBlenderV2
        AnimationBlenderV2* getAnimationBlender(void) const;

        // Ported from Ogre::v1::OldBone to Ogre::Bone
    ...
    public:
        ...
        static const Ogre::String AttrAnimationCount(void)
        {
            return "Animation Count";
        }
        static const Ogre::String AttrAnimationName(void)
        {
            return "Animation Name ";
        }
        static const Ogre::String AttrBlendTransition(void)
        {
            return "Blend Transition ";
        }
        ...
        static const Ogre::String AttrShowSkeleton(void)
        {
    ...
    private:
        ...
        Ogre::String mapBlendingTransitionToString(AnimationBlenderV2::BlendingTransition blendingTransition);
    ...
    private:
        ...
        // Cached skeleton instance from Ogre::Item (replaces v1::Entity skeleton)
