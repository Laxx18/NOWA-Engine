...
namespace NOWA
{
	...
	private:
		void applyBrushToMesh(Ogre::MovableObject* movableObject, const Ogre::Vector3& hitPoint, Ogre::Vector3* vertices, size_t vertexCount, unsigned long* indices, size_t indexCount, bool isSphere);

		Ogre::Real getBrushIntensity(size_t vertexIndex, Ogre::MovableObject* movableObject);

		void updateMesh(Ogre::MovableObject* movableObject, Ogre::Vector3* newRawVertices, size_t vertexCount, unsigned long* newRawIndices, size_t indexCount);

		void updateMeshWithModifiedVertices(Ogre::MovableObject* movableObject, const std::vector<Ogre::Vector3>& newVertices, size_t vertexCount, const std::vector<unsigned long>& newIndices, size_t indexCount);

		void initMeshWithModifiedVertices(Ogre::MovableObject* movableObject, const std::vector<Ogre::Vector3>& newVertices, size_t vertexCount, const std::vector<unsigned long>& newIndices, size_t indexCount);
	private:
		Ogre::String name;
