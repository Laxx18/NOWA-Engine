#ifndef HDR_EFFECT_COMPONENT_H_
#define HDR_EFFECT_COMPONENT_H_
...
namespace NOWA
{
    ...
    */
    ...
    /**
     * @brief		HDR (High Dynamic Range) effect component with predefined lighting profiles.
     */
    class EXPORTED HdrEffectComponent : public GameObjectComponent, public Ogre::Plugin
    {
    public:
    ...
    public:
        static const Ogre::String AttrEffectName(void)
        {
            return "Effect Name";
        }
        static const Ogre::String AttrSkyColor(void)
        {
            return "Sky Color";
        }
        static const Ogre::String AttrUpperHemisphere(void)
        {
            return "Upper Hemisphere";
        }
        static const Ogre::String AttrLowerHemisphere(void)
        {
            return "Lower Hemisphere";
        }
        static const Ogre::String AttrSunPower(void)
        {
            return "Sun Power";
        }
        ...
        static const Ogre::String AttrMinAutoExposure(void)
        {
            return "Min Auto Exposure";
        }
        static const Ogre::String AttrMaxAutoExposure(void)
        {
            return "Max Auto Exposure";
        }
        static const Ogre::String AttrBloom(void)
        {
            return "Bloom";
        }
        static const Ogre::String AttrEnvMapScale(void)
        {
            return "Env Map Scale";
        }
    ...
    private:
        ...
        Ogre::Real oldLightPowerScale;

        // Snapshot of whatever lighting was active right before connect()
        // applied HDR, so disconnect() can restore it exactly instead of leaving
        // the HDR-overridden values (e.g. a bright preset's power scale) in place -
        // which previously could even end up persisted into the saved scene.
        bool hasConnectLightingSnapshot;
        Ogre::Real connectOldLightPowerScale;
        Ogre::ColourValue connectOldAmbientUpperHemisphere;
        Ogre::ColourValue connectOldAmbientLowerHemisphere;
        Ogre::Vector3 connectOldAmbientHemisphereDir;
        Ogre::Real connectOldEnvMapScale;
    };
