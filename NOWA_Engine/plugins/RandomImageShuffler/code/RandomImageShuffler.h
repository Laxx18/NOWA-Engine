...
namespace NOWA
{
    ...
    public:
        ...
        static const Ogre::String AttrGeometry(void)
        {
            return "Geometry";
        }
        static const Ogre::String AttrMaskImage(void)
        {
            return "Mask Image";
        }
        static const Ogre::String AttrDisplayTime(void)
        {
            return "Display Time MS";
        }
        static const Ogre::String AttrUseSlideImage(void)
        {
            return "Use Slide Image";
        }
        static const Ogre::String AttrUseStopDelay(void)
        {
            return "Use Stop Delay";
        }
        static const Ogre::String AttrUseStopEffect(void)
        {
            return "Use Stop Effect";
        }
        static const Ogre::String AttrEaseFunction(void)
        {
            return "Ease Function";
        }
        static const Ogre::String AttrOnImageChosenFunctionName(void)
        {
            return "On Image Chosen Function Name";
        }
        static const Ogre::String AttrImageCount(void)
        {
            return "Image Count";
        }
        static const Ogre::String AttrImageName(void)
        {
            return "Image Name ";
        }
    ...
    private:
        ...
        // Snapshotted on the RENDER thread whenever the visible image changes. The lua
        // callbacks used to read imageWidget from inside a logic command, i.e. they touched
        // MyGUI from the wrong thread. Reading these copies instead avoids that without a
        // blocking enqueueAndWait().
        Ogre::String currentTextureName;
        Ogre::String currentImageIndexString;
