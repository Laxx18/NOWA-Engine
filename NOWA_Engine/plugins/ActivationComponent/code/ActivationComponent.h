...
#ifndef ACTIVATIONCOMPONENT_H
#define ACTIVATIONCOMPONENT_H
...
namespace NOWA
{
	...
	/**
	  * @brief		Usage: Is used by AreaOfInterestComponent in order to automatically activate this component, when it comes into the area of the target.
	  */
	class EXPORTED ActivationComponent : public GameObjectComponent, public Ogre::Plugin
	{
	public:
		typedef boost::shared_ptr<ActivationComponent> ActivationComponentPtr;
	public:
