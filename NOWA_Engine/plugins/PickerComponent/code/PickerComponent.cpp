...
namespace NOWA
{
	...
	bool PickerComponent::init(rapidxml::xml_node<>*& propertyElement)
	{
	...
	void PickerComponent::writeXML(xml_node<>* propertiesXML, xml_document<>& doc)
	{
		// 2 = int
		// 6 = real
		// 7 = string
	...
	{
		if (this->mouseButtonId == id && true == this->bConnected)
		{
