...
namespace NOWA
{
	...
	public:
		...
		*/
		...
		Ogre::Real calculateSteeringAngle(const Ogre::Vector3& position, Ogre::Real heading);

		Ogre::Real calculatePitchAngle(const Ogre::Vector3& position, Ogre::Real pitch);
		 ...
		 */
		Ogre::Real calculateMotorForce(const Ogre::Vector3& position);
	...
	private:
		...
		*/
		Ogre::Real calculateCurvature(const Ogre::Vector3& position);
		
	private:
		Ogre::String name;
		std::vector<Ogre::Vector3> waypointPositions;
