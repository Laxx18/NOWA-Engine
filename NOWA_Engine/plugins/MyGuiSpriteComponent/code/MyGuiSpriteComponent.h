...
#include "gameobject/MyGUISpriteComponentBase.h"
...
namespace NOWA
{
     ...
     */
    class EXPORTED MyGuiSpriteComponent : public MyGUISpriteComponentBase, public Ogre::Plugin
    {
    public:
    ...
    public:
         ...
         *              Must be called from the render thread (e.g. inside a GraphicsModule enqueueAndWait block).
         * @param		cellAbsoluteCoord	Absolute screen pixel coordinates of the target cell (from MyGUI::Widget::getAbsoluteCoord).
         */
        virtual void positionOverCell(const MyGUI::IntCoord& cellAbsoluteCoord) override;
    ...
    public:
        static const Ogre::String AttrImage(void)
        {
            return "Image";
        }
        static const Ogre::String AttrTileSize(void)
        {
            return "TileSize";
        }
        static const Ogre::String AttrRowsCols(void)
        {
            return "RowsCols";
        }
        static const Ogre::String AttrHorizontal(void)
        {
            return "Horizontal";
        }
        static const Ogre::String AttrInverseDirection(void)
        {
        ...
        static const Ogre::String AttrStartEndIndex(void)
        {
        ...
        static const Ogre::String AttrUsePickingMask(void)
        {
            return "UsePickingMask";
        }
