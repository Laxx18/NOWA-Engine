...
namespace NOWA
{
	...
	DatablockTerraComponent::DatablockTerraComponent()
		...
		offsetScale0(new Variant(DatablockTerraComponent::AttrOffsetScale0(), Ogre::Vector4(0.0f, 0.0f, 1.0f, 1.0f), this->attributes)),
		detail1TextureName(new Variant(DatablockTerraComponent::AttrDetail1(), Ogre::String(), this->attributes)),
		offsetScale1(new Variant(DatablockTerraComponent::AttrOffsetScale1(), Ogre::Vector4(0.0f, 0.0f, 1.0f, 1.0f), this->attributes)),
		detail2TextureName(new Variant(DatablockTerraComponent::AttrDetail2(), Ogre::String(), this->attributes)),
		offsetScale2(new Variant(DatablockTerraComponent::AttrOffsetScale2(), Ogre::Vector4(0.0f, 0.0f, 1.0f, 1.0f), this->attributes)),
		detail3TextureName(new Variant(DatablockTerraComponent::AttrDetail3(), Ogre::String(), this->attributes)),
		offsetScale3(new Variant(DatablockTerraComponent::AttrOffsetScale3(), Ogre::Vector4(0.0f, 0.0f, 1.0f, 1.0f), this->attributes)),
