...
namespace NOWA
{
    ...
    LightSpotComponent::~LightSpotComponent()
    {
        ...
        if (nullptr != this->light)
        {
            ...
            NOWA::GraphicsModule::getInstance()->enqueueAndWait(std::move(renderCommand), "LightSpotComponent::~LightSpotComponent");
    ...
    bool LightSpotComponent::connect(void)
    {
        if (nullptr != this->dummyItem)
        {
            ...
            NOWA::GraphicsModule::getInstance()->enqueueAndWait(std::move(renderCommand), "LightSpotComponent::connect setVisible");
        }
    ...
    bool LightSpotComponent::disconnect(void)
    {
        if (nullptr != this->dummyItem)
        {
            ...
            NOWA::GraphicsModule::getInstance()->enqueueAndWait(std::move(renderCommand), "LightSpotComponent::disconnect setVisible");
        }
    ...
    void LightSpotComponent::createLight(void)
    {
        if (nullptr == this->light)
        {
            ...
            NOWA::GraphicsModule::getInstance()->enqueueAndWait(std::move(renderCommand), "LightSpotComponent::createLight");
        }
    }
    ...
    void LightSpotComponent::setDiffuseColor(const Ogre::Vector3& diffuseColor)
    {
        ...
        if (nullptr != this->light)
        {
            ...
            NOWA::GraphicsModule::getInstance()->enqueueAndWait(std::move(renderCommand), "LightSpotComponent::setDiffuseColor");
        }
    }
    ...
    void LightSpotComponent::setSpecularColor(const Ogre::Vector3& specularColor)
    {
        ...
        if (nullptr != this->light)
        {
            ...
            NOWA::GraphicsModule::getInstance()->enqueueAndWait(std::move(renderCommand), "LightSpotComponent::setSpecularColor");
        }
    }
    ...
    void LightSpotComponent::setPowerScale(Ogre::Real powerScale)
    {
        ...
        if (nullptr != this->light)
        {
            ...
            NOWA::GraphicsModule::getInstance()->enqueueAndWait(std::move(renderCommand), "LightSpotComponent::setPowerScale");
        }
    }
    ...
    void LightSpotComponent::setCastShadows(bool castShadows)
    {
        ...
        if (nullptr != this->light)
        {
            ...
            NOWA::GraphicsModule::getInstance()->enqueueAndWait(std::move(renderCommand), "LightSpotComponent::setCastShadows");
        }
    }
    ...
    void LightSpotComponent::setSize(const Ogre::Vector3& size)
    {
        ...
        if (nullptr != this->light)
        {
            NOWA::GraphicsModule::RenderCommand renderCommand = [this, size]
            {
            ...
            NOWA::GraphicsModule::getInstance()->enqueueAndWait(std::move(renderCommand), "LightSpotComponent::setSize");
        }
    }
    ...
    void LightSpotComponent::setNearClipDistance(Ogre::Real nearClipDistance)
    {
        ...
        if (nullptr != this->light)
        {
            NOWA::GraphicsModule::RenderCommand renderCommand = [this, nearClipDistance]
            {
                this->light->setSpotlightNearClipDistance(nearClipDistance);
            };
            NOWA::GraphicsModule::getInstance()->enqueueAndWait(std::move(renderCommand), "LightSpotComponent::setNearClipDistance");
        }
    }
