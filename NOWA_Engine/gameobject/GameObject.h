...
namespace NOWA
{
    ...
    public:
        ...
        /**
         * @brief		Sets whether this game object is hidden while the simulation runs.
         *				The 'Visible' attribute itself is deliberately NOT modified, so the
         *				object is restored to exactly its configured state on disconnect.
         *				Useful for editor only helpers such as path waypoints.
         * @param[in]	hideOnConnect		true to hide the object on connect
         */
        void setHideOnConnect(bool hideOnConnect);

        /**
         * @brief	Gets whether this game object is hidden while the simulation runs.
         * @return	hideOnConnect True if this game object is hidden during simulation
         */
        bool getHideOnConnect(void) const;
    ...
    public:
         ...
         */
        template <class MovableType> MovableType* getMovableObject(void) const
        {
         ...
         */
        template <class MovableType> MovableType* getMovableObjectUnsafe(void) const
        {
         ...
         * @return		The component weak ptr which must be made to a strong ptr by using the function @makeStrongPtr() or lock(), or nullptr if not found.
         */
        template <class ComponentType> boost::weak_ptr<ComponentType> getComponent(unsigned int componentClassId, unsigned int componentOccurrenceIndex)
        {
         ...
         */
        template <class ComponentType> boost::weak_ptr<ComponentType> getComponentFromName(const Ogre::String& componentName, bool allowDerivatives = false)
        {
         ...
         * @return		success					Whether the component has been found and deleted
         */
        template <class ComponentType> bool deleteComponent(unsigned int componentOccurrenceIndex = 0)
        {
         ...
         * @return		The component weak ptr which must be made to a strong ptr by using the function @makeStrongPtr() or lock(), or nullptr if not found.
         */
        template <class ComponentType> boost::weak_ptr<ComponentType> getComponent(const Ogre::String& componentClassName, unsigned int componentOccurrenceIndex = 0)
        {
         ...
         * @return		The component weak ptr which must be made to a strong ptr by using the function @makeStrongPtr() or lock(), or nullptr if not found.
         */
        template <class ComponentType> boost::weak_ptr<ComponentType> getComponent(unsigned int componentOccurrenceIndex = 0)
        {
        ...
        template <class ComponentType> boost::weak_ptr<ComponentType> getComponentWithOccurrence(unsigned int componentOccurrenceIndex = 0)
        {
            return getComponent<ComponentType>(ComponentType::getStaticClassId(), componentOccurrenceIndex);
        }
    ...
    public:
        // Attribute constants
        static const Ogre::String AttrId(void)
        {
            return "Id";
        }
        static const Ogre::String AttrName(void)
        {
            return "Name";
        }
        static const Ogre::String AttrType(void)
        {
            return "Type";
        }
        static const Ogre::String AttrCategoryId(void)
        {
            return "Category Id";
        }
        static const Ogre::String AttrCategory(void)
        {
            return "Category";
        }
        static const Ogre::String AttrRenderCategoryId(void)
        {
            return "Render Category Id";
        }
        static const Ogre::String AttrRenderCategory(void)
        {
            return "Render Category";
        }
        static const Ogre::String AttrMeshName(void)
        {
            return "Mesh Name";
        }
        static const Ogre::String AttrTagName(void)
        {
            return "Tag Name";
        }
        ...
        static const Ogre::String AttrControlledByClientID(void)
        {
            return "Client Id";
        }
        static const Ogre::String AttrCastShadows(void)
        {
            return "Cast Shadows";
        }
        static const Ogre::String AttrVisible(void)
        {
            return "Visible";
        }
        static const Ogre::String AttrHideOnConnect(void)
        {
            return "Hide On Connect";
        }
        static const Ogre::String AttrDynamic(void)
        {
            return "Dynamic";
        }
        static const Ogre::String AttrSize(void)
        {
            return "Size";
        }
        static const Ogre::String AttrPosition(void)
        {
            return "Position";
        }
        ...
        static const Ogre::String AttrOrientation(void)
        {
            return "Orientation";
        }
        static const Ogre::String AttrDefaultDirection(void)
        {
            return "Global Mesh Direction";
        }
        static const Ogre::String AttrGlobal(void)
        {
            return "Global";
        }
        static const Ogre::String AttrClampY(void)
        {
            return "Clamp Y";
        }
        static const Ogre::String AttrReferenceId(void)
        {
            return "Reference Id";
        }
        static const Ogre::String AttrRenderQueueIndex(void)
        {
            return "Render Queue Index";
        }
        static const Ogre::String AttrRenderDistance(void)
        {
            return "Render Distance";
        }
        static const Ogre::String AttrLodDistance(void)
        {
            return "Lod Distance";
        }
        static const Ogre::String AttrLodLevels(void)
        {
            return "Lod Levels";
        }
        static const Ogre::String AttrShadowDistance(void)
        {
            return "Shadow Distance";
        }

        // Attribute actions
        static const Ogre::String AttrActionNeedRefresh(void)
        {
            return "NeedRefresh";
        }
        static const Ogre::String AttrActionColorDialog(void)
        {
            return "ColorDialog";
        }
        static const Ogre::String AttrActionForceSet(void)
        {
            return "ForceSet";
        }
        static const Ogre::String AttrActionMultiLine(void)
        {
            return "MultiLine";
        }
        static const Ogre::String AttrActionFileOpenDialog(void)
        {
            return "FileOpenDialog";
        }
        static const Ogre::String AttrActionFileType(void)
        {
            return "FileType";
        }
        static const Ogre::String AttrActionSeparator(void)
        {
            return "Separator";
        }
        static const Ogre::String AttrActionLabel(void)
        {
            return "Label";
        }
        static const Ogre::String AttrActionImage(void)
        {
            return "Image";
        }
        static const Ogre::String AttrActionNoUndo(void)
        {
            return "NoUndo";
        }
        static const Ogre::String AttrActionGenerateLuaFunction(void)
        {
            return "GenerateLuaFunction";
        }
        static const Ogre::String AttrActionReadOnly(void)
        {
            return "ReadOnly";
        }
        static const Ogre::String AttrActionLuaScript(void)
        {
            return "LuaScript";
        }
        static const Ogre::String AttrActionAutoComplete()
        {
            return "AttrActionAutoComplete";
        }
        static const Ogre::String AttrActionExec()
        {
            return "AttrActionExec";
        }
        static Ogre::String AttrActionExecId(void)
        {
            return "AttrActionExecId";
        }

        // Custom data strings
        static const Ogre::String AttrCustomDataSkipCreation(void)
        {
            return "SkipCreation";
        }
    ...
    private:
        static void destroyGameObjectResources(Ogre::SceneNode* sceneNode, Ogre::MovableObject* movableObject, Ogre::WireAabb* boundingBoxDraw, Ogre::RaySceneQuery* clampObjectQuery, Ogre::SceneManager* sceneManager);
        ...
        /**
         * @brief		Shows/hides ONLY the scene node, deliberately without touching the
         *				'Visible' attribute. setVisible() always writes that attribute, which
         *				would overwrite the configured value and make it unrestorable.
         */
        void applyRuntimeVisibility(bool visible);
