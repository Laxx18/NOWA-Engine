...
namespace NOWA
{
	...
	bool TagChildNodeComponent::init(rapidxml::xml_node<>*& propertyElement, const Ogre::String& filename)
	{
...
// Here when in post init add child, so that object cann be moved in editor directly
	...
	void TagChildNodeComponent::writeXML(xml_node<>* propertiesXML, xml_document<>& doc, const Ogre::String& filePath)
	{
		// 2 = int
		// 6 = real
		// 7 = string
