...
namespace NOWA
{
	...
	bool WorkspaceBaseComponent::connect(void)
	{
		...
		Ogre::String id = this->gameObjectPtr->getName() + this->getClassName() + "::connect" + Ogre::StringConverter::toString(this->index);
	...
	bool WorkspaceBaseComponent::disconnect(void)
	{
		...
		Ogre::String id = this->gameObjectPtr->getName() + this->getClassName() + "::disconnect" + Ogre::StringConverter::toString(this->index);
		NOWA::GraphicsModule::getInstance()->updateTrackedClosure(id, closureFunction);
	...
	bool WorkspaceBaseComponent::createWorkspace(void)
	{
		...
		Ogre::String id = this->gameObjectPtr->getName() + this->getClassName() + "::createWorkspace" + Ogre::StringConverter::toString(this->index);
		NOWA::GraphicsModule::getInstance()->updateTrackedClosure(id, closureFunction);
	...
	void WorkspaceBaseComponent::removeWorkspace(void)
	{
		...
		Ogre::String id = this->gameObjectPtr->getName() + this->getClassName() + "::removeWorkspace" + Ogre::StringConverter::toString(this->index);
		NOWA::GraphicsModule::getInstance()->updateTrackedClosure(id, closureFunction);
	}
	...
	void WorkspaceBaseComponent::reconnectAllNodes(void)
	{
		...
		if (nullptr != this->workspace)
		{
			...
			Ogre::String id = this->gameObjectPtr->getName() + this->getClassName() + "::reconnectAllNodes" + Ogre::StringConverter::toString(this->index);
			NOWA::GraphicsModule::getInstance()->updateTrackedClosure(id, closureFunction);
		}
	}
