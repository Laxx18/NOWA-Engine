...
namespace NOWA
{
	...
	public:
		...
		/**
		 * @see		GameObjectComponent::createApiForLua
		 */
		static void createApiForLua(void) { }
		...
		*/
		...
		{
			return "Usage: This component can be used to draw an value bar at the game object with an offset. The current value level can also be manipulated.";
		}
