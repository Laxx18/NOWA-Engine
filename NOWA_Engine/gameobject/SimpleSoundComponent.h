...
namespace NOWA
{
    ...
    public:
        ...
        /**
         * @brief Sets the playback speed of the sound.
         * @param[in] speed The playback speed to set. 1.0 is normal speed, values below 1.0 slow the sound down (and lower its pitch), values above 1.0 speed it up (and raise its pitch).
         * @note	Internally this maps to OpenAL's pitch parameter, which changes speed and pitch together (it is implemented as a resampling rate change), so there is no way to change one without the other.
         */
        void setSpeed(Ogre::Real speed);

        /**
         * @brief Gets sound playback speed value
         * @return speed The sound playback speed to get
         */
         ...
         * @param[in] processingSize			Sets the spectrum processing size. Note: addSoundSpectrumHandler must be used and stream must be set to true and spectrumProcessingSize must always be higher as mSpectrumNumberOfBands and divisible
         * by 2. Default value is 1024. It must not go below 1024
         ...
         */
        void enableSpectrumAnalysis(bool enable, int processingSize, int numberOfBands, OgreAL::MathWindows::WindowType windowType, OgreAL::AudioProcessor::SpectrumPreparationType spectrumPreparationType, Ogre::Real smoothFactor);
    ...
    public:
        ...
        static const Ogre::String AttrSoundName(void)
        {
            return "Sound Name";
        }
        static const Ogre::String AttrVolume(void)
        {
            return "Volume";
        }
        ...
        static const Ogre::String AttrLoop(void)
        {
            return "Loop";
        }
        static const Ogre::String AttrFadeInFadeOut(void)
        {
            return "Fadein Fadeout";
        }
        static const Ogre::String AttrStream(void)
        {
            return "Stream";
        }
        static const Ogre::String AttrRelativeToListener(void)
        {
            return "Relative To Listener";
        }
        static const Ogre::String AttrPlayWhenInMotion(void)
        {
            return "Play when in Motion";
        }
        static const Ogre::String AttrSpectrumAnalysisFunctionName(void)
        {
            return "Spectrum Analysis Function Name";
        }
