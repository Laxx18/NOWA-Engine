...
namespace NOWA
{
	...
	TerraComponent::TerraComponent()
		...
		dimensions(new Variant(TerraComponent::AttrDimensions(), Ogre::Vector3(200.0f, 100.0f, 200.0f), this->attributes)),
        ...
        lodRing0WorldSize(new Variant(TerraComponent::AttrLodRing0WorldSize(), 0.0f, this->attributes)),
	...
	bool TerraComponent::init(rapidxml::xml_node<>*& propertyElement)
	{
	...
	void TerraComponent::writeXML(xml_node<>* propertiesXML, xml_document<>& doc)
	{
		// 2 = int
		// 6 = real
		// 7 = string
