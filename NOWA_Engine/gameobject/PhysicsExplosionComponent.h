...
namespace NOWA
{
    ...
    public:
        ...
        /**
         * @brief Lua closure function gets called each second while the explosion countdown is running.
         * @param[in] closureFunction The closure function set.
         * @note Takes precedence over both a set script file's 'onTimerSecondTick' and setExplosionCallback()'s IExplosionCallback::onTimerSecondTick(), if set.
         */
        void reactOnTimerSecondTick(luabind::object closureFunction);

        /**
         * @brief Lua closure function gets called once the bomb explodes, after the countdown has elapsed.
         * @param[in] closureFunction The closure function set.
         * @note Takes precedence over both a set script file's 'onExplode' and setExplosionCallback()'s IExplosionCallback::onExplode(), if set.
         */
        void reactOnExplode(luabind::object closureFunction);

        /**
         * @brief Lua closure function gets called for each game object affected by the explosion.
         * @param[in] closureFunction The closure function set.
         * @note Called once per affected game object. Takes precedence over both a set script file's
         *		'onExplodeAffectedGameObject' and setExplosionCallback()'s IExplosionCallback::onExplodeAffectedGameObject(), if set.
         */
        void reactOnExplodeAffectedGameObject(luabind::object closureFunction);
    ...
    public:
        ...
        static const Ogre::String AttrCountDown(void)
        {
            return "Count Down (sec)";
        }
        static const Ogre::String AttrRadius(void)
        {
            return "Radius";
        }
        static const Ogre::String AttrStrength(void)
        {
            return "Strength (n)";
        }
    ...
    protected:
        ...
        luabind::object timerSecondTickClosureFunction;
        luabind::object explodeClosureFunction;
        luabind::object explodeAffectedGameObjectClosureFunction;
        // also a mask?
