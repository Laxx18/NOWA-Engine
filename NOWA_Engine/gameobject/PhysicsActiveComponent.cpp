...
namespace NOWA
{
    ...
    void PhysicsActiveComponent::createSoftBody(void)
    {
        ...
        OgreNewt::CollisionPtr collisionPtr = this->createDynamicCollision(inertia, this->collisionSize->getVector3(), this->collisionPosition->getVector3(), collisionOrientation, calculatedMassOrigin, this->gameObjectPtr->getCategoryId());
    ...
    PhysicsActiveComponent::ContactData PhysicsActiveComponent::getContactAhead(int index, const Ogre::Vector3& offset, Ogre::Real length, bool forceDrawLine, unsigned int categoryIds)
    {
        ...
        Ogre::Vector3 charPoint = this->physicsBody->getPosition() + (this->physicsBody->getOrientation() * defaultRot * offset);
    ...
    PhysicsActiveComponent::ContactData PhysicsActiveComponent::getContactToDirection(int index, const Ogre::Vector3& direction, const Ogre::Vector3& offset, Ogre::Real from, Ogre::Real to, bool forceDrawLine, unsigned int categoryIds)
    {
        if (nullptr == this->physicsBody)
        {
            return ContactData();
        ...
        // Apply both the default rotation and the body's orientation to the offset
        Ogre::Vector3 position = this->physicsBody->getPosition() + (this->physicsBody->getOrientation() * defaultRot * offset);
    ...
    GameObject* PhysicsActiveComponent::getContact(int index, const Ogre::Vector3& direction, const Ogre::Vector3& offset, Ogre::Real from, Ogre::Real to, bool forceDrawLine, unsigned int categoryIds)
    {
        if (nullptr == this->physicsBody)
        {
            return nullptr;
    ...
    Ogre::Real PhysicsActiveComponent::determineGameObjectHeight(const Ogre::Vector3& positionOffset1, const Ogre::Vector3& positionOffset2, unsigned int categoryIds)
    {
        ...
        Ogre::Vector3 charPoint = this->physicsBody->getPosition() + (this->physicsBody->getOrientation() * defaultRot * positionOffset1);
