...
namespace NOWA
{
	...
	*/
	...
	class EXPORTED JointVehicleTireComponent : public JointComponent
	{
	public:
		typedef boost::shared_ptr<JointVehicleTireComponent> JointVehicleTireCompPtr;
	public:
		JointVehicleTireComponent(void);
		...
		*/
		...
		static unsigned int getStaticClassId(void)
		{
			return NOWA::getIdFromName("JointVehicleTireComponent");
		}
		...
		*/
		static Ogre::String getStaticInfoText(void)
		{
			return "Info: A tire joint, which belongs to a vehicle chassis. Requirements: A GameObject with a PhysicsActiveVehicleComponent and a base JointComponent must exist.";
		}
