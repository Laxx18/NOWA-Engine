#ifndef PHYSICS_RAGDOLL_COMPONENT_V2_H
#define PHYSICS_RAGDOLL_COMPONENT_V2_H
...
namespace NOWA
{
	...
	class EXPORTED PhysicsRagDollComponentV2 : public PhysicsActiveComponent
	{
	public:
		typedef boost::shared_ptr<PhysicsRagDollComponentV2> PhysicsRagDollComponentV2Ptr;
	public:
		...
		virtual ~PhysicsRagDollComponentV2();
		...
		*/
		...
		{
			return NOWA::getIdFromName("PhysicsRagDollComponentV2");
		}
		...
		*/
		...
		{
			return "Usage: This component is used to create physics rag doll for Ogre::Item (V2). The ragdoll details are specified in a XML file. "
		...
		*/
		...
		{
		public:
			friend class PhysicsRagDollComponentV2;
			 ...
			 * @param[in]	axes The axes at which the rotation should occur
	...
	protected:
		...
		void joinBones(PhysicsRagDollComponentV2::JointType type, RagBone* childRagBone, RagBone* parentRagBone, const Ogre::Vector3& pin,
		...
		/// Helper: extracts skeleton-local position and orientation from a V2 Bone
		static void extractBoneDerivedTransform(Ogre::Bone* bone, Ogre::Vector3& outPos, Ogre::Quaternion& outOrient);
	...
	protected:
		...
		std::map<Ogre::Bone*, std::pair<Ogre::Bone*, Ogre::Vector3>> boneCorrectionMap;
	};
