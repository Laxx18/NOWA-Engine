...
namespace Ogre
{
        ...
        uint32 verticalPixelDim, uint32 lodLevel)
    {
        ...
        horizontalPixelDim = std::min(horizontalPixelDim, m_parentOcean->m_width - static_cast<uint32>(m_gridX));
        verticalPixelDim = std::min(verticalPixelDim, m_parentOcean->m_depth - static_cast<uint32>(m_gridZ));
