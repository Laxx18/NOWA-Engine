...
#include "CompositorHelperLogics.h"
...
void HeatVisionListener::notifyMaterialRender(Ogre::uint32 pass_id, Ogre::MaterialPtr &mat)
{
	if (pass_id == 0xDEADBABE)
	{
		...
		fpParams->setNamedConstant("random_fractions", Ogre::Vector4(Ogre::Math::RangeRandom(0.0f, 1.0f), Ogre::Math::RangeRandom(0.0f, 1.0f), 0.0f, 0.0f));
		...
		fpParams->setNamedConstant("depth_modulator", Ogre::Vector4(curr, 0.0f, 0.0f, 0.0f));
	}
}
//---------------------------------------------------------------------------
