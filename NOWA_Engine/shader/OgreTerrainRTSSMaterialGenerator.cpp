...
namespace Ogre
{
	...
	**/
	...
	//---------------------------------------------------------------------
	void TerrainRTSSMaterialGenerator::CustomSM2Profile::CustomShaderHelperCg::generateVpDynamicShadows(
	...
	//---------------------------------------------------------------------
	uint TerrainRTSSMaterialGenerator::CustomSM2Profile::CustomShaderHelperCg::generateVpDynamicShadowsParams(
