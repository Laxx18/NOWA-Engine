...
namespace NOWA
{
    ...
    namespace KI
    {
        template <class Owner> class IState;

        template <class Owner> class EXPORTED StateMachine
        {
        public:
            StateMachine(Owner* owner) : owner(owner), currentState(nullptr), previousState(nullptr), childState(nullptr)
            {
            }
            ...
            template <class Instance> void registerState(Ogre::String stateName)
            {
        ...
        template <class Owner> class EXPORTED LuaStateMachine
        {
        public:
            LuaStateMachine(Owner* owner) : owner(owner)
            {
            }
            ...
            void setCurrentState(const luabind::object& currentState)
            {
                ...
                catch (luabind::error& error)
                {
                    ...
                    Ogre::LogManager::getSingleton().logMessage(Ogre::LML_CRITICAL, "[LuaStateMachine] Caught error in 'setCurrentState' Error: " + Ogre::String(error.what()) + " details: " + msg.str());
                }
            }
            ...
            void setGlobalState(const luabind::object& globalState)
            {
                ...
                catch (luabind::error& error)
                {
                    ...
                    Ogre::LogManager::getSingleton().logMessage(Ogre::LML_CRITICAL, "[LuaStateMachine] Caught error in 'setGlobalState' Error: " + Ogre::String(error.what()) + " details: " + msg.str());
                }
            }
            ...
            void update(Ogre::Real dt)
            {
                ...
                catch (luabind::error& error)
                {
                    ...
                    if (found == errorMessages.cend())
                    {
                        ...
                        Ogre::LogManager::getSingleton().logMessage(Ogre::LML_CRITICAL, "[LuaStateMachine] Caught error in 'execute' Error: " + Ogre::String(error.what()) + " details: " + msg.str());
            ...
            void changeState(const luabind::object& newState)
            {
                ...
                catch (luabind::error& error)
                {
                    ...
                    Ogre::LogManager::getSingleton().logMessage(Ogre::LML_CRITICAL, "[LuaStateMachine] Caught error in 'changeState' Error: " + Ogre::String(error.what()) + " details: " + msg.str());
                }
            }
            ...
            void exitGlobalState(void)
            {
                ...
                catch (luabind::error& error)
                {
                    ...
                    Ogre::LogManager::getSingleton().logMessage(Ogre::LML_CRITICAL, "[LuaStateMachine] Caught error in 'exitGlobalState' Error: " + Ogre::String(error.what()) + " details: " + msg.str());
                }
            }
        ...
        template <class Owner> class EXPORTED IState
        {
        public:
            virtual ~IState() {};
