...
void MainApplication::startSimulation(const Ogre::String& configName)
{
	...
	NOWA::AppStateManager::getSingletonPtr()->start("DesignState", false, /*NOWA::AppStateManager::INTERPOLATED*/ NOWA::AppStateManager::FPS_INDEPENDENT /*NOWA::AppStateManager::ADAPTIVE*/ /*NOWA::AppStateManager::RESTRICTED_INTERPOLATED*/);
}