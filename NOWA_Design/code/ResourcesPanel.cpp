...
void ResourcesPanelMeshes::loadMeshes(const Ogre::String& filter)
{
	...
	if (true == filter.empty())
	{
		...
		// Add Wall
		{
			if (NOWA::GameObjectFactory::getInstance()->getComponentFactory()->hasComponent("ProceduralWallComponent"))
			{
				child = new MyGUI::TreeControl::Node("Wall", "Data");
				parent->add(child);
			}
		}
		// Add Road
        ...
        // Add Platform Conveyor
        {
            ...
            {
                child = new MyGUI::TreeControl::Node("Platform Conveyor", "Data");
                parent->add(child);
            }
        }
		// Add Geometry
		{
			...
			{
				child = new MyGUI::TreeControl::Node("Geometry", "Data");
				parent->add(child);
			}
		}
        // Add Stairs
