...
void ProjectManager::createNewProject(const NOWA::ProjectParameter& projectParameter)
{
    ...
    try
    {
        ...
        this->dotSceneImportModule->parseScene(this->projectParameter.projectName, this->projectParameter.sceneName, "Projects", nullptr);
    }
...
void ProjectManager::loadProject(const Ogre::String& filePathName, unsigned short recentFileIndex)
{
    ...
    try
    {
        ...
        NOWA::AppStateManager::LogicCommand logicCommand = [this, &success]()
        {
            ...
            Ogre::LogManager::getSingletonPtr()->logMessage("Objects exists=" + Ogre::StringConverter::toString(rgm->resourceGroupExists("Objects")) + " initialised=" + Ogre::StringConverter::toString(rgm->isResourceGroupInitialised("Objects")) +
            ...
            Ogre::LogManager::getSingletonPtr()->logMessage("Material exists before load: " + Ogre::StringConverter::toString(!testMat.isNull()));
            ...
            success = this->dotSceneImportModule->parseScene(this->projectParameter.projectName, this->projectParameter.sceneName, "Projects", nullptr);
        };
