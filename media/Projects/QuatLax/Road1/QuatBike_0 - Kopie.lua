module("QuatBike_0", package.seeall);
...
QuatBike_0["connect"] = function(gameObject)
    scene1_QuatBike_0 = AppStateManager:getGameObjectController():castGameObject(gameObject);
    AppStateManager:getGameObjectController():activatePlayerController(true, scene1_QuatBike_0:getId(), true);
    physicsActiveVehicleComponent = scene1_QuatBike_0:getPhysicsActiveVehicleComponent();
    raceGoalComponent = scene1_QuatBike_0:getRaceGoalComponent();
    ...
    rollSound = scene1_QuatBike_0:getSimpleSoundComponentFromIndex(0);
    rollSound:setVolume(200);
    
    skidSound = scene1_QuatBike_0:getSimpleSoundComponentFromIndex(1);
    
    playerController = scene1_QuatBike_0:getPlayerControllerComponent();
...
QuatBike_0["disconnect"] = function()
    
end

QuatBike_0["update"] = function(dt)
...
QuatBike_0["onSteeringAngleChanged"] = function(vehicleDrivingManipulation, dt)
...
QuatBike_0["onMotorForceChanged"] = function(vehicleDrivingManipulation, dt)
...
QuatBike_0["onHandBrakeChanged"] = function(vehicleDrivingManipulation, dt)
...
QuatBike_0["onBrakeChanged"] = function(vehicleDrivingManipulation, dt)
...
QuatBike_0["onTireContact"] = function(tireName, hitPhysicsComponent, contactPosition, contactNormal, penetration)
...
QuatBike_0["onFeedbackRace"] = function(currentLap, lapTimeSec, finished)
...
QuatBike_0["onWrongDirectionDriving"] = function(wrongDirection)
    wrongDirectionText:setActivated(wrongDirection == true);
end

QuatBike_0["onCountdown"] = function(countdownNumber)
