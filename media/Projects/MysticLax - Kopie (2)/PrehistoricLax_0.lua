...
RagDollState["enter"] = function(gameObject)
    ...
    prehistoricLax:getPickerComponentFromName("LeftHandPicker"):setActivated(false);
end
...
RagDollState["exit"] = function(gameObject)
   ...
   prehistoricLax:getPickerComponentFromName("RightHandPicker"):setActivated(true);
